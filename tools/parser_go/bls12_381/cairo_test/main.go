...
import (
	...
	"math/big"
	"os"
	bls12381 "tools/parser_go/bls12_381"
	"tools/parser_go/bls12_381/fp"
...
func info() {
	app.Name = "Gnark BLS12-381 parser CLI"
	app.Usage = "An CLI for parsing bls12-381 operations"
	app.Version = "1.0.0"
}
...
func main() {
	...
	app.Action = func(c *cli.Context) error {
		...
		case "pair":
			...
			Y.Y.A0 = Y2
			Y.Y.A1 = Y3
			g1_arr := []bls12381.G1Affine{X}
			g2_arr := []bls12381.G2Affine{Y}
