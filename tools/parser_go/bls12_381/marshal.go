...
// we follow the bls12_381 style encoding as specified in ZCash and now IETF
//
...
// Encoder writes bls12_381 object values to an output stream
type Encoder struct {
	w   io.Writer
...
// Decoder reads bls12_381 object values from an inbound stream
type Decoder struct {
	r             io.Reader
	n             int64 // read bytes
...
// NewDecoder returns a binary decoder supporting curve bls12_381 objects in both
...
func (dec *Decoder) Decode(v interface{}) (err error) {
	...
	if v == nil || rv.Kind() != reflect.Ptr || rv.IsNil() || !rv.Elem().CanSet() {
		return errors.New("bls12_381 decoder: unsupported type, need pointer")
	}
	...
	default:
		n := binary.Size(t)
		if n == -1 {
			return errors.New("bls12_381 encoder: unsupported type")
		}
...
// NewEncoder returns a binary encoder supporting curve bls12_381 objects
