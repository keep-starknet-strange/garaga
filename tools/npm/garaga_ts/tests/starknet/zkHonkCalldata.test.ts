...
describe('ZK Honk Getting calldata', () => {
  ...
  const proofAndVkWithFlavors = [
    [`${PATH}/proof_ultra_keccak_zk.bin`, `${PATH}/public_inputs_ultra_keccak_zk.bin`, `${PATH}/vk_ultra_keccak.bin`, HonkFlavor.KECCAK],
    [`${PATH}/proof_ultra_starknet_zk.bin`, `${PATH}/public_inputs_ultra_keccak_zk.bin`, `${PATH}/vk_ultra_keccak.bin`, HonkFlavor.STARKNET],
  ]
