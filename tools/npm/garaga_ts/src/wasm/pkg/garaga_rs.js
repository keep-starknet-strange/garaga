...
export function drand_calldata_builder(values) {
    ...
    const ret = wasm.drand_calldata_builder(ptr0, len0);
    if (ret[3]) {
...
export function msm_calldata_builder(values, scalars, curve_id, include_points_and_scalars, serialize_as_pure_felt252_array) {
    ...
    const ret = wasm.msm_calldata_builder(ptr0, len0, ptr1, len1, curve_id, include_points_and_scalars, serialize_as_pure_felt252_array);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
...
export function mpc_calldata_builder(curve_id, values1, n_fixed_g2, values2) {
    ...
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.mpc_calldata_builder(curve_id, ptr0, len0, n_fixed_g2, ptr1, len1);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
    var v3 = getArrayJsValueFromWasm0(ret[0], ret[1]).slice();
...
export function schnorr_calldata_builder(rx, s, e, px, py, curve_id) {
    const ret = wasm.schnorr_calldata_builder(rx, s, e, px, py, curve_id);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
...
export function ecdsa_calldata_builder(r, s, v, px, py, z, curve_id) {
    const ret = wasm.ecdsa_calldata_builder(r, s, v, px, py, z, curve_id);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
    var v1 = getArrayJsValueFromWasm0(ret[0], ret[1]).slice();
...
export function eddsa_calldata_builder(ry_twisted, s, py_twisted, msg) {
    const ret = wasm.eddsa_calldata_builder(ry_twisted, s, py_twisted, msg);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
    var v1 = getArrayJsValueFromWasm0(ret[0], ret[1]).slice();
...
export function to_weirstrass(x_twisted, y_twisted) {
    const ret = wasm.to_weirstrass(x_twisted, y_twisted);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
    var v1 = getArrayJsValueFromWasm0(ret[0], ret[1]).slice();
 ...
 * @returns {any[]}
 */
export function get_groth16_calldata(proof_js, vk_js, curve_id_js) {
    const ret = wasm.get_groth16_calldata(proof_js, vk_js, curve_id_js);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
    var v1 = getArrayJsValueFromWasm0(ret[0], ret[1]).slice();
...
export function parse_honk_proof(proof_js, public_inputs_js) {
    const ret = wasm.parse_honk_proof(proof_js, public_inputs_js);
    if (ret[2]) {
...
export function get_honk_calldata(proof_js, public_inputs_js, vk_js, flavor_js) {
    const ret = wasm.get_honk_calldata(proof_js, public_inputs_js, vk_js, flavor_js);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
    var v1 = getArrayJsValueFromWasm0(ret[0], ret[1]).slice();
...
export function get_zk_honk_calldata(proof_js, public_inputs_js, vk_js, flavor_js) {
    const ret = wasm.get_zk_honk_calldata(proof_js, public_inputs_js, vk_js, flavor_js);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
    var v1 = getArrayJsValueFromWasm0(ret[0], ret[1]).slice();
...
export function poseidon_hash(x, y) {
    const ret = wasm.poseidon_hash(x, y);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
