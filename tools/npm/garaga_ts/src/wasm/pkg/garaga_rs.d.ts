...
export function drand_tlock_encrypt_calldata_builder(values: any[]): any[];
...
export function parse_honk_proof(proof_js: any, public_inputs_js: any): any;
export function get_honk_calldata(proof_js: any, public_inputs_js: any, vk_js: any, flavor_js: any): any[];
export function get_zk_honk_calldata(proof_js: any, public_inputs_js: any, vk_js: any, flavor_js: any): any[];
...
export interface InitOutput {
  ...
  readonly drand_tlock_encrypt_calldata_builder: (a: number, b: number, c: number) => void;
