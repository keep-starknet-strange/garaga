...
mod_builtin_layout_instance = CairoLayout(
    layout_name="mod_builtin_layout",
    rc_units=4,
    public_memory_fraction=8,
    diluted_pool_instance_def=DilutedPoolInstanceDef(
        log_units_per_step=4,
    ...
    builtins=dict(
        ...
        add_mod=AddModInstanceDef(ratio=128, word_bit_len=96, n_words=4, batch_size=8),
        mul_mod=MulModInstanceDef(ratio=256, word_bit_len=96, n_words=4, batch_size=8, bits_per_part=16),
    ),
    n_trace_columns=11,
)
...
LAYOUTS: Dict[str, CairoLayout] = {
    ...
    "mod_builtin_layout": mod_builtin_layout_instance,
}
