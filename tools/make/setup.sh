...
if ! scarb --version | grep -q "2.12.2"; then
    echo "Warning: Scarb is not installed or its version is not 2.12.2."
    echo "Got: $(scarb --version)"
    echo "Please install Scarb 2.12.2 before continuing. https://docs.swmansion.com/scarb/download.html"
fi
