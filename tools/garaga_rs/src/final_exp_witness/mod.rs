...
mod tests {
    ...
    fn get_final_exp_witness_1() {
        ...
        let z = ["0x1", "0x0", "0x0", "0x0", "0x0", "0x0", "0x0", "0x0", "0x0", "0x0", "0x0", "0x0"];
        let x = x.into_iter().map(|v| element_to_biguint(&FieldElement::<BN254PrimeField>::from_hex(v).unwrap())).collect::<Vec<_>>();
        let xy = y.into_iter().map(|v| element_to_biguint(&FieldElement::<BN254PrimeField>::from_hex(v).unwrap())).collect::<Vec<_>>();
        let xz = z.into_iter().map(|v| element_to_biguint(&FieldElement::<BN254PrimeField>::from_hex(v).unwrap())).collect::<Vec<_>>();
    ...
    fn get_final_exp_witness_2() {
        ...
        let x = x.into_iter().map(|v| element_to_biguint(&FieldElement::<BLS12381PrimeField>::from_hex(v).unwrap())).collect::<Vec<_>>();
        let xy = y.into_iter().map(|v| element_to_biguint(&FieldElement::<BLS12381PrimeField>::from_hex(v).unwrap())).collect::<Vec<_>>();
        let xz = z.into_iter().map(|v| element_to_biguint(&FieldElement::<BLS12381PrimeField>::from_hex(v).unwrap())).collect::<Vec<_>>();
