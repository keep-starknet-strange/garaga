...
use crate::definitions::{get_irreducible_poly, CurveID, CurveParamsProvider};
...
pub fn nondeterministic_extension_field_div<F>(
    x: Polynomial<F>,
    y: Polynomial<F>,
    ext_degree: usize,
) -> Polynomial<F>
    ...
    if ext_degree == 2 {
        ...
        let [c0, c1] = match curve_id {
            CurveID::BN254 => {
                ...
                let c = a * b;
                [
                    BigUint::from(c.c0.into_bigint()),
                    BigUint::from(c.c1.into_bigint()),
                ]
            }
            CurveID::BLS12_381 => {
    ...
    if ext_degree == 6 {
        ...
        let [c0, c1, c2, c3, c4, c5] = match curve_id {
            CurveID::BN254 => {
                ...
                let c = a * b;
                [
                    BigUint::from(c.c0.c0.into_bigint()),
                    BigUint::from(c.c0.c1.into_bigint()),
                    BigUint::from(c.c1.c0.into_bigint()),
                    BigUint::from(c.c1.c1.into_bigint()),
                    BigUint::from(c.c2.c0.into_bigint()),
                    BigUint::from(c.c2.c1.into_bigint()),
                ]
            }
            CurveID::BLS12_381 => {
        ...
        return vec![
            ...
            element_from_biguint(&c3),
            element_from_biguint(&c4),
            element_from_biguint(&c5),
        ];
    }
    if ext_degree == 12 {
        ...
        let [c0, c1, c2, c3, c4, c5, c6, c7, c8, c9, c10, c11] = match curve_id {
            CurveID::BN254 => {
                ...
                let c = a * b;
                [
                    BigUint::from(c.c0.c0.c0.into_bigint()),
                    BigUint::from(c.c0.c0.c1.into_bigint()),
                    BigUint::from(c.c0.c1.c0.into_bigint()),
                    BigUint::from(c.c0.c1.c1.into_bigint()),
                    BigUint::from(c.c0.c2.c0.into_bigint()),
                    BigUint::from(c.c0.c2.c1.into_bigint()),
                    BigUint::from(c.c1.c0.c0.into_bigint()),
                    BigUint::from(c.c1.c0.c1.into_bigint()),
                    BigUint::from(c.c1.c1.c0.into_bigint()),
                    BigUint::from(c.c1.c1.c1.into_bigint()),
                    BigUint::from(c.c1.c2.c0.into_bigint()),
                    BigUint::from(c.c1.c2.c1.into_bigint()),
                ]
            }
            CurveID::BLS12_381 => {
        ...
        vec![
            ...
            element_from_biguint(&c4),
            element_from_biguint(&c5),
            element_from_biguint(&c6),
            element_from_biguint(&c7),
            element_from_biguint(&c8),
