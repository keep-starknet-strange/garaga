...
mod tests {
    ...
    fn test_nondeterministic_extension_field_mul_divmod_1() {
        let ps = [
            ...
            ["0x1", "0x0", "0x0", "0x0", "0x0", "0x0", "0x0", "0x0", "0x0", "0x0", "0x0", "0x0"],
            ["0x1", "0x3049ed443e0ee79060270c9094ac6390a5c1ab3db65328a47174c6c33f6bd5f2", "0x0", "0xa279a60d390f263fa2b23afda6a2160c7af52ea6fdddb7ffe26ded0e216c821", "0x0", "0x0", "0x0", "0x146bccf3dc47e8eedf574326c5188ea8e4978a568116c9aa5b8517cdeb0e1f38", "0x0", "0x10b71d55b795eb0c1590286e48c412e3434b0def1afddfc8840541b6936825fd", "0x0", "0x0"], 
            ["0x1", "0x10b80d23f4e55970de219c8bb6cc99af9ca48837a7da389ff6e02693c8912bf3", "0x0", "0x1999e3b5911b71ef05b218f5be987ba6f43afb6a702ffca89c7a6643b411046f", "0x0", "0x0", "0x0", "0x2a00794e593076aab0ec5e6283a9ed0ddbe6ef97af88861febd351722d50802a", "0x0", "0x22583e5a131ce5504fbb720b2081781441eeb10978efac409e27787d1fa359b6", "0x0", "0x0"],
        ];
        let q = ["0xe894c747efef08ab122e832492446abf3359cf28786e81ab3a81a74fce2c75b", "0x0", "0x221a77eeae1aacc77e771d8440e698d3b8d2447bb8de2a046cf8c063f7523fb7", "0x0", "0x1d9393fe1dfd5bf8174a7b2086cdc6288de8ee5409946e58d5385d342633aa56", "0x0", "0x122377527927c40e63ddc4c9ef6a51a864d1e6575602045f81ddf7ae83afc4c3"];
        ...
        let ps = ps.into_iter().map(|v| Polynomial::new(v.into_iter().map(|v| FieldElement::<BN254PrimeField>::from_hex(v).unwrap()).collect::<Vec<_>>())).collect::<Vec<_>>();
        let xq = q.into_iter().map(|v| FieldElement::<BN254PrimeField>::from_hex(v).unwrap()).collect::<Vec<_>>();
        let xr = r.into_iter().map(|v| FieldElement::<BN254PrimeField>::from_hex(v).unwrap()).collect::<Vec<_>>();
    ...
    fn test_nondeterministic_extension_field_mul_divmod_2() {
        ...
        let r = ["0x1", "0x0", "0x0", "0x0", "0x0", "0x0", "0x0", "0x0", "0x0", "0x0", "0x0", "0x0"];
        let ps = ps.into_iter().map(|v| Polynomial::new(v.into_iter().map(|v| FieldElement::<BN254PrimeField>::from_hex(v).unwrap()).collect::<Vec<_>>())).collect::<Vec<_>>();
        let xq = q.into_iter().map(|v| FieldElement::<BN254PrimeField>::from_hex(v).unwrap()).collect::<Vec<_>>();
        let xr = r.into_iter().map(|v| FieldElement::<BN254PrimeField>::from_hex(v).unwrap()).collect::<Vec<_>>();
        let (q, r) = nondeterministic_extension_field_mul_divmod(12, ps);
    ...
    fn test_nondeterministic_extension_field_mul_divmod_3() {
        ...
        let ps = ps.into_iter().map(|v| Polynomial::new(v.into_iter().map(|v| FieldElement::<BLS12381PrimeField>::from_hex(v).unwrap()).collect::<Vec<_>>())).collect::<Vec<_>>();
        let xq = q.into_iter().map(|v| FieldElement::<BLS12381PrimeField>::from_hex(v).unwrap()).collect::<Vec<_>>();
        let xr = r.into_iter().map(|v| FieldElement::<BLS12381PrimeField>::from_hex(v).unwrap()).collect::<Vec<_>>();
        let (q, r) = nondeterministic_extension_field_mul_divmod(12, ps);
        let q = q.coefficients;
        let r = r.coefficients;
        assert_eq!(q, xq);
    ...
    fn nondeterministic_extension_field_div_1() {
        let x = ["0x2f6a437ba87bf892de86475ec2155dd6bf2acf7ddb7ad74c028c1a0bd146a17d", "0xc2fc4dd8bf1d0a89f2a486ff97fe6ba7ef3267310f51196b7463fd620b3b35a"];
        let y = ["0x2590bd4bb718dbd69556e3011b96811fc7a3ced21887a6f699cd9802cdf4fb54", "0x120d13a0b0bfe0ebd93d335ad218672b78966266e1671de6ab59b5b9a2452eb6"];
        let z = ["0x237db2935c4432bc98005e68cacde68a193b54e64d347301094edcbfa224d3d5", "0x124077e14a7d826a707c3ec1809ae9bafafa05dd6b4ba735fba44e801d415637"];
        let x = Polynomial::new(x.into_iter().map(|v| FieldElement::<BN254PrimeField>::from_hex(v).unwrap()).collect::<Vec<_>>());
        let y = Polynomial::new(y.into_iter().map(|v| FieldElement::<BN254PrimeField>::from_hex(v).unwrap()).collect::<Vec<_>>());
        let xz = z.into_iter().map(|v| FieldElement::<BN254PrimeField>::from_hex(v).unwrap()).collect::<Vec<_>>();
    ...
    fn nondeterministic_extension_field_div_2() {
        let x = ["0x1", "0x0", "0x0", "0x0", "0x0", "0x0", "0x0", "0x0", "0x0", "0x0", "0x0", "0x0"];
        let y = ["0x14156ca1853095df27f3cb7c50eca75e794d2f14195c16df4a0f8f9dcb48bee9", "0xdc2a20a6107d4c49fed6b2018946bcc2a8dad06f01d099a6df0a4a55ed21b59", "0x14260c5afb0b1148ed80f8339cf9e06ff04257cb6c1817c4efa721fc98f69503", "0xafe8a09df07bf3dffefe512eb9448ef436dd090f98323135baab8ae3c766c60", "0x114692950f53d4f707bb02cc2b5dc98aff5936811707d6579371dae20368253c", "0x2dd3fca72591963149646f1e106dc0ee917551f5a9da397fe12d4a3939ce650c", "0x1750bd450b85cbd62ea3f1b228beff5fd364a127d6054be99a9248497b82062a", "0x1248cfad33a2147726169d3ce55db12ecafd74bc4b83377c168d89b919386546", "0x28d156bac04e64938816b055888399c99a954b82724e5f5589d549a709b2b5ef", "0x39e1ab153bd709556afece475580f453f9126f256fbb49c235bc75082f5f26e", "0x14853f940bf5c557c7f558d3e74e6617d7f08b54fd83597fed1d7e7b9d09e04", "0xaa480d613601947fee14a3ce2b7af4e1872fe49ae3473546aa01a618b78b125"];
        ...
        let y = Polynomial::new(y.into_iter().map(|v| FieldElement::<BN254PrimeField>::from_hex(v).unwrap()).collect::<Vec<_>>());
        let xz = z.into_iter().map(|v| FieldElement::<BN254PrimeField>::from_hex(v).unwrap()).collect::<Vec<_>>();
        let z = nondeterministic_extension_field_div(x, y, 12);
        let z = z.coefficients;
        assert_eq!(z.len(), xz.len());
    }
    ...
    fn nondeterministic_extension_field_div_3() {
        ...
        let x = Polynomial::new(x.into_iter().map(|v| FieldElement::<BLS12381PrimeField>::from_hex(v).unwrap()).collect::<Vec<_>>());
        let y = Polynomial::new(y.into_iter().map(|v| FieldElement::<BLS12381PrimeField>::from_hex(v).unwrap()).collect::<Vec<_>>());
        let xz = z.into_iter().map(|v| FieldElement::<BLS12381PrimeField>::from_hex(v).unwrap()).collect::<Vec<_>>();
        let z = nondeterministic_extension_field_div(x, y, 2);
        let z = z.coefficients;
        assert_eq!(z, xz);
    }
