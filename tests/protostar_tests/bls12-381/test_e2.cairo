...
from src.bls12_381.fq import BigInt3
...
func test_mulbnr1p1{
    ...
    %{
        ...
        curve_str = bytes.fromhex(f'{ids.CURVE:x}').decode('ascii')
        cmd_line = './tools/parser_go/' + curve_str + '/cairo_test/main'
        cmd = [cmd_line, 'e2', 'mulbnr1p1'] + [str(x) for x in inputs]
        out = subprocess.run(cmd, stdout=subprocess.PIPE).stdout.decode('utf-8')
        fp_elements = parse_fp_elements(out)
...
func test_mulbnr1p2{
    ...
    %{
        ...
        curve_str = bytes.fromhex(f'{ids.CURVE:x}').decode('ascii')
        cmd_line = './tools/parser_go/' + curve_str + '/cairo_test/main'
        cmd = [cmd_line, 'e2', 'mulbnr1p2'] + [str(x) for x in inputs]
        out = subprocess.run(cmd, stdout=subprocess.PIPE).stdout.decode('utf-8')
        fp_elements = parse_fp_elements(out)
...
func test_mulbnr1p3{
    ...
    %{
        ...
        curve_str = bytes.fromhex(f'{ids.CURVE:x}').decode('ascii')
        cmd_line = './tools/parser_go/' + curve_str + '/cairo_test/main'
        cmd = [cmd_line, 'e2', 'mulbnr1p3'] + [str(x) for x in inputs]
        out = subprocess.run(cmd, stdout=subprocess.PIPE).stdout.decode('utf-8')
        fp_elements = parse_fp_elements(out)
...
func test_mulbnr1p4{
    ...
    %{
        ...
        curve_str = bytes.fromhex(f'{ids.CURVE:x}').decode('ascii')
        cmd_line = './tools/parser_go/' + curve_str + '/cairo_test/main'
        cmd = [cmd_line, 'e2', 'mulbnr1p4'] + [str(x) for x in inputs]
        out = subprocess.run(cmd, stdout=subprocess.PIPE).stdout.decode('utf-8')
        fp_elements = parse_fp_elements(out)
...
func test_mulbnr1p5{
    ...
    %{
        ...
        curve_str = bytes.fromhex(f'{ids.CURVE:x}').decode('ascii')
        cmd_line = './tools/parser_go/' + curve_str + '/cairo_test/main'
        cmd = [cmd_line, 'e2', 'mulbnr1p5'] + [str(x) for x in inputs]
        out = subprocess.run(cmd, stdout=subprocess.PIPE).stdout.decode('utf-8')
        fp_elements = parse_fp_elements(out)
