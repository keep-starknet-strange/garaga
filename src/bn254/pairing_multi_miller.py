...
class E12_034:
    ...
    def to_poly(self):
        return Polynomial(
            [
                field.one(),
                BaseFieldElement(self.w1, field),
                field.zero(),
                BaseFieldElement(self.w3, field),
                field.zero(),
                field.zero(),
                field.zero(),
                BaseFieldElement(self.w7, field),
                field.zero(),
                BaseFieldElement(self.w9, field),
                field.zero(),
                field.zero(),
            ]
        )
...
class E12_01234:
    ...
    def to_poly(self):
        return Polynomial(
            [
                BaseFieldElement(self.w0, field),
                BaseFieldElement(self.w1, field),
                BaseFieldElement(self.w2, field),
                BaseFieldElement(self.w3, field),
                BaseFieldElement(self.w4, field),
                field.zero(),
                BaseFieldElement(self.w6, field),
                BaseFieldElement(self.w7, field),
                BaseFieldElement(self.w8, field),
                BaseFieldElement(self.w9, field),
                BaseFieldElement(self.w10, field),
                BaseFieldElement(self.w11, field),
            ]
        )
    ...
    def to_poly(self):
        return Polynomial(
            [
                ...
                BaseFieldElement(self.w3, field),
                BaseFieldElement(self.w4, field),
                BaseFieldElement(self.w5, field),
                BaseFieldElement(self.w6, field),
                BaseFieldElement(self.w7, field),
                BaseFieldElement(self.w8, field),
                BaseFieldElement(self.w9, field),
