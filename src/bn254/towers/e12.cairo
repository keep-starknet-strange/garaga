...
func square_trick{
    ...
    // local r_w: E12full;
    // local q_w: E11full;
    let r_w0d0 = [range_check_ptr];
    let r_w0d1 = [range_check_ptr + 1];
    let r_w0d2 = [range_check_ptr + 2];
    let r_w1d0 = [range_check_ptr + 3];
    let r_w1d1 = [range_check_ptr + 4];
    let r_w1d2 = [range_check_ptr + 5];
    let r_w2d0 = [range_check_ptr + 6];
    let r_w2d1 = [range_check_ptr + 7];
    let r_w2d2 = [range_check_ptr + 8];
    let r_w3d0 = [range_check_ptr + 9];
    let r_w3d1 = [range_check_ptr + 10];
    let r_w3d2 = [range_check_ptr + 11];
    let r_w4d0 = [range_check_ptr + 12];
    let r_w4d1 = [range_check_ptr + 13];
    let r_w4d2 = [range_check_ptr + 14];
    let r_w5d0 = [range_check_ptr + 15];
    let r_w5d1 = [range_check_ptr + 16];
    let r_w5d2 = [range_check_ptr + 17];
    let r_w6d0 = [range_check_ptr + 18];
    let r_w6d1 = [range_check_ptr + 19];
    let r_w6d2 = [range_check_ptr + 20];
    let r_w7d0 = [range_check_ptr + 21];
    let r_w7d1 = [range_check_ptr + 22];
    let r_w7d2 = [range_check_ptr + 23];
    let r_w8d0 = [range_check_ptr + 24];
    let r_w8d1 = [range_check_ptr + 25];
    let r_w8d2 = [range_check_ptr + 26];
    let r_w9d0 = [range_check_ptr + 27];
    let r_w9d1 = [range_check_ptr + 28];
    let r_w9d2 = [range_check_ptr + 29];
    let r_w10d0 = [range_check_ptr + 30];
    let r_w10d1 = [range_check_ptr + 31];
    let r_w10d2 = [range_check_ptr + 32];
    let r_w11d0 = [range_check_ptr + 33];
    let r_w11d1 = [range_check_ptr + 34];
    let r_w11d2 = [range_check_ptr + 35];
    let q_w0l = [range_check_ptr + 36];
    let q_w0h = [range_check_ptr + 37];
    let q_w1l = [range_check_ptr + 38];
    let q_w1h = [range_check_ptr + 39];
    let q_w2l = [range_check_ptr + 40];
    let q_w2h = [range_check_ptr + 41];
    let q_w3l = [range_check_ptr + 42];
    let q_w3h = [range_check_ptr + 43];
    let q_w4l = [range_check_ptr + 44];
    let q_w4h = [range_check_ptr + 45];
    let q_w5l = [range_check_ptr + 46];
    let q_w5h = [range_check_ptr + 47];
    let q_w6l = [range_check_ptr + 48];
    let q_w6h = [range_check_ptr + 49];
    let q_w7l = [range_check_ptr + 50];
    let q_w7h = [range_check_ptr + 51];
    let q_w8l = [range_check_ptr + 52];
    let q_w8h = [range_check_ptr + 53];
    let q_w9l = [range_check_ptr + 54];
    let q_w9h = [range_check_ptr + 55];
    let q_w10l = [range_check_ptr + 56];
    let q_w10h = [range_check_ptr + 57];
    ...
    %{
        ...
        for i in range(12):
            ...
            for k in range(ids.N_LIMBS):
                setattr(ids, f'r_w{i}d{k}', val[k])
        for i in range(11):
            val = split_128(z_polyq_coeffs[i]%p)
            setattr(ids, f'q_w{i}l', val[0])
            setattr(ids, f'q_w{i}h', val[1])
    %}
    tempvar r_w: E12full* = cast(range_check_ptr, E12full*);

    assert [range_check_ptr + 58] = THREE_BASE_MIN_1 - (r_w0d0 + r_w0d1 + r_w0d2);
    assert [range_check_ptr + 59] = THREE_BASE_MIN_1 - (r_w1d0 + r_w1d1 + r_w1d2);
    assert [range_check_ptr + 60] = THREE_BASE_MIN_1 - (r_w2d0 + r_w2d1 + r_w2d2);
    assert [range_check_ptr + 61] = THREE_BASE_MIN_1 - (r_w3d0 + r_w3d1 + r_w3d2);
    assert [range_check_ptr + 62] = THREE_BASE_MIN_1 - (r_w4d0 + r_w4d1 + r_w4d2);
    assert [range_check_ptr + 63] = THREE_BASE_MIN_1 - (r_w5d0 + r_w5d1 + r_w5d2);
    assert [range_check_ptr + 64] = THREE_BASE_MIN_1 - (r_w6d0 + r_w6d1 + r_w6d2);
    assert [range_check_ptr + 65] = THREE_BASE_MIN_1 - (r_w7d0 + r_w7d1 + r_w7d2);
    assert [range_check_ptr + 66] = THREE_BASE_MIN_1 - (r_w8d0 + r_w8d1 + r_w8d2);
    assert [range_check_ptr + 67] = THREE_BASE_MIN_1 - (r_w9d0 + r_w9d1 + r_w9d2);
    assert [range_check_ptr + 68] = THREE_BASE_MIN_1 - (r_w10d0 + r_w10d1 + r_w10d2);
    assert [range_check_ptr + 69] = THREE_BASE_MIN_1 - (r_w11d0 + r_w11d1 + r_w11d2);
    ...
    local poly_acc_sq_f: PolyAcc12 = PolyAcc12(
        ...
        q=E11full(
            Uint256(c_i * q_w0l + poly_acc_sq.q.w0.low, c_i * q_w0h + poly_acc_sq.q.w0.high),
            Uint256(c_i * q_w1l + poly_acc_sq.q.w1.low, c_i * q_w1h + poly_acc_sq.q.w1.high),
            Uint256(c_i * q_w2l + poly_acc_sq.q.w2.low, c_i * q_w2h + poly_acc_sq.q.w2.high),
            Uint256(c_i * q_w3l + poly_acc_sq.q.w3.low, c_i * q_w3h + poly_acc_sq.q.w3.high),
            Uint256(c_i * q_w4l + poly_acc_sq.q.w4.low, c_i * q_w4h + poly_acc_sq.q.w4.high),
            Uint256(c_i * q_w5l + poly_acc_sq.q.w5.low, c_i * q_w5h + poly_acc_sq.q.w5.high),
            Uint256(c_i * q_w6l + poly_acc_sq.q.w6.low, c_i * q_w6h + poly_acc_sq.q.w6.high),
            Uint256(c_i * q_w7l + poly_acc_sq.q.w7.low, c_i * q_w7h + poly_acc_sq.q.w7.high),
            Uint256(c_i * q_w8l + poly_acc_sq.q.w8.low, c_i * q_w8h + poly_acc_sq.q.w8.high),
            Uint256(c_i * q_w9l + poly_acc_sq.q.w9.low, c_i * q_w9h + poly_acc_sq.q.w9.high),
            Uint256(c_i * q_w10l + poly_acc_sq.q.w10.low, c_i * q_w10h + poly_acc_sq.q.w10.high),
        ),
        r=E12full(
            BigInt3(
                d0=c_i * r_w0d0 + poly_acc_sq.r.w0.d0,
                d1=c_i * r_w0d1 + poly_acc_sq.r.w0.d1,
                d2=c_i * r_w0d2 + poly_acc_sq.r.w0.d2,
            ),
            BigInt3(
                d0=c_i * r_w1d0 + poly_acc_sq.r.w1.d0,
                d1=c_i * r_w1d1 + poly_acc_sq.r.w1.d1,
                d2=c_i * r_w1d2 + poly_acc_sq.r.w1.d2,
            ),
            BigInt3(
                d0=c_i * r_w2d0 + poly_acc_sq.r.w2.d0,
                d1=c_i * r_w2d1 + poly_acc_sq.r.w2.d1,
                d2=c_i * r_w2d2 + poly_acc_sq.r.w2.d2,
            ),
            BigInt3(
                d0=c_i * r_w3d0 + poly_acc_sq.r.w3.d0,
                d1=c_i * r_w3d1 + poly_acc_sq.r.w3.d1,
                d2=c_i * r_w3d2 + poly_acc_sq.r.w3.d2,
            ),
            BigInt3(
                d0=c_i * r_w4d0 + poly_acc_sq.r.w4.d0,
                d1=c_i * r_w4d1 + poly_acc_sq.r.w4.d1,
                d2=c_i * r_w4d2 + poly_acc_sq.r.w4.d2,
            ),
            BigInt3(
                d0=c_i * r_w5d0 + poly_acc_sq.r.w5.d0,
                d1=c_i * r_w5d1 + poly_acc_sq.r.w5.d1,
                d2=c_i * r_w5d2 + poly_acc_sq.r.w5.d2,
            ),
            BigInt3(
                d0=c_i * r_w6d0 + poly_acc_sq.r.w6.d0,
                d1=c_i * r_w6d1 + poly_acc_sq.r.w6.d1,
                d2=c_i * r_w6d2 + poly_acc_sq.r.w6.d2,
            ),
            BigInt3(
                d0=c_i * r_w7d0 + poly_acc_sq.r.w7.d0,
                d1=c_i * r_w7d1 + poly_acc_sq.r.w7.d1,
                d2=c_i * r_w7d2 + poly_acc_sq.r.w7.d2,
            ),
            BigInt3(
                d0=c_i * r_w8d0 + poly_acc_sq.r.w8.d0,
                d1=c_i * r_w8d1 + poly_acc_sq.r.w8.d1,
                d2=c_i * r_w8d2 + poly_acc_sq.r.w8.d2,
            ),
            BigInt3(
                d0=c_i * r_w9d0 + poly_acc_sq.r.w9.d0,
                d1=c_i * r_w9d1 + poly_acc_sq.r.w9.d1,
                d2=c_i * r_w9d2 + poly_acc_sq.r.w9.d2,
            ),
            BigInt3(
                d0=c_i * r_w10d0 + poly_acc_sq.r.w10.d0,
                d1=c_i * r_w10d1 + poly_acc_sq.r.w10.d1,
                d2=c_i * r_w10d2 + poly_acc_sq.r.w10.d2,
            ),
            BigInt3(
                d0=c_i * r_w11d0 + poly_acc_sq.r.w11.d0,
                d1=c_i * r_w11d1 + poly_acc_sq.r.w11.d1,
                d2=c_i * r_w11d2 + poly_acc_sq.r.w11.d2,
            ),
        ),
    );
...
func mul034_trick{
...
}(x: E12full*, y: E12full034*) -> E12full* {
    alloc_locals;
    let (__fp__, _) = get_fp_and_pc();
    // local r_w: E12full;
    // local q_w: E9full;
    ...
    assert [range_check_ptr + 54] = THREE_BASE_MIN_1 - (r_w0d0 + r_w0d1 + r_w0d2);
    assert [range_check_ptr + 55] = THREE_BASE_MIN_1 - (r_w1d0 + r_w1d1 + r_w1d2);
    assert [range_check_ptr + 56] = THREE_BASE_MIN_1 - (r_w2d0 + r_w2d1 + r_w2d2);
    assert [range_check_ptr + 57] = THREE_BASE_MIN_1 - (r_w3d0 + r_w3d1 + r_w3d2);
    assert [range_check_ptr + 58] = THREE_BASE_MIN_1 - (r_w4d0 + r_w4d1 + r_w4d2);
    assert [range_check_ptr + 59] = THREE_BASE_MIN_1 - (r_w5d0 + r_w5d1 + r_w5d2);
    assert [range_check_ptr + 60] = THREE_BASE_MIN_1 - (r_w6d0 + r_w6d1 + r_w6d2);
    assert [range_check_ptr + 61] = THREE_BASE_MIN_1 - (r_w7d0 + r_w7d1 + r_w7d2);
    assert [range_check_ptr + 62] = THREE_BASE_MIN_1 - (r_w8d0 + r_w8d1 + r_w8d2);
    assert [range_check_ptr + 63] = THREE_BASE_MIN_1 - (r_w9d0 + r_w9d1 + r_w9d2);
    assert [range_check_ptr + 64] = THREE_BASE_MIN_1 - (r_w10d0 + r_w10d1 + r_w10d2);
    assert [range_check_ptr + 65] = THREE_BASE_MIN_1 - (r_w11d0 + r_w11d1 + r_w11d2);
    ...
    assert poseidon_ptr[24].input = PoseidonBuiltinState(
        s0=q_w0l, s1=poseidon_ptr[23].output.s0, s2=2
    );
    assert poseidon_ptr[25].input = PoseidonBuiltinState(
        s0=q_w0h, s1=poseidon_ptr[24].output.s0, s2=2
    );
    assert poseidon_ptr[26].input = PoseidonBuiltinState(
        s0=q_w1l, s1=poseidon_ptr[25].output.s0, s2=2
    );
    assert poseidon_ptr[27].input = PoseidonBuiltinState(
        s0=q_w1h, s1=poseidon_ptr[26].output.s0, s2=2
    );
    assert poseidon_ptr[28].input = PoseidonBuiltinState(
        s0=q_w2l, s1=poseidon_ptr[27].output.s0, s2=2
    );
    assert poseidon_ptr[29].input = PoseidonBuiltinState(
        s0=q_w2h, s1=poseidon_ptr[28].output.s0, s2=2
    );
    assert poseidon_ptr[30].input = PoseidonBuiltinState(
        s0=q_w3l, s1=poseidon_ptr[29].output.s0, s2=2
    );
    assert poseidon_ptr[31].input = PoseidonBuiltinState(
        s0=q_w3h, s1=poseidon_ptr[30].output.s0, s2=2
    );
    assert poseidon_ptr[32].input = PoseidonBuiltinState(
        s0=q_w4l, s1=poseidon_ptr[31].output.s0, s2=2
    );
    assert poseidon_ptr[33].input = PoseidonBuiltinState(
        s0=q_w4h, s1=poseidon_ptr[32].output.s0, s2=2
    );
    assert poseidon_ptr[34].input = PoseidonBuiltinState(
        s0=q_w5l, s1=poseidon_ptr[33].output.s0, s2=2
    );
    assert poseidon_ptr[35].input = PoseidonBuiltinState(
        s0=q_w5h, s1=poseidon_ptr[34].output.s0, s2=2
    );
    assert poseidon_ptr[36].input = PoseidonBuiltinState(
        s0=q_w6l, s1=poseidon_ptr[35].output.s0, s2=2
    );
    assert poseidon_ptr[37].input = PoseidonBuiltinState(
        s0=q_w6h, s1=poseidon_ptr[36].output.s0, s2=2
    );
    assert poseidon_ptr[38].input = PoseidonBuiltinState(
        s0=q_w7l, s1=poseidon_ptr[37].output.s0, s2=2
    );
    assert poseidon_ptr[39].input = PoseidonBuiltinState(
        s0=q_w7h, s1=poseidon_ptr[38].output.s0, s2=2
    );
    assert poseidon_ptr[40].input = PoseidonBuiltinState(
        s0=q_w8l, s1=poseidon_ptr[39].output.s0, s2=2
    );
    assert poseidon_ptr[41].input = PoseidonBuiltinState(
        s0=q_w8h, s1=poseidon_ptr[40].output.s0, s2=2
    );
    assert poseidon_ptr[42].input = PoseidonBuiltinState(
        s0=r_w0d0 * r_w0d1, s1=poseidon_ptr[41].output.s0, s2=2
    );
    assert poseidon_ptr[43].input = PoseidonBuiltinState(
        s0=r_w0d2 * r_w1d0, s1=poseidon_ptr[42].output.s0, s2=2
    );
    assert poseidon_ptr[44].input = PoseidonBuiltinState(
        s0=r_w1d1 * r_w1d2, s1=poseidon_ptr[43].output.s0, s2=2
    );
    assert poseidon_ptr[45].input = PoseidonBuiltinState(
        s0=r_w2d0 * r_w2d1, s1=poseidon_ptr[44].output.s0, s2=2
    );
    assert poseidon_ptr[46].input = PoseidonBuiltinState(
        s0=r_w2d2 * r_w3d0, s1=poseidon_ptr[45].output.s0, s2=2
    );
    assert poseidon_ptr[47].input = PoseidonBuiltinState(
        s0=r_w3d1 * r_w3d2, s1=poseidon_ptr[46].output.s0, s2=2
    );
    assert poseidon_ptr[48].input = PoseidonBuiltinState(
        s0=r_w4d0 * r_w4d1, s1=poseidon_ptr[47].output.s0, s2=2
    );
    assert poseidon_ptr[49].input = PoseidonBuiltinState(
        s0=r_w4d2 * r_w5d0, s1=poseidon_ptr[48].output.s0, s2=2
    );
    assert poseidon_ptr[50].input = PoseidonBuiltinState(
        s0=r_w5d1 * r_w5d2, s1=poseidon_ptr[49].output.s0, s2=2
    );
    assert poseidon_ptr[51].input = PoseidonBuiltinState(
        s0=r_w6d0 * r_w6d1, s1=poseidon_ptr[50].output.s0, s2=2
    );
    assert poseidon_ptr[52].input = PoseidonBuiltinState(
        s0=r_w6d2 * r_w7d0, s1=poseidon_ptr[51].output.s0, s2=2
    );
    assert poseidon_ptr[53].input = PoseidonBuiltinState(
        s0=r_w7d1 * r_w7d2, s1=poseidon_ptr[52].output.s0, s2=2
    );
    assert poseidon_ptr[54].input = PoseidonBuiltinState(
        s0=r_w8d0 * r_w8d1, s1=poseidon_ptr[53].output.s0, s2=2
    );
    assert poseidon_ptr[55].input = PoseidonBuiltinState(
        s0=r_w8d2 * r_w9d0, s1=poseidon_ptr[54].output.s0, s2=2
    );
    assert poseidon_ptr[56].input = PoseidonBuiltinState(
        s0=r_w9d1 * r_w9d2, s1=poseidon_ptr[55].output.s0, s2=2
    );
    assert poseidon_ptr[57].input = PoseidonBuiltinState(
        s0=r_w10d0 * r_w10d1, s1=poseidon_ptr[56].output.s0, s2=2
    );
    assert poseidon_ptr[58].input = PoseidonBuiltinState(
        s0=r_w10d2 * r_w11d0, s1=poseidon_ptr[57].output.s0, s2=2
    );
    assert poseidon_ptr[59].input = PoseidonBuiltinState(
        s0=r_w11d1 * r_w11d2, s1=poseidon_ptr[58].output.s0, s2=2
    );
    ...
    local poly_acc_034_f: PolyAcc034 = PolyAcc034(
        ...
        q=E9full(
            Uint256(c_i * q_w0l + poly_acc_034.q.w0.low, c_i * q_w0h + poly_acc_034.q.w0.high),
            Uint256(c_i * q_w1l + poly_acc_034.q.w1.low, c_i * q_w1h + poly_acc_034.q.w1.high),
            Uint256(c_i * q_w2l + poly_acc_034.q.w2.low, c_i * q_w2h + poly_acc_034.q.w2.high),
            Uint256(c_i * q_w3l + poly_acc_034.q.w3.low, c_i * q_w3h + poly_acc_034.q.w3.high),
            Uint256(c_i * q_w4l + poly_acc_034.q.w4.low, c_i * q_w4h + poly_acc_034.q.w4.high),
            Uint256(c_i * q_w5l + poly_acc_034.q.w5.low, c_i * q_w5h + poly_acc_034.q.w5.high),
            Uint256(c_i * q_w6l + poly_acc_034.q.w6.low, c_i * q_w6h + poly_acc_034.q.w6.high),
            Uint256(c_i * q_w7l + poly_acc_034.q.w7.low, c_i * q_w7h + poly_acc_034.q.w7.high),
            Uint256(c_i * q_w8l + poly_acc_034.q.w8.low, c_i * q_w8h + poly_acc_034.q.w8.high),
        ),
        r=E12full(
            BigInt3(
                d0=c_i * r_w0d0 + poly_acc_034.r.w0.d0,
                d1=c_i * r_w0d1 + poly_acc_034.r.w0.d1,
                d2=c_i * r_w0d2 + poly_acc_034.r.w0.d2,
            ),
            BigInt3(
                d0=c_i * r_w1d0 + poly_acc_034.r.w1.d0,
                d1=c_i * r_w1d1 + poly_acc_034.r.w1.d1,
                d2=c_i * r_w1d2 + poly_acc_034.r.w1.d2,
            ),
            BigInt3(
                d0=c_i * r_w2d0 + poly_acc_034.r.w2.d0,
                d1=c_i * r_w2d1 + poly_acc_034.r.w2.d1,
                d2=c_i * r_w2d2 + poly_acc_034.r.w2.d2,
            ),
            BigInt3(
                d0=c_i * r_w3d0 + poly_acc_034.r.w3.d0,
                d1=c_i * r_w3d1 + poly_acc_034.r.w3.d1,
                d2=c_i * r_w3d2 + poly_acc_034.r.w3.d2,
            ),
            BigInt3(
                d0=c_i * r_w4d0 + poly_acc_034.r.w4.d0,
                d1=c_i * r_w4d1 + poly_acc_034.r.w4.d1,
                d2=c_i * r_w4d2 + poly_acc_034.r.w4.d2,
            ),
            BigInt3(
                d0=c_i * r_w5d0 + poly_acc_034.r.w5.d0,
                d1=c_i * r_w5d1 + poly_acc_034.r.w5.d1,
                d2=c_i * r_w5d2 + poly_acc_034.r.w5.d2,
            ),
            BigInt3(
                d0=c_i * r_w6d0 + poly_acc_034.r.w6.d0,
                d1=c_i * r_w6d1 + poly_acc_034.r.w6.d1,
                d2=c_i * r_w6d2 + poly_acc_034.r.w6.d2,
            ),
            BigInt3(
                d0=c_i * r_w7d0 + poly_acc_034.r.w7.d0,
                d1=c_i * r_w7d1 + poly_acc_034.r.w7.d1,
                d2=c_i * r_w7d2 + poly_acc_034.r.w7.d2,
            ),
            BigInt3(
                d0=c_i * r_w8d0 + poly_acc_034.r.w8.d0,
                d1=c_i * r_w8d1 + poly_acc_034.r.w8.d1,
                d2=c_i * r_w8d2 + poly_acc_034.r.w8.d2,
            ),
            BigInt3(
                d0=c_i * r_w9d0 + poly_acc_034.r.w9.d0,
                d1=c_i * r_w9d1 + poly_acc_034.r.w9.d1,
                d2=c_i * r_w9d2 + poly_acc_034.r.w9.d2,
            ),
            BigInt3(
                d0=c_i * r_w10d0 + poly_acc_034.r.w10.d0,
                d1=c_i * r_w10d1 + poly_acc_034.r.w10.d1,
                d2=c_i * r_w10d2 + poly_acc_034.r.w10.d2,
            ),
            BigInt3(
                d0=c_i * r_w11d0 + poly_acc_034.r.w11.d0,
                d1=c_i * r_w11d1 + poly_acc_034.r.w11.d1,
                d2=c_i * r_w11d2 + poly_acc_034.r.w11.d2,
            ),
        ),
    );
...
func mul034_034_trick{
...
}(x: E12full034*, y: E12full034*) -> E12full01234* {
    alloc_locals;
    let (__fp__, _) = get_fp_and_pc();
    ...
    let r_w4d2 = [range_check_ptr + 14];
    // w5 = 0
    let r_w6d0 = [range_check_ptr + 15];
    let r_w6d1 = [range_check_ptr + 16];
    let r_w6d2 = [range_check_ptr + 17];
    let r_w7d0 = [range_check_ptr + 18];
    let r_w7d1 = [range_check_ptr + 19];
    let r_w7d2 = [range_check_ptr + 20];
    let r_w8d0 = [range_check_ptr + 21];
    let r_w8d1 = [range_check_ptr + 22];
    let r_w8d2 = [range_check_ptr + 23];
    let r_w9d0 = [range_check_ptr + 24];
    let r_w9d1 = [range_check_ptr + 25];
    let r_w9d2 = [range_check_ptr + 26];
    let r_w10d0 = [range_check_ptr + 27];
    let r_w10d1 = [range_check_ptr + 28];
    let r_w10d2 = [range_check_ptr + 29];
    let r_w11d0 = [range_check_ptr + 30];
    let r_w11d1 = [range_check_ptr + 31];
    let r_w11d2 = [range_check_ptr + 32];
    let q_w0l = [range_check_ptr + 33];
    let q_w0h = [range_check_ptr + 34];
    let q_w1l = [range_check_ptr + 35];
    let q_w1h = [range_check_ptr + 36];
    let q_w2l = [range_check_ptr + 37];
    let q_w2h = [range_check_ptr + 38];
    let q_w3l = [range_check_ptr + 39];
    let q_w3h = [range_check_ptr + 40];
    let q_w4l = [range_check_ptr + 41];
    let q_w4h = [range_check_ptr + 42];
    let q_w5l = [range_check_ptr + 43];
    let q_w5h = [range_check_ptr + 44];
    let q_w6l = [range_check_ptr + 45];
    let q_w6h = [range_check_ptr + 46];
    ...
    %{
        ...
        for i in range(7):
            ...
            setattr(ids,f'q_w{i}h', val[1])
    %}
    tempvar r_w: E12full01234* = cast(range_check_ptr, E12full01234*);
    assert [range_check_ptr + 47] = THREE_BASE_MIN_1 - (r_w0d0 + r_w0d1 + r_w0d2);
    assert [range_check_ptr + 48] = THREE_BASE_MIN_1 - (r_w1d0 + r_w1d1 + r_w1d2);
    assert [range_check_ptr + 49] = THREE_BASE_MIN_1 - (r_w2d0 + r_w2d1 + r_w2d2);
    assert [range_check_ptr + 50] = THREE_BASE_MIN_1 - (r_w3d0 + r_w3d1 + r_w3d2);
    assert [range_check_ptr + 51] = THREE_BASE_MIN_1 - (r_w4d0 + r_w4d1 + r_w4d2);
    assert [range_check_ptr + 52] = THREE_BASE_MIN_1 - (r_w6d0 + r_w6d1 + r_w6d2);
    assert [range_check_ptr + 53] = THREE_BASE_MIN_1 - (r_w7d0 + r_w7d1 + r_w7d2);
    assert [range_check_ptr + 54] = THREE_BASE_MIN_1 - (r_w8d0 + r_w8d1 + r_w8d2);
    assert [range_check_ptr + 55] = THREE_BASE_MIN_1 - (r_w9d0 + r_w9d1 + r_w9d2);
    assert [range_check_ptr + 56] = THREE_BASE_MIN_1 - (r_w10d0 + r_w10d1 + r_w10d2);
    assert [range_check_ptr + 57] = THREE_BASE_MIN_1 - (r_w11d0 + r_w11d1 + r_w11d2);
    ...
    assert poseidon_ptr[12].input = PoseidonBuiltinState(
        s0=q_w0l, s1=poseidon_ptr[11].output.s0, s2=2
    );
    assert poseidon_ptr[13].input = PoseidonBuiltinState(
        s0=q_w0h, s1=poseidon_ptr[12].output.s0, s2=2
    );
    assert poseidon_ptr[14].input = PoseidonBuiltinState(
        s0=q_w1l, s1=poseidon_ptr[13].output.s0, s2=2
    );
    assert poseidon_ptr[15].input = PoseidonBuiltinState(
        s0=q_w1h, s1=poseidon_ptr[14].output.s0, s2=2
    );
    assert poseidon_ptr[16].input = PoseidonBuiltinState(
        s0=q_w2l, s1=poseidon_ptr[15].output.s0, s2=2
    );
    assert poseidon_ptr[17].input = PoseidonBuiltinState(
        s0=q_w2h, s1=poseidon_ptr[16].output.s0, s2=2
    );
    assert poseidon_ptr[18].input = PoseidonBuiltinState(
        s0=q_w3l, s1=poseidon_ptr[17].output.s0, s2=2
    );
    assert poseidon_ptr[19].input = PoseidonBuiltinState(
        s0=q_w3h, s1=poseidon_ptr[18].output.s0, s2=2
    );
    assert poseidon_ptr[20].input = PoseidonBuiltinState(
        s0=q_w4l, s1=poseidon_ptr[19].output.s0, s2=2
    );
    assert poseidon_ptr[21].input = PoseidonBuiltinState(
        s0=q_w4h, s1=poseidon_ptr[20].output.s0, s2=2
    );
    assert poseidon_ptr[22].input = PoseidonBuiltinState(
        s0=q_w5l, s1=poseidon_ptr[21].output.s0, s2=2
    );
    assert poseidon_ptr[23].input = PoseidonBuiltinState(
        s0=q_w5h, s1=poseidon_ptr[22].output.s0, s2=2
    );
    assert poseidon_ptr[24].input = PoseidonBuiltinState(
        s0=q_w6l, s1=poseidon_ptr[23].output.s0, s2=2
    );
    assert poseidon_ptr[25].input = PoseidonBuiltinState(
        s0=q_w6h, s1=poseidon_ptr[24].output.s0, s2=2
    );
    assert poseidon_ptr[26].input = PoseidonBuiltinState(
        s0=r_w0d0 * r_w0d1, s1=poseidon_ptr[25].output.s0, s2=2
    );
    assert poseidon_ptr[27].input = PoseidonBuiltinState(
        s0=r_w0d2 * r_w1d0, s1=poseidon_ptr[26].output.s0, s2=2
    );
    assert poseidon_ptr[28].input = PoseidonBuiltinState(
        s0=r_w1d1 * r_w1d2, s1=poseidon_ptr[27].output.s0, s2=2
    );
    assert poseidon_ptr[29].input = PoseidonBuiltinState(
        s0=r_w2d0 * r_w2d1, s1=poseidon_ptr[28].output.s0, s2=2
    );
    assert poseidon_ptr[30].input = PoseidonBuiltinState(
        s0=r_w2d2 * r_w3d0, s1=poseidon_ptr[29].output.s0, s2=2
    );
    assert poseidon_ptr[31].input = PoseidonBuiltinState(
        s0=r_w3d1 * r_w3d2, s1=poseidon_ptr[30].output.s0, s2=2
    );
    assert poseidon_ptr[32].input = PoseidonBuiltinState(
        s0=r_w4d0 * r_w4d1, s1=poseidon_ptr[31].output.s0, s2=2
    );
    assert poseidon_ptr[33].input = PoseidonBuiltinState(
        s0=r_w4d2 * r_w6d0, s1=poseidon_ptr[32].output.s0, s2=2
    );
    assert poseidon_ptr[34].input = PoseidonBuiltinState(
        s0=r_w6d1 * r_w6d2, s1=poseidon_ptr[33].output.s0, s2=2
    );
    assert poseidon_ptr[35].input = PoseidonBuiltinState(
        s0=r_w7d0 * r_w7d1, s1=poseidon_ptr[34].output.s0, s2=2
    );
    assert poseidon_ptr[36].input = PoseidonBuiltinState(
        s0=r_w7d2 * r_w8d0, s1=poseidon_ptr[35].output.s0, s2=2
    );
    assert poseidon_ptr[37].input = PoseidonBuiltinState(
        s0=r_w8d1 * r_w8d2, s1=poseidon_ptr[36].output.s0, s2=2
    );
    assert poseidon_ptr[38].input = PoseidonBuiltinState(
        s0=r_w9d0 * r_w9d1, s1=poseidon_ptr[37].output.s0, s2=2
    );
    assert poseidon_ptr[39].input = PoseidonBuiltinState(
        s0=r_w9d2 * r_w10d0, s1=poseidon_ptr[38].output.s0, s2=2
    );
    assert poseidon_ptr[40].input = PoseidonBuiltinState(
        s0=r_w10d1 * r_w10d2, s1=poseidon_ptr[39].output.s0, s2=2
    );
    assert poseidon_ptr[41].input = PoseidonBuiltinState(
        s0=r_w11d0 * r_w11d1, s1=poseidon_ptr[40].output.s0, s2=2
    );
    assert poseidon_ptr[42].input = PoseidonBuiltinState(
        s0=r_w11d2, s1=poseidon_ptr[41].output.s0, s2=2
    );
    ...
    local poly_acc_034034_f: PolyAcc034034 = PolyAcc034034(
        ...
        q=E7full(
            Uint256(
                c_i * q_w0l + poly_acc_034034.q.w0.low, c_i * q_w0h + poly_acc_034034.q.w0.high
            ),
            Uint256(
                c_i * q_w1l + poly_acc_034034.q.w1.low, c_i * q_w1h + poly_acc_034034.q.w1.high
            ),
            Uint256(
                c_i * q_w2l + poly_acc_034034.q.w2.low, c_i * q_w2h + poly_acc_034034.q.w2.high
            ),
            Uint256(
                c_i * q_w3l + poly_acc_034034.q.w3.low, c_i * q_w3h + poly_acc_034034.q.w3.high
            ),
            Uint256(
                c_i * q_w4l + poly_acc_034034.q.w4.low, c_i * q_w4h + poly_acc_034034.q.w4.high
            ),
            Uint256(
                c_i * q_w5l + poly_acc_034034.q.w5.low, c_i * q_w5h + poly_acc_034034.q.w5.high
            ),
            Uint256(
                c_i * q_w6l + poly_acc_034034.q.w6.low, c_i * q_w6h + poly_acc_034034.q.w6.high
            ),
        ),
        r=E12full01234(
            w0=BigInt3(
                d0=c_i * r_w0d0 + poly_acc_034034.r.w0.d0,
                d1=c_i * r_w0d1 + poly_acc_034034.r.w0.d1,
                d2=c_i * r_w0d2 + poly_acc_034034.r.w0.d2,
            ),
            w1=BigInt3(
                d0=c_i * r_w1d0 + poly_acc_034034.r.w1.d0,
                d1=c_i * r_w1d1 + poly_acc_034034.r.w1.d1,
                d2=c_i * r_w1d2 + poly_acc_034034.r.w1.d2,
            ),
            w2=BigInt3(
                d0=c_i * r_w2d0 + poly_acc_034034.r.w2.d0,
                d1=c_i * r_w2d1 + poly_acc_034034.r.w2.d1,
                d2=c_i * r_w2d2 + poly_acc_034034.r.w2.d2,
            ),
            w3=BigInt3(
                d0=c_i * r_w3d0 + poly_acc_034034.r.w3.d0,
                d1=c_i * r_w3d1 + poly_acc_034034.r.w3.d1,
                d2=c_i * r_w3d2 + poly_acc_034034.r.w3.d2,
            ),
            w4=BigInt3(
                d0=c_i * r_w4d0 + poly_acc_034034.r.w4.d0,
                d1=c_i * r_w4d1 + poly_acc_034034.r.w4.d1,
                d2=c_i * r_w4d2 + poly_acc_034034.r.w4.d2,
            ),
            w6=BigInt3(
                d0=c_i * r_w6d0 + poly_acc_034034.r.w6.d0,
                d1=c_i * r_w6d1 + poly_acc_034034.r.w6.d1,
                d2=c_i * r_w6d2 + poly_acc_034034.r.w6.d2,
            ),
            w7=BigInt3(
                d0=c_i * r_w7d0 + poly_acc_034034.r.w7.d0,
                d1=c_i * r_w7d1 + poly_acc_034034.r.w7.d1,
                d2=c_i * r_w7d2 + poly_acc_034034.r.w7.d2,
            ),
            w8=BigInt3(
                d0=c_i * r_w8d0 + poly_acc_034034.r.w8.d0,
                d1=c_i * r_w8d1 + poly_acc_034034.r.w8.d1,
                d2=c_i * r_w8d2 + poly_acc_034034.r.w8.d2,
            ),
            w9=BigInt3(
                d0=c_i * r_w9d0 + poly_acc_034034.r.w9.d0,
                d1=c_i * r_w9d1 + poly_acc_034034.r.w9.d1,
                d2=c_i * r_w9d2 + poly_acc_034034.r.w9.d2,
            ),
            w10=BigInt3(
                d0=c_i * r_w10d0 + poly_acc_034034.r.w10.d0,
                d1=c_i * r_w10d1 + poly_acc_034034.r.w10.d1,
                d2=c_i * r_w10d2 + poly_acc_034034.r.w10.d2,
            ),
            w11=BigInt3(
                d0=c_i * r_w11d0 + poly_acc_034034.r.w11.d0,
                d1=c_i * r_w11d1 + poly_acc_034034.r.w11.d1,
                d2=c_i * r_w11d2 + poly_acc_034034.r.w11.d2,
            ),
        ),
    );
...
func mul01234_trick{
...
}(x: E12full*, y: E12full01234*) -> E12full* {
    alloc_locals;
    let (__fp__, _) = get_fp_and_pc();
    // local r_w: E12full;
    // local q_w: E11full;
    ...
    assert poseidon_ptr[34].input = PoseidonBuiltinState(
        s0=y.w11.d2 * q_w0l, s1=poseidon_ptr[33].output.s0, s2=2
    );
    assert poseidon_ptr[35].input = PoseidonBuiltinState(
        s0=q_w0h, s1=poseidon_ptr[34].output.s0, s2=2
    );
    assert poseidon_ptr[36].input = PoseidonBuiltinState(
        s0=q_w1l, s1=poseidon_ptr[35].output.s0, s2=2
    );
    assert poseidon_ptr[37].input = PoseidonBuiltinState(
        s0=q_w1h, s1=poseidon_ptr[36].output.s0, s2=2
    );
    assert poseidon_ptr[38].input = PoseidonBuiltinState(
        s0=q_w2l, s1=poseidon_ptr[37].output.s0, s2=2
    );
    assert poseidon_ptr[39].input = PoseidonBuiltinState(
        s0=q_w2h, s1=poseidon_ptr[38].output.s0, s2=2
    );
    assert poseidon_ptr[40].input = PoseidonBuiltinState(
        s0=q_w3l, s1=poseidon_ptr[39].output.s0, s2=2
    );
    assert poseidon_ptr[41].input = PoseidonBuiltinState(
        s0=q_w3h, s1=poseidon_ptr[40].output.s0, s2=2
    );
    assert poseidon_ptr[42].input = PoseidonBuiltinState(
        s0=q_w4l, s1=poseidon_ptr[41].output.s0, s2=2
    );
    assert poseidon_ptr[43].input = PoseidonBuiltinState(
        s0=q_w4h, s1=poseidon_ptr[42].output.s0, s2=2
    );
    assert poseidon_ptr[44].input = PoseidonBuiltinState(
        s0=q_w5l, s1=poseidon_ptr[43].output.s0, s2=2
    );
    assert poseidon_ptr[45].input = PoseidonBuiltinState(
        s0=q_w5h, s1=poseidon_ptr[44].output.s0, s2=2
    );
    assert poseidon_ptr[46].input = PoseidonBuiltinState(
        s0=q_w6l, s1=poseidon_ptr[45].output.s0, s2=2
    );
    assert poseidon_ptr[47].input = PoseidonBuiltinState(
        s0=q_w6h, s1=poseidon_ptr[46].output.s0, s2=2
    );
    assert poseidon_ptr[48].input = PoseidonBuiltinState(
        s0=q_w7l, s1=poseidon_ptr[47].output.s0, s2=2
    );
    assert poseidon_ptr[49].input = PoseidonBuiltinState(
        s0=q_w7h, s1=poseidon_ptr[48].output.s0, s2=2
    );
    assert poseidon_ptr[50].input = PoseidonBuiltinState(
        s0=q_w8l, s1=poseidon_ptr[49].output.s0, s2=2
    );
    assert poseidon_ptr[51].input = PoseidonBuiltinState(
        s0=q_w8h, s1=poseidon_ptr[50].output.s0, s2=2
    );
    assert poseidon_ptr[52].input = PoseidonBuiltinState(
        s0=q_w9l, s1=poseidon_ptr[51].output.s0, s2=2
    );
    assert poseidon_ptr[53].input = PoseidonBuiltinState(
        s0=q_w9h, s1=poseidon_ptr[52].output.s0, s2=2
    );
    assert poseidon_ptr[54].input = PoseidonBuiltinState(
        s0=q_w10l, s1=poseidon_ptr[53].output.s0, s2=2
    );
    assert poseidon_ptr[55].input = PoseidonBuiltinState(
        s0=q_w10h, s1=poseidon_ptr[54].output.s0, s2=2
    );
    ...
    let (y_of_z_w1) = bigint_mul(y.w1, z_pow1_11.z_1);
    let (y_of_z_w2) = bigint_mul(y.w2, z_pow1_11.z_2);
    let (y_of_z_w3) = bigint_mul(y.w3, z_pow1_11.z_3);
    let (y_of_z_w4) = bigint_mul(y.w4, z_pow1_11.z_4);
    let (y_of_z_w6) = bigint_mul(y.w6, z_pow1_11.z_6);
    let (y_of_z_w7) = bigint_mul(y.w7, z_pow1_11.z_7);
    let (y_of_z_w8) = bigint_mul(y.w8, z_pow1_11.z_8);
    let (y_of_z_w9) = bigint_mul(y.w9, z_pow1_11.z_9);
    let (y_of_z_w10) = bigint_mul(y.w10, z_pow1_11.z_10);
    let (y_of_z_w11) = bigint_mul(y.w11, z_pow1_11.z_11);
    ...
    local poly_acc_01234_f: PolyAcc12 = PolyAcc12(
        ...
        q=E11full(
            Uint256(c_i * q_w0l + poly_acc_01234.q.w0.low, c_i * q_w0h + poly_acc_01234.q.w0.high),
            Uint256(c_i * q_w1l + poly_acc_01234.q.w1.low, c_i * q_w1h + poly_acc_01234.q.w1.high),
            Uint256(c_i * q_w2l + poly_acc_01234.q.w2.low, c_i * q_w2h + poly_acc_01234.q.w2.high),
            Uint256(c_i * q_w3l + poly_acc_01234.q.w3.low, c_i * q_w3h + poly_acc_01234.q.w3.high),
            Uint256(c_i * q_w4l + poly_acc_01234.q.w4.low, c_i * q_w4h + poly_acc_01234.q.w4.high),
            Uint256(c_i * q_w5l + poly_acc_01234.q.w5.low, c_i * q_w5h + poly_acc_01234.q.w5.high),
            Uint256(c_i * q_w6l + poly_acc_01234.q.w6.low, c_i * q_w6h + poly_acc_01234.q.w6.high),
            Uint256(c_i * q_w7l + poly_acc_01234.q.w7.low, c_i * q_w7h + poly_acc_01234.q.w7.high),
            Uint256(c_i * q_w8l + poly_acc_01234.q.w8.low, c_i * q_w8h + poly_acc_01234.q.w8.high),
            Uint256(c_i * q_w9l + poly_acc_01234.q.w9.low, c_i * q_w9h + poly_acc_01234.q.w9.high),
            Uint256(
                c_i * q_w10l + poly_acc_01234.q.w10.low, c_i * q_w10h + poly_acc_01234.q.w10.high
            ),
        ),
        r=E12full(
            BigInt3(
                d0=c_i * r_w0d0 + poly_acc_01234.r.w0.d0,
                d1=c_i * r_w0d1 + poly_acc_01234.r.w0.d1,
                d2=c_i * r_w0d2 + poly_acc_01234.r.w0.d2,
            ),
            BigInt3(
                d0=c_i * r_w1d0 + poly_acc_01234.r.w1.d0,
                d1=c_i * r_w1d1 + poly_acc_01234.r.w1.d1,
                d2=c_i * r_w1d2 + poly_acc_01234.r.w1.d2,
            ),
            BigInt3(
                d0=c_i * r_w2d0 + poly_acc_01234.r.w2.d0,
                d1=c_i * r_w2d1 + poly_acc_01234.r.w2.d1,
                d2=c_i * r_w2d2 + poly_acc_01234.r.w2.d2,
            ),
            BigInt3(
                d0=c_i * r_w3d0 + poly_acc_01234.r.w3.d0,
                d1=c_i * r_w3d1 + poly_acc_01234.r.w3.d1,
                d2=c_i * r_w3d2 + poly_acc_01234.r.w3.d2,
            ),
            BigInt3(
                d0=c_i * r_w4d0 + poly_acc_01234.r.w4.d0,
                d1=c_i * r_w4d1 + poly_acc_01234.r.w4.d1,
                d2=c_i * r_w4d2 + poly_acc_01234.r.w4.d2,
            ),
            BigInt3(
                d0=c_i * r_w5d0 + poly_acc_01234.r.w5.d0,
                d1=c_i * r_w5d1 + poly_acc_01234.r.w5.d1,
                d2=c_i * r_w5d2 + poly_acc_01234.r.w5.d2,
            ),
            BigInt3(
                d0=c_i * r_w6d0 + poly_acc_01234.r.w6.d0,
                d1=c_i * r_w6d1 + poly_acc_01234.r.w6.d1,
                d2=c_i * r_w6d2 + poly_acc_01234.r.w6.d2,
            ),
            BigInt3(
                d0=c_i * r_w7d0 + poly_acc_01234.r.w7.d0,
                d1=c_i * r_w7d1 + poly_acc_01234.r.w7.d1,
                d2=c_i * r_w7d2 + poly_acc_01234.r.w7.d2,
            ),
            BigInt3(
                d0=c_i * r_w8d0 + poly_acc_01234.r.w8.d0,
                d1=c_i * r_w8d1 + poly_acc_01234.r.w8.d1,
                d2=c_i * r_w8d2 + poly_acc_01234.r.w8.d2,
            ),
            BigInt3(
                d0=c_i * r_w9d0 + poly_acc_01234.r.w9.d0,
                d1=c_i * r_w9d1 + poly_acc_01234.r.w9.d1,
                d2=c_i * r_w9d2 + poly_acc_01234.r.w9.d2,
            ),
            BigInt3(
                d0=c_i * r_w10d0 + poly_acc_01234.r.w10.d0,
                d1=c_i * r_w10d1 + poly_acc_01234.r.w10.d1,
                d2=c_i * r_w10d2 + poly_acc_01234.r.w10.d2,
            ),
            BigInt3(
                d0=c_i * r_w11d0 + poly_acc_01234.r.w11.d0,
                d1=c_i * r_w11d1 + poly_acc_01234.r.w11.d1,
                d2=c_i * r_w11d2 + poly_acc_01234.r.w11.d2,
            ),
        ),
    );
...
func get_powers_of_z{range_check_ptr}(z: BigInt3*) -> ZPowers11* {
    alloc_locals;
    let (__fp__, _) = get_fp_and_pc();
    ...
    local z_powers: ZPowers11 = ZPowers11(
        z_1=[z],
        z_2=[z_2],
        z_3=[z_3],
        z_4=[z_4],
