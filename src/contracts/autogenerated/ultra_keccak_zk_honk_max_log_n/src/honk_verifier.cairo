use super::honk_verifier_circuits::{
    run_BN254_EVAL_FN_CHALLENGE_SING_63P_RLC_circuit,
    ...
    run_GRUMPKIN_ZK_HONK_SUMCHECK_SIZE_23_PUB_20_circuit,
};
...
mod UltraKeccakZKHonkVerifier {
    ...
    use super::{
        VK_HASH, precomputed_lines, run_BN254_EVAL_FN_CHALLENGE_SING_63P_RLC_circuit,
        run_GRUMPKIN_ZKHONK_PREP_MSM_SCALARS_SIZE_23_circuit,
        run_GRUMPKIN_ZK_HONK_EVALS_CONS_DONE_SIZE_23_circuit,
        run_GRUMPKIN_ZK_HONK_EVALS_CONS_INIT_SIZE_23_circuit,
        run_GRUMPKIN_ZK_HONK_EVALS_CONS_LOOP_SIZE_23_circuit,
        run_GRUMPKIN_ZK_HONK_SUMCHECK_SIZE_23_PUB_20_circuit, vk,
    };
    ...
    impl IUltraKeccakZKHonkVerifier of super::IUltraKeccakZKHonkVerifier<ContractState> {
        fn verify_ultra_keccak_zk_honk_proof(
            ...
            let (sum_check_rlc, honk_check) = run_GRUMPKIN_ZK_HONK_SUMCHECK_SIZE_23_PUB_20_circuit(
            ...
            let scalars: Span<u256> = array![
                ...
                into_u256_unchecked(scalar_58),
                into_u256_unchecked(scalar_59),
                into_u256_unchecked(scalar_60),
                into_u256_unchecked(scalar_61),
                into_u256_unchecked(scalar_62),
                into_u256_unchecked(scalar_63),
            ...
            // Skip the first 27 points as they are from VK and keep the last 35 proof points
            for point in points.slice(27, 35) {
            ...
            let (lhs_fA0) = run_BN254_EVAL_FN_CHALLENGE_SING_63P_RLC_circuit(
                A: random_point,
                coeff: mb.coeff0,
                SumDlogDivBatched: full_proof.msm_hint_batched.RLCSumDlogDiv,
            );
            let (lhs_fA2) = run_BN254_EVAL_FN_CHALLENGE_SING_63P_RLC_circuit(
