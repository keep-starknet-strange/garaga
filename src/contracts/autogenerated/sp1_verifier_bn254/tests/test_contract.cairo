...
use sp1_verifier_bn254::groth16_verifier::{
    ISP1Groth16VerifierBN254Dispatcher, ISP1Groth16VerifierBN254DispatcherTrait,
};
use starknet::ContractAddress;

/// Deploy the SP1Groth16VerifierBN254 contract for testing.
///
/// This function declares and deploys a new instance of the SP1Groth16VerifierBN254 contract
...
/// # Example
/// ```cairo
/// let contract_address = deploy_contract("SP1Groth16VerifierBN254");
/// let dispatcher = ISP1Groth16VerifierBN254Dispatcher { contract_address };
/// ```
