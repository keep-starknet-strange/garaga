...
use groth16_example_bls12_381::groth16_verifier::{
    IGroth16VerifierBLS12_381Dispatcher, IGroth16VerifierBLS12_381DispatcherTrait,
};
use snforge_std::fs::{File, FileTrait, read_txt};
use snforge_std::{ContractClassTrait, DeclareResultTrait, declare};
use starknet::ContractAddress;

/// Deploy the Groth16VerifierBLS12_381 contract for testing.
///
/// This function declares and deploys a new instance of the Groth16VerifierBLS12_381 contract
...
/// # Example
/// ```cairo
/// let contract_address = deploy_contract("Groth16VerifierBLS12_381");
/// let dispatcher = IGroth16VerifierBLS12_381Dispatcher { contract_address };
/// ```
