...
/// Deploy the UltraStarknetHonkVerifier contract for testing.
///
/// This function declares and deploys a new instance of the UltraStarknetHonkVerifier contract
...
/// # Example
/// ```cairo
/// let contract_address = deploy_contract("UltraStarknetHonkVerifier");
/// let dispatcher = IUltraStarknetHonkVerifierDispatcher { contract_address };
/// ```
...
/// ```bash
/// garaga calldata ///     --system ultra_starknet_honk ///     --vk path/to/vk ///     --proof
