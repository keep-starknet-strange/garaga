...
pub fn run_BN254_EVAL_FN_CHALLENGE_SING_48P_RLC_circuit<
...
>(
    ...
    let (in207, in208, in209) = (CE::<CI<207>> {}, CE::<CI<208>> {}, CE::<CI<209>> {});
    let (in210, in211, in212) = (CE::<CI<210>> {}, CE::<CI<211>> {}, CE::<CI<212>> {});
    let t0 = circuit_mul(in53, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
    let t1 = circuit_add(in52, t0); // Eval sumdlogdiv_a_num Horner step: add coefficient_49
    let t2 = circuit_mul(t1, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
    let t3 = circuit_add(in51, t2); // Eval sumdlogdiv_a_num Horner step: add coefficient_48
    let t4 = circuit_mul(t3, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
    let t5 = circuit_add(in50, t4); // Eval sumdlogdiv_a_num Horner step: add coefficient_47
    let t6 = circuit_mul(t5, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
    let t7 = circuit_add(in49, t6); // Eval sumdlogdiv_a_num Horner step: add coefficient_46
    let t8 = circuit_mul(t7, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
    let t9 = circuit_add(in48, t8); // Eval sumdlogdiv_a_num Horner step: add coefficient_45
    let t10 = circuit_mul(t9, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
    let t11 = circuit_add(in47, t10); // Eval sumdlogdiv_a_num Horner step: add coefficient_44
    let t12 = circuit_mul(t11, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
    let t13 = circuit_add(in46, t12); // Eval sumdlogdiv_a_num Horner step: add coefficient_43
    let t14 = circuit_mul(t13, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
    let t15 = circuit_add(in45, t14); // Eval sumdlogdiv_a_num Horner step: add coefficient_42
    let t16 = circuit_mul(t15, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
    let t17 = circuit_add(in44, t16); // Eval sumdlogdiv_a_num Horner step: add coefficient_41
    let t18 = circuit_mul(t17, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
    let t19 = circuit_add(in43, t18); // Eval sumdlogdiv_a_num Horner step: add coefficient_40
    let t20 = circuit_mul(t19, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
    let t21 = circuit_add(in42, t20); // Eval sumdlogdiv_a_num Horner step: add coefficient_39
    let t22 = circuit_mul(t21, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
    let t23 = circuit_add(in41, t22); // Eval sumdlogdiv_a_num Horner step: add coefficient_38
    let t24 = circuit_mul(t23, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
    let t25 = circuit_add(in40, t24); // Eval sumdlogdiv_a_num Horner step: add coefficient_37
    let t26 = circuit_mul(t25, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
    let t27 = circuit_add(in39, t26); // Eval sumdlogdiv_a_num Horner step: add coefficient_36
    let t28 = circuit_mul(t27, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
    let t29 = circuit_add(in38, t28); // Eval sumdlogdiv_a_num Horner step: add coefficient_35
    let t30 = circuit_mul(t29, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
    let t31 = circuit_add(in37, t30); // Eval sumdlogdiv_a_num Horner step: add coefficient_34
    let t32 = circuit_mul(t31, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
    let t33 = circuit_add(in36, t32); // Eval sumdlogdiv_a_num Horner step: add coefficient_33
    let t34 = circuit_mul(t33, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
    let t35 = circuit_add(in35, t34); // Eval sumdlogdiv_a_num Horner step: add coefficient_32
    let t36 = circuit_mul(t35, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
    let t37 = circuit_add(in34, t36); // Eval sumdlogdiv_a_num Horner step: add coefficient_31
    let t38 = circuit_mul(t37, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
    let t39 = circuit_add(in33, t38); // Eval sumdlogdiv_a_num Horner step: add coefficient_30
    let t40 = circuit_mul(t39, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
    let t41 = circuit_add(in32, t40); // Eval sumdlogdiv_a_num Horner step: add coefficient_29
    let t42 = circuit_mul(t41, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
    let t43 = circuit_add(in31, t42); // Eval sumdlogdiv_a_num Horner step: add coefficient_28
    let t44 = circuit_mul(t43, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
    let t45 = circuit_add(in30, t44); // Eval sumdlogdiv_a_num Horner step: add coefficient_27
    let t46 = circuit_mul(t45, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
    let t47 = circuit_add(in29, t46); // Eval sumdlogdiv_a_num Horner step: add coefficient_26
    let t48 = circuit_mul(t47, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
    let t49 = circuit_add(in28, t48); // Eval sumdlogdiv_a_num Horner step: add coefficient_25
    let t50 = circuit_mul(t49, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
    let t51 = circuit_add(in27, t50); // Eval sumdlogdiv_a_num Horner step: add coefficient_24
    let t52 = circuit_mul(t51, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
    let t53 = circuit_add(in26, t52); // Eval sumdlogdiv_a_num Horner step: add coefficient_23
    let t54 = circuit_mul(t53, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
    let t55 = circuit_add(in25, t54); // Eval sumdlogdiv_a_num Horner step: add coefficient_22
    let t56 = circuit_mul(t55, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
    let t57 = circuit_add(in24, t56); // Eval sumdlogdiv_a_num Horner step: add coefficient_21
    let t58 = circuit_mul(t57, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
    let t59 = circuit_add(in23, t58); // Eval sumdlogdiv_a_num Horner step: add coefficient_20
    let t60 = circuit_mul(t59, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
    let t61 = circuit_add(in22, t60); // Eval sumdlogdiv_a_num Horner step: add coefficient_19
    let t62 = circuit_mul(t61, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
    let t63 = circuit_add(in21, t62); // Eval sumdlogdiv_a_num Horner step: add coefficient_18
    let t64 = circuit_mul(t63, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
    let t65 = circuit_add(in20, t64); // Eval sumdlogdiv_a_num Horner step: add coefficient_17
    let t66 = circuit_mul(t65, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
    let t67 = circuit_add(in19, t66); // Eval sumdlogdiv_a_num Horner step: add coefficient_16
    let t68 = circuit_mul(t67, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
    let t69 = circuit_add(in18, t68); // Eval sumdlogdiv_a_num Horner step: add coefficient_15
    let t70 = circuit_mul(t69, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
    let t71 = circuit_add(in17, t70); // Eval sumdlogdiv_a_num Horner step: add coefficient_14
    let t72 = circuit_mul(t71, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
    let t73 = circuit_add(in16, t72); // Eval sumdlogdiv_a_num Horner step: add coefficient_13
    let t74 = circuit_mul(t73, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
    let t75 = circuit_add(in15, t74); // Eval sumdlogdiv_a_num Horner step: add coefficient_12
    let t76 = circuit_mul(t75, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
    let t77 = circuit_add(in14, t76); // Eval sumdlogdiv_a_num Horner step: add coefficient_11
    let t78 = circuit_mul(t77, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
    let t79 = circuit_add(in13, t78); // Eval sumdlogdiv_a_num Horner step: add coefficient_10
    let t80 = circuit_mul(t79, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
    let t81 = circuit_add(in12, t80); // Eval sumdlogdiv_a_num Horner step: add coefficient_9
    let t82 = circuit_mul(t81, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
    let t83 = circuit_add(in11, t82); // Eval sumdlogdiv_a_num Horner step: add coefficient_8
    let t84 = circuit_mul(t83, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
    let t85 = circuit_add(in10, t84); // Eval sumdlogdiv_a_num Horner step: add coefficient_7
    let t86 = circuit_mul(t85, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
    let t87 = circuit_add(in9, t86); // Eval sumdlogdiv_a_num Horner step: add coefficient_6
    let t88 = circuit_mul(t87, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
    let t89 = circuit_add(in8, t88); // Eval sumdlogdiv_a_num Horner step: add coefficient_5
    let t90 = circuit_mul(t89, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
    let t91 = circuit_add(in7, t90); // Eval sumdlogdiv_a_num Horner step: add coefficient_4
    let t92 = circuit_mul(t91, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
    let t93 = circuit_add(in6, t92); // Eval sumdlogdiv_a_num Horner step: add coefficient_3
    let t94 = circuit_mul(t93, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
    let t95 = circuit_add(in5, t94); // Eval sumdlogdiv_a_num Horner step: add coefficient_2
    let t96 = circuit_mul(t95, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
    let t97 = circuit_add(in4, t96); // Eval sumdlogdiv_a_num Horner step: add coefficient_1
    let t98 = circuit_mul(t97, in0); // Eval sumdlogdiv_a_num Horner step: multiply by xA
    let t99 = circuit_add(in3, t98); // Eval sumdlogdiv_a_num Horner step: add coefficient_0
    let t100 = circuit_mul(in105, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
    let t101 = circuit_add(in104, t100); // Eval sumdlogdiv_a_den Horner step: add coefficient_50
    let t102 = circuit_mul(t101, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
    let t103 = circuit_add(in103, t102); // Eval sumdlogdiv_a_den Horner step: add coefficient_49
    let t104 = circuit_mul(t103, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
    let t105 = circuit_add(in102, t104); // Eval sumdlogdiv_a_den Horner step: add coefficient_48
    let t106 = circuit_mul(t105, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
    let t107 = circuit_add(in101, t106); // Eval sumdlogdiv_a_den Horner step: add coefficient_47
    let t108 = circuit_mul(t107, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
    let t109 = circuit_add(in100, t108); // Eval sumdlogdiv_a_den Horner step: add coefficient_46
    let t110 = circuit_mul(t109, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
    let t111 = circuit_add(in99, t110); // Eval sumdlogdiv_a_den Horner step: add coefficient_45
    let t112 = circuit_mul(t111, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
    let t113 = circuit_add(in98, t112); // Eval sumdlogdiv_a_den Horner step: add coefficient_44
    let t114 = circuit_mul(t113, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
    let t115 = circuit_add(in97, t114); // Eval sumdlogdiv_a_den Horner step: add coefficient_43
    let t116 = circuit_mul(t115, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
    let t117 = circuit_add(in96, t116); // Eval sumdlogdiv_a_den Horner step: add coefficient_42
    let t118 = circuit_mul(t117, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
    let t119 = circuit_add(in95, t118); // Eval sumdlogdiv_a_den Horner step: add coefficient_41
    let t120 = circuit_mul(t119, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
    let t121 = circuit_add(in94, t120); // Eval sumdlogdiv_a_den Horner step: add coefficient_40
    let t122 = circuit_mul(t121, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
    let t123 = circuit_add(in93, t122); // Eval sumdlogdiv_a_den Horner step: add coefficient_39
    let t124 = circuit_mul(t123, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
    let t125 = circuit_add(in92, t124); // Eval sumdlogdiv_a_den Horner step: add coefficient_38
    let t126 = circuit_mul(t125, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
    let t127 = circuit_add(in91, t126); // Eval sumdlogdiv_a_den Horner step: add coefficient_37
    let t128 = circuit_mul(t127, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
    let t129 = circuit_add(in90, t128); // Eval sumdlogdiv_a_den Horner step: add coefficient_36
    let t130 = circuit_mul(t129, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
    let t131 = circuit_add(in89, t130); // Eval sumdlogdiv_a_den Horner step: add coefficient_35
    let t132 = circuit_mul(t131, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
    let t133 = circuit_add(in88, t132); // Eval sumdlogdiv_a_den Horner step: add coefficient_34
    let t134 = circuit_mul(t133, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
    let t135 = circuit_add(in87, t134); // Eval sumdlogdiv_a_den Horner step: add coefficient_33
    let t136 = circuit_mul(t135, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
    let t137 = circuit_add(in86, t136); // Eval sumdlogdiv_a_den Horner step: add coefficient_32
    let t138 = circuit_mul(t137, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
    let t139 = circuit_add(in85, t138); // Eval sumdlogdiv_a_den Horner step: add coefficient_31
    let t140 = circuit_mul(t139, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
    let t141 = circuit_add(in84, t140); // Eval sumdlogdiv_a_den Horner step: add coefficient_30
    let t142 = circuit_mul(t141, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
    let t143 = circuit_add(in83, t142); // Eval sumdlogdiv_a_den Horner step: add coefficient_29
    let t144 = circuit_mul(t143, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
    let t145 = circuit_add(in82, t144); // Eval sumdlogdiv_a_den Horner step: add coefficient_28
    let t146 = circuit_mul(t145, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
    let t147 = circuit_add(in81, t146); // Eval sumdlogdiv_a_den Horner step: add coefficient_27
    let t148 = circuit_mul(t147, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
    let t149 = circuit_add(in80, t148); // Eval sumdlogdiv_a_den Horner step: add coefficient_26
    let t150 = circuit_mul(t149, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
    let t151 = circuit_add(in79, t150); // Eval sumdlogdiv_a_den Horner step: add coefficient_25
    let t152 = circuit_mul(t151, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
    let t153 = circuit_add(in78, t152); // Eval sumdlogdiv_a_den Horner step: add coefficient_24
    let t154 = circuit_mul(t153, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
    let t155 = circuit_add(in77, t154); // Eval sumdlogdiv_a_den Horner step: add coefficient_23
    let t156 = circuit_mul(t155, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
    let t157 = circuit_add(in76, t156); // Eval sumdlogdiv_a_den Horner step: add coefficient_22
    let t158 = circuit_mul(t157, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
    let t159 = circuit_add(in75, t158); // Eval sumdlogdiv_a_den Horner step: add coefficient_21
    let t160 = circuit_mul(t159, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
    let t161 = circuit_add(in74, t160); // Eval sumdlogdiv_a_den Horner step: add coefficient_20
    let t162 = circuit_mul(t161, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
    let t163 = circuit_add(in73, t162); // Eval sumdlogdiv_a_den Horner step: add coefficient_19
    let t164 = circuit_mul(t163, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
    let t165 = circuit_add(in72, t164); // Eval sumdlogdiv_a_den Horner step: add coefficient_18
    let t166 = circuit_mul(t165, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
    let t167 = circuit_add(in71, t166); // Eval sumdlogdiv_a_den Horner step: add coefficient_17
    let t168 = circuit_mul(t167, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
    let t169 = circuit_add(in70, t168); // Eval sumdlogdiv_a_den Horner step: add coefficient_16
    let t170 = circuit_mul(t169, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
    let t171 = circuit_add(in69, t170); // Eval sumdlogdiv_a_den Horner step: add coefficient_15
    let t172 = circuit_mul(t171, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
    let t173 = circuit_add(in68, t172); // Eval sumdlogdiv_a_den Horner step: add coefficient_14
    let t174 = circuit_mul(t173, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
    let t175 = circuit_add(in67, t174); // Eval sumdlogdiv_a_den Horner step: add coefficient_13
    let t176 = circuit_mul(t175, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
    let t177 = circuit_add(in66, t176); // Eval sumdlogdiv_a_den Horner step: add coefficient_12
    let t178 = circuit_mul(t177, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
    let t179 = circuit_add(in65, t178); // Eval sumdlogdiv_a_den Horner step: add coefficient_11
    let t180 = circuit_mul(t179, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
    let t181 = circuit_add(in64, t180); // Eval sumdlogdiv_a_den Horner step: add coefficient_10
    let t182 = circuit_mul(t181, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
    let t183 = circuit_add(in63, t182); // Eval sumdlogdiv_a_den Horner step: add coefficient_9
    let t184 = circuit_mul(t183, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
    let t185 = circuit_add(in62, t184); // Eval sumdlogdiv_a_den Horner step: add coefficient_8
    let t186 = circuit_mul(t185, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
    let t187 = circuit_add(in61, t186); // Eval sumdlogdiv_a_den Horner step: add coefficient_7
    let t188 = circuit_mul(t187, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
    let t189 = circuit_add(in60, t188); // Eval sumdlogdiv_a_den Horner step: add coefficient_6
    let t190 = circuit_mul(t189, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
    let t191 = circuit_add(in59, t190); // Eval sumdlogdiv_a_den Horner step: add coefficient_5
    let t192 = circuit_mul(t191, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
    let t193 = circuit_add(in58, t192); // Eval sumdlogdiv_a_den Horner step: add coefficient_4
    let t194 = circuit_mul(t193, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
    let t195 = circuit_add(in57, t194); // Eval sumdlogdiv_a_den Horner step: add coefficient_3
    let t196 = circuit_mul(t195, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
    let t197 = circuit_add(in56, t196); // Eval sumdlogdiv_a_den Horner step: add coefficient_2
    let t198 = circuit_mul(t197, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
    let t199 = circuit_add(in55, t198); // Eval sumdlogdiv_a_den Horner step: add coefficient_1
    let t200 = circuit_mul(t199, in0); // Eval sumdlogdiv_a_den Horner step: multiply by xA
    let t201 = circuit_add(in54, t200); // Eval sumdlogdiv_a_den Horner step: add coefficient_0
    let t202 = circuit_inverse(t201);
    let t203 = circuit_mul(t99, t202);
    let t204 = circuit_mul(in157, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
    let t205 = circuit_add(in156, t204); // Eval sumdlogdiv_b_num Horner step: add coefficient_50
    let t206 = circuit_mul(t205, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
    let t207 = circuit_add(in155, t206); // Eval sumdlogdiv_b_num Horner step: add coefficient_49
    let t208 = circuit_mul(t207, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
    let t209 = circuit_add(in154, t208); // Eval sumdlogdiv_b_num Horner step: add coefficient_48
    let t210 = circuit_mul(t209, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
    let t211 = circuit_add(in153, t210); // Eval sumdlogdiv_b_num Horner step: add coefficient_47
    let t212 = circuit_mul(t211, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
    let t213 = circuit_add(in152, t212); // Eval sumdlogdiv_b_num Horner step: add coefficient_46
    let t214 = circuit_mul(t213, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
    let t215 = circuit_add(in151, t214); // Eval sumdlogdiv_b_num Horner step: add coefficient_45
    let t216 = circuit_mul(t215, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
    let t217 = circuit_add(in150, t216); // Eval sumdlogdiv_b_num Horner step: add coefficient_44
    let t218 = circuit_mul(t217, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
    let t219 = circuit_add(in149, t218); // Eval sumdlogdiv_b_num Horner step: add coefficient_43
    let t220 = circuit_mul(t219, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
    let t221 = circuit_add(in148, t220); // Eval sumdlogdiv_b_num Horner step: add coefficient_42
    let t222 = circuit_mul(t221, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
    let t223 = circuit_add(in147, t222); // Eval sumdlogdiv_b_num Horner step: add coefficient_41
    let t224 = circuit_mul(t223, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
    let t225 = circuit_add(in146, t224); // Eval sumdlogdiv_b_num Horner step: add coefficient_40
    let t226 = circuit_mul(t225, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
    let t227 = circuit_add(in145, t226); // Eval sumdlogdiv_b_num Horner step: add coefficient_39
    let t228 = circuit_mul(t227, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
    let t229 = circuit_add(in144, t228); // Eval sumdlogdiv_b_num Horner step: add coefficient_38
    let t230 = circuit_mul(t229, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
    let t231 = circuit_add(in143, t230); // Eval sumdlogdiv_b_num Horner step: add coefficient_37
    let t232 = circuit_mul(t231, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
    let t233 = circuit_add(in142, t232); // Eval sumdlogdiv_b_num Horner step: add coefficient_36
    let t234 = circuit_mul(t233, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
    let t235 = circuit_add(in141, t234); // Eval sumdlogdiv_b_num Horner step: add coefficient_35
    let t236 = circuit_mul(t235, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
    let t237 = circuit_add(in140, t236); // Eval sumdlogdiv_b_num Horner step: add coefficient_34
    let t238 = circuit_mul(t237, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
    let t239 = circuit_add(in139, t238); // Eval sumdlogdiv_b_num Horner step: add coefficient_33
    let t240 = circuit_mul(t239, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
    let t241 = circuit_add(in138, t240); // Eval sumdlogdiv_b_num Horner step: add coefficient_32
    let t242 = circuit_mul(t241, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
    let t243 = circuit_add(in137, t242); // Eval sumdlogdiv_b_num Horner step: add coefficient_31
    let t244 = circuit_mul(t243, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
    let t245 = circuit_add(in136, t244); // Eval sumdlogdiv_b_num Horner step: add coefficient_30
    let t246 = circuit_mul(t245, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
    let t247 = circuit_add(in135, t246); // Eval sumdlogdiv_b_num Horner step: add coefficient_29
    let t248 = circuit_mul(t247, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
    let t249 = circuit_add(in134, t248); // Eval sumdlogdiv_b_num Horner step: add coefficient_28
    let t250 = circuit_mul(t249, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
    let t251 = circuit_add(in133, t250); // Eval sumdlogdiv_b_num Horner step: add coefficient_27
    let t252 = circuit_mul(t251, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
    let t253 = circuit_add(in132, t252); // Eval sumdlogdiv_b_num Horner step: add coefficient_26
    let t254 = circuit_mul(t253, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
    let t255 = circuit_add(in131, t254); // Eval sumdlogdiv_b_num Horner step: add coefficient_25
    let t256 = circuit_mul(t255, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
    let t257 = circuit_add(in130, t256); // Eval sumdlogdiv_b_num Horner step: add coefficient_24
    let t258 = circuit_mul(t257, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
    let t259 = circuit_add(in129, t258); // Eval sumdlogdiv_b_num Horner step: add coefficient_23
    let t260 = circuit_mul(t259, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
    let t261 = circuit_add(in128, t260); // Eval sumdlogdiv_b_num Horner step: add coefficient_22
    let t262 = circuit_mul(t261, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
    let t263 = circuit_add(in127, t262); // Eval sumdlogdiv_b_num Horner step: add coefficient_21
    let t264 = circuit_mul(t263, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
    let t265 = circuit_add(in126, t264); // Eval sumdlogdiv_b_num Horner step: add coefficient_20
    let t266 = circuit_mul(t265, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
    let t267 = circuit_add(in125, t266); // Eval sumdlogdiv_b_num Horner step: add coefficient_19
    let t268 = circuit_mul(t267, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
    let t269 = circuit_add(in124, t268); // Eval sumdlogdiv_b_num Horner step: add coefficient_18
    let t270 = circuit_mul(t269, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
    let t271 = circuit_add(in123, t270); // Eval sumdlogdiv_b_num Horner step: add coefficient_17
    let t272 = circuit_mul(t271, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
    let t273 = circuit_add(in122, t272); // Eval sumdlogdiv_b_num Horner step: add coefficient_16
    let t274 = circuit_mul(t273, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
    let t275 = circuit_add(in121, t274); // Eval sumdlogdiv_b_num Horner step: add coefficient_15
    let t276 = circuit_mul(t275, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
    let t277 = circuit_add(in120, t276); // Eval sumdlogdiv_b_num Horner step: add coefficient_14
    let t278 = circuit_mul(t277, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
    let t279 = circuit_add(in119, t278); // Eval sumdlogdiv_b_num Horner step: add coefficient_13
    let t280 = circuit_mul(t279, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
    let t281 = circuit_add(in118, t280); // Eval sumdlogdiv_b_num Horner step: add coefficient_12
    let t282 = circuit_mul(t281, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
    let t283 = circuit_add(in117, t282); // Eval sumdlogdiv_b_num Horner step: add coefficient_11
    let t284 = circuit_mul(t283, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
    let t285 = circuit_add(in116, t284); // Eval sumdlogdiv_b_num Horner step: add coefficient_10
    let t286 = circuit_mul(t285, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
    let t287 = circuit_add(in115, t286); // Eval sumdlogdiv_b_num Horner step: add coefficient_9
    let t288 = circuit_mul(t287, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
    let t289 = circuit_add(in114, t288); // Eval sumdlogdiv_b_num Horner step: add coefficient_8
    let t290 = circuit_mul(t289, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
    let t291 = circuit_add(in113, t290); // Eval sumdlogdiv_b_num Horner step: add coefficient_7
    let t292 = circuit_mul(t291, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
    let t293 = circuit_add(in112, t292); // Eval sumdlogdiv_b_num Horner step: add coefficient_6
    let t294 = circuit_mul(t293, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
    let t295 = circuit_add(in111, t294); // Eval sumdlogdiv_b_num Horner step: add coefficient_5
    let t296 = circuit_mul(t295, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
    let t297 = circuit_add(in110, t296); // Eval sumdlogdiv_b_num Horner step: add coefficient_4
    let t298 = circuit_mul(t297, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
    let t299 = circuit_add(in109, t298); // Eval sumdlogdiv_b_num Horner step: add coefficient_3
    let t300 = circuit_mul(t299, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
    let t301 = circuit_add(in108, t300); // Eval sumdlogdiv_b_num Horner step: add coefficient_2
    let t302 = circuit_mul(t301, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
    let t303 = circuit_add(in107, t302); // Eval sumdlogdiv_b_num Horner step: add coefficient_1
    let t304 = circuit_mul(t303, in0); // Eval sumdlogdiv_b_num Horner step: multiply by xA
    let t305 = circuit_add(in106, t304); // Eval sumdlogdiv_b_num Horner step: add coefficient_0
    let t306 = circuit_mul(in212, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
    let t307 = circuit_add(in211, t306); // Eval sumdlogdiv_b_den Horner step: add coefficient_53
    let t308 = circuit_mul(t307, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
    let t309 = circuit_add(in210, t308); // Eval sumdlogdiv_b_den Horner step: add coefficient_52
    let t310 = circuit_mul(t309, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
    let t311 = circuit_add(in209, t310); // Eval sumdlogdiv_b_den Horner step: add coefficient_51
    let t312 = circuit_mul(t311, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
    let t313 = circuit_add(in208, t312); // Eval sumdlogdiv_b_den Horner step: add coefficient_50
    let t314 = circuit_mul(t313, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
    let t315 = circuit_add(in207, t314); // Eval sumdlogdiv_b_den Horner step: add coefficient_49
    let t316 = circuit_mul(t315, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
    let t317 = circuit_add(in206, t316); // Eval sumdlogdiv_b_den Horner step: add coefficient_48
    let t318 = circuit_mul(t317, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
    let t319 = circuit_add(in205, t318); // Eval sumdlogdiv_b_den Horner step: add coefficient_47
    let t320 = circuit_mul(t319, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
    let t321 = circuit_add(in204, t320); // Eval sumdlogdiv_b_den Horner step: add coefficient_46
    let t322 = circuit_mul(t321, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
    let t323 = circuit_add(in203, t322); // Eval sumdlogdiv_b_den Horner step: add coefficient_45
    let t324 = circuit_mul(t323, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
    let t325 = circuit_add(in202, t324); // Eval sumdlogdiv_b_den Horner step: add coefficient_44
    let t326 = circuit_mul(t325, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
    let t327 = circuit_add(in201, t326); // Eval sumdlogdiv_b_den Horner step: add coefficient_43
    let t328 = circuit_mul(t327, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
    let t329 = circuit_add(in200, t328); // Eval sumdlogdiv_b_den Horner step: add coefficient_42
    let t330 = circuit_mul(t329, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
    let t331 = circuit_add(in199, t330); // Eval sumdlogdiv_b_den Horner step: add coefficient_41
    let t332 = circuit_mul(t331, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
    let t333 = circuit_add(in198, t332); // Eval sumdlogdiv_b_den Horner step: add coefficient_40
    let t334 = circuit_mul(t333, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
    let t335 = circuit_add(in197, t334); // Eval sumdlogdiv_b_den Horner step: add coefficient_39
    let t336 = circuit_mul(t335, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
    let t337 = circuit_add(in196, t336); // Eval sumdlogdiv_b_den Horner step: add coefficient_38
    let t338 = circuit_mul(t337, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
    let t339 = circuit_add(in195, t338); // Eval sumdlogdiv_b_den Horner step: add coefficient_37
    let t340 = circuit_mul(t339, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
    let t341 = circuit_add(in194, t340); // Eval sumdlogdiv_b_den Horner step: add coefficient_36
    let t342 = circuit_mul(t341, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
    let t343 = circuit_add(in193, t342); // Eval sumdlogdiv_b_den Horner step: add coefficient_35
    let t344 = circuit_mul(t343, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
    let t345 = circuit_add(in192, t344); // Eval sumdlogdiv_b_den Horner step: add coefficient_34
    let t346 = circuit_mul(t345, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
    let t347 = circuit_add(in191, t346); // Eval sumdlogdiv_b_den Horner step: add coefficient_33
    let t348 = circuit_mul(t347, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
    let t349 = circuit_add(in190, t348); // Eval sumdlogdiv_b_den Horner step: add coefficient_32
    let t350 = circuit_mul(t349, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
    let t351 = circuit_add(in189, t350); // Eval sumdlogdiv_b_den Horner step: add coefficient_31
    let t352 = circuit_mul(t351, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
    let t353 = circuit_add(in188, t352); // Eval sumdlogdiv_b_den Horner step: add coefficient_30
    let t354 = circuit_mul(t353, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
    let t355 = circuit_add(in187, t354); // Eval sumdlogdiv_b_den Horner step: add coefficient_29
    let t356 = circuit_mul(t355, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
    let t357 = circuit_add(in186, t356); // Eval sumdlogdiv_b_den Horner step: add coefficient_28
    let t358 = circuit_mul(t357, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
    let t359 = circuit_add(in185, t358); // Eval sumdlogdiv_b_den Horner step: add coefficient_27
    let t360 = circuit_mul(t359, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
    let t361 = circuit_add(in184, t360); // Eval sumdlogdiv_b_den Horner step: add coefficient_26
    let t362 = circuit_mul(t361, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
    let t363 = circuit_add(in183, t362); // Eval sumdlogdiv_b_den Horner step: add coefficient_25
    let t364 = circuit_mul(t363, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
    let t365 = circuit_add(in182, t364); // Eval sumdlogdiv_b_den Horner step: add coefficient_24
    let t366 = circuit_mul(t365, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
    let t367 = circuit_add(in181, t366); // Eval sumdlogdiv_b_den Horner step: add coefficient_23
    let t368 = circuit_mul(t367, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
    let t369 = circuit_add(in180, t368); // Eval sumdlogdiv_b_den Horner step: add coefficient_22
    let t370 = circuit_mul(t369, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
    let t371 = circuit_add(in179, t370); // Eval sumdlogdiv_b_den Horner step: add coefficient_21
    let t372 = circuit_mul(t371, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
    let t373 = circuit_add(in178, t372); // Eval sumdlogdiv_b_den Horner step: add coefficient_20
    let t374 = circuit_mul(t373, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
    let t375 = circuit_add(in177, t374); // Eval sumdlogdiv_b_den Horner step: add coefficient_19
    let t376 = circuit_mul(t375, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
    let t377 = circuit_add(in176, t376); // Eval sumdlogdiv_b_den Horner step: add coefficient_18
    let t378 = circuit_mul(t377, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
    let t379 = circuit_add(in175, t378); // Eval sumdlogdiv_b_den Horner step: add coefficient_17
    let t380 = circuit_mul(t379, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
    let t381 = circuit_add(in174, t380); // Eval sumdlogdiv_b_den Horner step: add coefficient_16
    let t382 = circuit_mul(t381, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
    let t383 = circuit_add(in173, t382); // Eval sumdlogdiv_b_den Horner step: add coefficient_15
    let t384 = circuit_mul(t383, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
    let t385 = circuit_add(in172, t384); // Eval sumdlogdiv_b_den Horner step: add coefficient_14
    let t386 = circuit_mul(t385, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
    let t387 = circuit_add(in171, t386); // Eval sumdlogdiv_b_den Horner step: add coefficient_13
    let t388 = circuit_mul(t387, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
    let t389 = circuit_add(in170, t388); // Eval sumdlogdiv_b_den Horner step: add coefficient_12
    let t390 = circuit_mul(t389, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
    let t391 = circuit_add(in169, t390); // Eval sumdlogdiv_b_den Horner step: add coefficient_11
    let t392 = circuit_mul(t391, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
    let t393 = circuit_add(in168, t392); // Eval sumdlogdiv_b_den Horner step: add coefficient_10
    let t394 = circuit_mul(t393, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
    let t395 = circuit_add(in167, t394); // Eval sumdlogdiv_b_den Horner step: add coefficient_9
    let t396 = circuit_mul(t395, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
    let t397 = circuit_add(in166, t396); // Eval sumdlogdiv_b_den Horner step: add coefficient_8
    let t398 = circuit_mul(t397, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
    let t399 = circuit_add(in165, t398); // Eval sumdlogdiv_b_den Horner step: add coefficient_7
    let t400 = circuit_mul(t399, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
    let t401 = circuit_add(in164, t400); // Eval sumdlogdiv_b_den Horner step: add coefficient_6
    let t402 = circuit_mul(t401, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
    let t403 = circuit_add(in163, t402); // Eval sumdlogdiv_b_den Horner step: add coefficient_5
    let t404 = circuit_mul(t403, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
    let t405 = circuit_add(in162, t404); // Eval sumdlogdiv_b_den Horner step: add coefficient_4
    let t406 = circuit_mul(t405, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
    let t407 = circuit_add(in161, t406); // Eval sumdlogdiv_b_den Horner step: add coefficient_3
    let t408 = circuit_mul(t407, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
    let t409 = circuit_add(in160, t408); // Eval sumdlogdiv_b_den Horner step: add coefficient_2
    let t410 = circuit_mul(t409, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
    let t411 = circuit_add(in159, t410); // Eval sumdlogdiv_b_den Horner step: add coefficient_1
    let t412 = circuit_mul(t411, in0); // Eval sumdlogdiv_b_den Horner step: multiply by xA
    let t413 = circuit_add(in158, t412); // Eval sumdlogdiv_b_den Horner step: add coefficient_0
    let t414 = circuit_inverse(t413);
    let t415 = circuit_mul(t305, t414);
    let t416 = circuit_mul(in1, t415);
    let t417 = circuit_add(t203, t416);
    let t418 = circuit_mul(in2, t417);

    let modulus = modulus;

    let mut circuit_inputs = (t418,).new_inputs();
    // Prefill constants:
    ...
    let outputs = circuit_inputs.done_2().eval(modulus).unwrap();
    let res: u384 = outputs.get_output(t418);
    return (res,);
}
