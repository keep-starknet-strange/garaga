...
use noir_ultra_keccak_honk_example::honk_verifier::{
    IUltraKeccakHonkVerifierDispatcherTrait, IUltraKeccakHonkVerifierLibraryDispatcher,
};
use snforge_std::fs::{FileTrait, read_txt};
use snforge_std::{DeclareResultTrait, declare};
use starknet::ClassHash;

/// Declare the UltraKeccakHonkVerifier contract for testing.
///
/// This function declares a new instance of the UltraKeccakHonkVerifier contract
///
/// # Arguments
...
/// # Example
/// ```cairo
/// let class_hash = declare_contract("UltraKeccakHonkVerifier");
/// let dispatcher = IUltraKeccakHonkVerifierLibraryDispatcher { class_hash };
/// ```
