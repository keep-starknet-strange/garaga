...
use noir_ultra_keccak_honk_example::honk_verifier::{
    IUltraKeccakHonkVerifierDispatcher, IUltraKeccakHonkVerifierDispatcherTrait,
};
use snforge_std::fs::{FileTrait, read_txt};
use snforge_std::{ContractClassTrait, DeclareResultTrait, declare};
use starknet::ContractAddress;

/// Deploy the UltraKeccakHonkVerifier contract for testing.
///
/// This function declares and deploys a new instance of the UltraKeccakHonkVerifier contract
...
/// # Example
/// ```cairo
/// let contract_address = deploy_contract("UltraKeccakHonkVerifier");
/// let dispatcher = IUltraKeccakHonkVerifierDispatcher { contract_address };
/// ```
...
/// Test the verification function verify_ultra_keccak_honk_proof with a valid proof.
///
...
/// ```bash
/// garaga calldata ///     --system ultra_keccak_honk ///     --vk path/to/vk ///     --proof
...
fn test_verify_ultra_keccak_honk_proof() {
    ...
    // This calls the contract's verify_ultra_keccak_honk_proof function with the loaded proof data
    let result = dispatcher.verify_ultra_keccak_honk_proof(calldata);
