...
/// Deploy the UltraStarknetZKHonkVerifier contract for testing.
///
/// This function declares and deploys a new instance of the UltraStarknetZKHonkVerifier contract
...
/// # Example
/// ```cairo
/// let contract_address = deploy_contract("UltraStarknetZKHonkVerifier");
/// let dispatcher = IUltraStarknetZKHonkVerifierDispatcher { contract_address };
/// ```
...
/// ```bash
/// garaga calldata ///     --system ultra_starknet_zk_honk ///     --vk path/to/vk ///     --proof
