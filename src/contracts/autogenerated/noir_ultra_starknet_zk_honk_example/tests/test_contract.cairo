...
use noir_ultra_starknet_zk_honk_example::honk_verifier::{
    IUltraStarknetZKHonkVerifierDispatcherTrait, IUltraStarknetZKHonkVerifierLibraryDispatcher,
};
use snforge_std::fs::{FileTrait, read_txt};
use snforge_std::{DeclareResultTrait, declare};
use starknet::ClassHash;

/// Declare the UltraStarknetZKHonkVerifier contract for testing.
///
/// This function declares a new instance of the UltraStarknetZKHonkVerifier contract
///
/// # Arguments
...
/// # Example
/// ```cairo
/// let class_hash = declare_contract("UltraStarknetZKHonkVerifier");
/// let dispatcher = IUltraStarknetZKHonkVerifierLibraryDispatcher { class_hash };
/// ```
...
/// Test the verification function verify_ultra_starknet_zk_honk_proof with a valid proof.
///
...
fn test_verify_ultra_starknet_zk_honk_proof() {
    ...
    // This calls the contract's verify_ultra_starknet_zk_honk_proof function with the loaded proof
    // data
    let result = dispatcher.verify_ultra_starknet_zk_honk_proof(calldata);
