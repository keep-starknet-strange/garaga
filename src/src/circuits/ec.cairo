...
fn run_INIT_FN_CHALLENGE_DUPL_11P_circuit(
    ...
    let t28 = circuit_mul(in3, in0); // Eval sumdlogdiv_a_num step coeff_1 * xA0^1
    let t29 = circuit_add(in2, t28); // Eval sumdlogdiv_a_num step + (coeff_1 * xA0^1)
    let t30 = circuit_mul(in4, t0); // Eval sumdlogdiv_a_num step coeff_2 * xA0^2
    let t31 = circuit_add(t29, t30); // Eval sumdlogdiv_a_num step + (coeff_2 * xA0^2)
    let t32 = circuit_mul(in5, t2); // Eval sumdlogdiv_a_num step coeff_3 * xA0^3
    let t33 = circuit_add(t31, t32); // Eval sumdlogdiv_a_num step + (coeff_3 * xA0^3)
    let t34 = circuit_mul(in6, t4); // Eval sumdlogdiv_a_num step coeff_4 * xA0^4
    let t35 = circuit_add(t33, t34); // Eval sumdlogdiv_a_num step + (coeff_4 * xA0^4)
    let t36 = circuit_mul(in7, t6); // Eval sumdlogdiv_a_num step coeff_5 * xA0^5
    let t37 = circuit_add(t35, t36); // Eval sumdlogdiv_a_num step + (coeff_5 * xA0^5)
    let t38 = circuit_mul(in8, t8); // Eval sumdlogdiv_a_num step coeff_6 * xA0^6
    let t39 = circuit_add(t37, t38); // Eval sumdlogdiv_a_num step + (coeff_6 * xA0^6)
    let t40 = circuit_mul(in9, t10); // Eval sumdlogdiv_a_num step coeff_7 * xA0^7
    let t41 = circuit_add(t39, t40); // Eval sumdlogdiv_a_num step + (coeff_7 * xA0^7)
    let t42 = circuit_mul(in10, t12); // Eval sumdlogdiv_a_num step coeff_8 * xA0^8
    let t43 = circuit_add(t41, t42); // Eval sumdlogdiv_a_num step + (coeff_8 * xA0^8)
    let t44 = circuit_mul(in11, t14); // Eval sumdlogdiv_a_num step coeff_9 * xA0^9
    let t45 = circuit_add(t43, t44); // Eval sumdlogdiv_a_num step + (coeff_9 * xA0^9)
    let t46 = circuit_mul(in12, t16); // Eval sumdlogdiv_a_num step coeff_10 * xA0^10
    let t47 = circuit_add(t45, t46); // Eval sumdlogdiv_a_num step + (coeff_10 * xA0^10)
    let t48 = circuit_mul(in13, t18); // Eval sumdlogdiv_a_num step coeff_11 * xA0^11
    let t49 = circuit_add(t47, t48); // Eval sumdlogdiv_a_num step + (coeff_11 * xA0^11)
    let t50 = circuit_mul(in15, in0); // Eval sumdlogdiv_a_den step coeff_1 * xA0^1
    let t51 = circuit_add(in14, t50); // Eval sumdlogdiv_a_den step + (coeff_1 * xA0^1)
    let t52 = circuit_mul(in16, t0); // Eval sumdlogdiv_a_den step coeff_2 * xA0^2
    let t53 = circuit_add(t51, t52); // Eval sumdlogdiv_a_den step + (coeff_2 * xA0^2)
    let t54 = circuit_mul(in17, t2); // Eval sumdlogdiv_a_den step coeff_3 * xA0^3
    let t55 = circuit_add(t53, t54); // Eval sumdlogdiv_a_den step + (coeff_3 * xA0^3)
    let t56 = circuit_mul(in18, t4); // Eval sumdlogdiv_a_den step coeff_4 * xA0^4
    let t57 = circuit_add(t55, t56); // Eval sumdlogdiv_a_den step + (coeff_4 * xA0^4)
    let t58 = circuit_mul(in19, t6); // Eval sumdlogdiv_a_den step coeff_5 * xA0^5
    let t59 = circuit_add(t57, t58); // Eval sumdlogdiv_a_den step + (coeff_5 * xA0^5)
    let t60 = circuit_mul(in20, t8); // Eval sumdlogdiv_a_den step coeff_6 * xA0^6
    let t61 = circuit_add(t59, t60); // Eval sumdlogdiv_a_den step + (coeff_6 * xA0^6)
    let t62 = circuit_mul(in21, t10); // Eval sumdlogdiv_a_den step coeff_7 * xA0^7
    let t63 = circuit_add(t61, t62); // Eval sumdlogdiv_a_den step + (coeff_7 * xA0^7)
    let t64 = circuit_mul(in22, t12); // Eval sumdlogdiv_a_den step coeff_8 * xA0^8
    let t65 = circuit_add(t63, t64); // Eval sumdlogdiv_a_den step + (coeff_8 * xA0^8)
    let t66 = circuit_mul(in23, t14); // Eval sumdlogdiv_a_den step coeff_9 * xA0^9
    let t67 = circuit_add(t65, t66); // Eval sumdlogdiv_a_den step + (coeff_9 * xA0^9)
    let t68 = circuit_mul(in24, t16); // Eval sumdlogdiv_a_den step coeff_10 * xA0^10
    let t69 = circuit_add(t67, t68); // Eval sumdlogdiv_a_den step + (coeff_10 * xA0^10)
    let t70 = circuit_mul(in25, t18); // Eval sumdlogdiv_a_den step coeff_11 * xA0^11
    let t71 = circuit_add(t69, t70); // Eval sumdlogdiv_a_den step + (coeff_11 * xA0^11)
    let t72 = circuit_mul(in26, t20); // Eval sumdlogdiv_a_den step coeff_12 * xA0^12
    let t73 = circuit_add(t71, t72); // Eval sumdlogdiv_a_den step + (coeff_12 * xA0^12)
    let t74 = circuit_mul(in28, in0); // Eval sumdlogdiv_b_num step coeff_1 * xA0^1
    let t75 = circuit_add(in27, t74); // Eval sumdlogdiv_b_num step + (coeff_1 * xA0^1)
    let t76 = circuit_mul(in29, t0); // Eval sumdlogdiv_b_num step coeff_2 * xA0^2
    let t77 = circuit_add(t75, t76); // Eval sumdlogdiv_b_num step + (coeff_2 * xA0^2)
    let t78 = circuit_mul(in30, t2); // Eval sumdlogdiv_b_num step coeff_3 * xA0^3
    let t79 = circuit_add(t77, t78); // Eval sumdlogdiv_b_num step + (coeff_3 * xA0^3)
    let t80 = circuit_mul(in31, t4); // Eval sumdlogdiv_b_num step coeff_4 * xA0^4
    let t81 = circuit_add(t79, t80); // Eval sumdlogdiv_b_num step + (coeff_4 * xA0^4)
    let t82 = circuit_mul(in32, t6); // Eval sumdlogdiv_b_num step coeff_5 * xA0^5
    let t83 = circuit_add(t81, t82); // Eval sumdlogdiv_b_num step + (coeff_5 * xA0^5)
    let t84 = circuit_mul(in33, t8); // Eval sumdlogdiv_b_num step coeff_6 * xA0^6
    let t85 = circuit_add(t83, t84); // Eval sumdlogdiv_b_num step + (coeff_6 * xA0^6)
    let t86 = circuit_mul(in34, t10); // Eval sumdlogdiv_b_num step coeff_7 * xA0^7
    let t87 = circuit_add(t85, t86); // Eval sumdlogdiv_b_num step + (coeff_7 * xA0^7)
    let t88 = circuit_mul(in35, t12); // Eval sumdlogdiv_b_num step coeff_8 * xA0^8
    let t89 = circuit_add(t87, t88); // Eval sumdlogdiv_b_num step + (coeff_8 * xA0^8)
    let t90 = circuit_mul(in36, t14); // Eval sumdlogdiv_b_num step coeff_9 * xA0^9
    let t91 = circuit_add(t89, t90); // Eval sumdlogdiv_b_num step + (coeff_9 * xA0^9)
    let t92 = circuit_mul(in37, t16); // Eval sumdlogdiv_b_num step coeff_10 * xA0^10
    let t93 = circuit_add(t91, t92); // Eval sumdlogdiv_b_num step + (coeff_10 * xA0^10)
    let t94 = circuit_mul(in38, t18); // Eval sumdlogdiv_b_num step coeff_11 * xA0^11
    let t95 = circuit_add(t93, t94); // Eval sumdlogdiv_b_num step + (coeff_11 * xA0^11)
    let t96 = circuit_mul(in39, t20); // Eval sumdlogdiv_b_num step coeff_12 * xA0^12
    let t97 = circuit_add(t95, t96); // Eval sumdlogdiv_b_num step + (coeff_12 * xA0^12)
    let t98 = circuit_mul(in41, in0); // Eval sumdlogdiv_b_den step coeff_1 * xA0^1
    let t99 = circuit_add(in40, t98); // Eval sumdlogdiv_b_den step + (coeff_1 * xA0^1)
    let t100 = circuit_mul(in42, t0); // Eval sumdlogdiv_b_den step coeff_2 * xA0^2
    let t101 = circuit_add(t99, t100); // Eval sumdlogdiv_b_den step + (coeff_2 * xA0^2)
    let t102 = circuit_mul(in43, t2); // Eval sumdlogdiv_b_den step coeff_3 * xA0^3
    let t103 = circuit_add(t101, t102); // Eval sumdlogdiv_b_den step + (coeff_3 * xA0^3)
    let t104 = circuit_mul(in44, t4); // Eval sumdlogdiv_b_den step coeff_4 * xA0^4
    let t105 = circuit_add(t103, t104); // Eval sumdlogdiv_b_den step + (coeff_4 * xA0^4)
    let t106 = circuit_mul(in45, t6); // Eval sumdlogdiv_b_den step coeff_5 * xA0^5
    let t107 = circuit_add(t105, t106); // Eval sumdlogdiv_b_den step + (coeff_5 * xA0^5)
    let t108 = circuit_mul(in46, t8); // Eval sumdlogdiv_b_den step coeff_6 * xA0^6
    let t109 = circuit_add(t107, t108); // Eval sumdlogdiv_b_den step + (coeff_6 * xA0^6)
    let t110 = circuit_mul(in47, t10); // Eval sumdlogdiv_b_den step coeff_7 * xA0^7
    let t111 = circuit_add(t109, t110); // Eval sumdlogdiv_b_den step + (coeff_7 * xA0^7)
    let t112 = circuit_mul(in48, t12); // Eval sumdlogdiv_b_den step coeff_8 * xA0^8
    let t113 = circuit_add(t111, t112); // Eval sumdlogdiv_b_den step + (coeff_8 * xA0^8)
    let t114 = circuit_mul(in49, t14); // Eval sumdlogdiv_b_den step coeff_9 * xA0^9
    let t115 = circuit_add(t113, t114); // Eval sumdlogdiv_b_den step + (coeff_9 * xA0^9)
    let t116 = circuit_mul(in50, t16); // Eval sumdlogdiv_b_den step coeff_10 * xA0^10
    let t117 = circuit_add(t115, t116); // Eval sumdlogdiv_b_den step + (coeff_10 * xA0^10)
    let t118 = circuit_mul(in51, t18); // Eval sumdlogdiv_b_den step coeff_11 * xA0^11
    let t119 = circuit_add(t117, t118); // Eval sumdlogdiv_b_den step + (coeff_11 * xA0^11)
    let t120 = circuit_mul(in52, t20); // Eval sumdlogdiv_b_den step coeff_12 * xA0^12
    let t121 = circuit_add(t119, t120); // Eval sumdlogdiv_b_den step + (coeff_12 * xA0^12)
    let t122 = circuit_mul(in53, t22); // Eval sumdlogdiv_b_den step coeff_13 * xA0^13
    let t123 = circuit_add(t121, t122); // Eval sumdlogdiv_b_den step + (coeff_13 * xA0^13)
    let t124 = circuit_mul(in54, t24); // Eval sumdlogdiv_b_den step coeff_14 * xA0^14
    let t125 = circuit_add(t123, t124); // Eval sumdlogdiv_b_den step + (coeff_14 * xA0^14)
    let t126 = circuit_mul(in55, t26); // Eval sumdlogdiv_b_den step coeff_15 * xA0^15
    let t127 = circuit_add(t125, t126); // Eval sumdlogdiv_b_den step + (coeff_15 * xA0^15)
    let t128 = circuit_mul(in3, in1); // Eval sumdlogdiv_a_num step coeff_1 * xA2^1
    let t129 = circuit_add(in2, t128); // Eval sumdlogdiv_a_num step + (coeff_1 * xA2^1)
    let t130 = circuit_mul(in4, t1); // Eval sumdlogdiv_a_num step coeff_2 * xA2^2
    let t131 = circuit_add(t129, t130); // Eval sumdlogdiv_a_num step + (coeff_2 * xA2^2)
    let t132 = circuit_mul(in5, t3); // Eval sumdlogdiv_a_num step coeff_3 * xA2^3
    let t133 = circuit_add(t131, t132); // Eval sumdlogdiv_a_num step + (coeff_3 * xA2^3)
    let t134 = circuit_mul(in6, t5); // Eval sumdlogdiv_a_num step coeff_4 * xA2^4
    let t135 = circuit_add(t133, t134); // Eval sumdlogdiv_a_num step + (coeff_4 * xA2^4)
    let t136 = circuit_mul(in7, t7); // Eval sumdlogdiv_a_num step coeff_5 * xA2^5
    let t137 = circuit_add(t135, t136); // Eval sumdlogdiv_a_num step + (coeff_5 * xA2^5)
    let t138 = circuit_mul(in8, t9); // Eval sumdlogdiv_a_num step coeff_6 * xA2^6
    let t139 = circuit_add(t137, t138); // Eval sumdlogdiv_a_num step + (coeff_6 * xA2^6)
    let t140 = circuit_mul(in9, t11); // Eval sumdlogdiv_a_num step coeff_7 * xA2^7
    let t141 = circuit_add(t139, t140); // Eval sumdlogdiv_a_num step + (coeff_7 * xA2^7)
    let t142 = circuit_mul(in10, t13); // Eval sumdlogdiv_a_num step coeff_8 * xA2^8
    let t143 = circuit_add(t141, t142); // Eval sumdlogdiv_a_num step + (coeff_8 * xA2^8)
    let t144 = circuit_mul(in11, t15); // Eval sumdlogdiv_a_num step coeff_9 * xA2^9
    let t145 = circuit_add(t143, t144); // Eval sumdlogdiv_a_num step + (coeff_9 * xA2^9)
    let t146 = circuit_mul(in12, t17); // Eval sumdlogdiv_a_num step coeff_10 * xA2^10
    let t147 = circuit_add(t145, t146); // Eval sumdlogdiv_a_num step + (coeff_10 * xA2^10)
    let t148 = circuit_mul(in13, t19); // Eval sumdlogdiv_a_num step coeff_11 * xA2^11
    let t149 = circuit_add(t147, t148); // Eval sumdlogdiv_a_num step + (coeff_11 * xA2^11)
    let t150 = circuit_mul(in15, in1); // Eval sumdlogdiv_a_den step coeff_1 * xA2^1
    let t151 = circuit_add(in14, t150); // Eval sumdlogdiv_a_den step + (coeff_1 * xA2^1)
    let t152 = circuit_mul(in16, t1); // Eval sumdlogdiv_a_den step coeff_2 * xA2^2
    let t153 = circuit_add(t151, t152); // Eval sumdlogdiv_a_den step + (coeff_2 * xA2^2)
    let t154 = circuit_mul(in17, t3); // Eval sumdlogdiv_a_den step coeff_3 * xA2^3
    let t155 = circuit_add(t153, t154); // Eval sumdlogdiv_a_den step + (coeff_3 * xA2^3)
    let t156 = circuit_mul(in18, t5); // Eval sumdlogdiv_a_den step coeff_4 * xA2^4
    let t157 = circuit_add(t155, t156); // Eval sumdlogdiv_a_den step + (coeff_4 * xA2^4)
    let t158 = circuit_mul(in19, t7); // Eval sumdlogdiv_a_den step coeff_5 * xA2^5
    let t159 = circuit_add(t157, t158); // Eval sumdlogdiv_a_den step + (coeff_5 * xA2^5)
    let t160 = circuit_mul(in20, t9); // Eval sumdlogdiv_a_den step coeff_6 * xA2^6
    let t161 = circuit_add(t159, t160); // Eval sumdlogdiv_a_den step + (coeff_6 * xA2^6)
    let t162 = circuit_mul(in21, t11); // Eval sumdlogdiv_a_den step coeff_7 * xA2^7
    let t163 = circuit_add(t161, t162); // Eval sumdlogdiv_a_den step + (coeff_7 * xA2^7)
    let t164 = circuit_mul(in22, t13); // Eval sumdlogdiv_a_den step coeff_8 * xA2^8
    let t165 = circuit_add(t163, t164); // Eval sumdlogdiv_a_den step + (coeff_8 * xA2^8)
    let t166 = circuit_mul(in23, t15); // Eval sumdlogdiv_a_den step coeff_9 * xA2^9
    let t167 = circuit_add(t165, t166); // Eval sumdlogdiv_a_den step + (coeff_9 * xA2^9)
    let t168 = circuit_mul(in24, t17); // Eval sumdlogdiv_a_den step coeff_10 * xA2^10
    let t169 = circuit_add(t167, t168); // Eval sumdlogdiv_a_den step + (coeff_10 * xA2^10)
    let t170 = circuit_mul(in25, t19); // Eval sumdlogdiv_a_den step coeff_11 * xA2^11
    let t171 = circuit_add(t169, t170); // Eval sumdlogdiv_a_den step + (coeff_11 * xA2^11)
    let t172 = circuit_mul(in26, t21); // Eval sumdlogdiv_a_den step coeff_12 * xA2^12
    let t173 = circuit_add(t171, t172); // Eval sumdlogdiv_a_den step + (coeff_12 * xA2^12)
    let t174 = circuit_mul(in28, in1); // Eval sumdlogdiv_b_num step coeff_1 * xA2^1
    let t175 = circuit_add(in27, t174); // Eval sumdlogdiv_b_num step + (coeff_1 * xA2^1)
    let t176 = circuit_mul(in29, t1); // Eval sumdlogdiv_b_num step coeff_2 * xA2^2
    let t177 = circuit_add(t175, t176); // Eval sumdlogdiv_b_num step + (coeff_2 * xA2^2)
    let t178 = circuit_mul(in30, t3); // Eval sumdlogdiv_b_num step coeff_3 * xA2^3
    let t179 = circuit_add(t177, t178); // Eval sumdlogdiv_b_num step + (coeff_3 * xA2^3)
    let t180 = circuit_mul(in31, t5); // Eval sumdlogdiv_b_num step coeff_4 * xA2^4
    let t181 = circuit_add(t179, t180); // Eval sumdlogdiv_b_num step + (coeff_4 * xA2^4)
    let t182 = circuit_mul(in32, t7); // Eval sumdlogdiv_b_num step coeff_5 * xA2^5
    let t183 = circuit_add(t181, t182); // Eval sumdlogdiv_b_num step + (coeff_5 * xA2^5)
    let t184 = circuit_mul(in33, t9); // Eval sumdlogdiv_b_num step coeff_6 * xA2^6
    let t185 = circuit_add(t183, t184); // Eval sumdlogdiv_b_num step + (coeff_6 * xA2^6)
    let t186 = circuit_mul(in34, t11); // Eval sumdlogdiv_b_num step coeff_7 * xA2^7
    let t187 = circuit_add(t185, t186); // Eval sumdlogdiv_b_num step + (coeff_7 * xA2^7)
    let t188 = circuit_mul(in35, t13); // Eval sumdlogdiv_b_num step coeff_8 * xA2^8
    let t189 = circuit_add(t187, t188); // Eval sumdlogdiv_b_num step + (coeff_8 * xA2^8)
    let t190 = circuit_mul(in36, t15); // Eval sumdlogdiv_b_num step coeff_9 * xA2^9
    let t191 = circuit_add(t189, t190); // Eval sumdlogdiv_b_num step + (coeff_9 * xA2^9)
    let t192 = circuit_mul(in37, t17); // Eval sumdlogdiv_b_num step coeff_10 * xA2^10
    let t193 = circuit_add(t191, t192); // Eval sumdlogdiv_b_num step + (coeff_10 * xA2^10)
    let t194 = circuit_mul(in38, t19); // Eval sumdlogdiv_b_num step coeff_11 * xA2^11
    let t195 = circuit_add(t193, t194); // Eval sumdlogdiv_b_num step + (coeff_11 * xA2^11)
    let t196 = circuit_mul(in39, t21); // Eval sumdlogdiv_b_num step coeff_12 * xA2^12
    let t197 = circuit_add(t195, t196); // Eval sumdlogdiv_b_num step + (coeff_12 * xA2^12)
    let t198 = circuit_mul(in41, in1); // Eval sumdlogdiv_b_den step coeff_1 * xA2^1
    let t199 = circuit_add(in40, t198); // Eval sumdlogdiv_b_den step + (coeff_1 * xA2^1)
    let t200 = circuit_mul(in42, t1); // Eval sumdlogdiv_b_den step coeff_2 * xA2^2
    let t201 = circuit_add(t199, t200); // Eval sumdlogdiv_b_den step + (coeff_2 * xA2^2)
    let t202 = circuit_mul(in43, t3); // Eval sumdlogdiv_b_den step coeff_3 * xA2^3
    let t203 = circuit_add(t201, t202); // Eval sumdlogdiv_b_den step + (coeff_3 * xA2^3)
    let t204 = circuit_mul(in44, t5); // Eval sumdlogdiv_b_den step coeff_4 * xA2^4
    let t205 = circuit_add(t203, t204); // Eval sumdlogdiv_b_den step + (coeff_4 * xA2^4)
    let t206 = circuit_mul(in45, t7); // Eval sumdlogdiv_b_den step coeff_5 * xA2^5
    let t207 = circuit_add(t205, t206); // Eval sumdlogdiv_b_den step + (coeff_5 * xA2^5)
    let t208 = circuit_mul(in46, t9); // Eval sumdlogdiv_b_den step coeff_6 * xA2^6
    let t209 = circuit_add(t207, t208); // Eval sumdlogdiv_b_den step + (coeff_6 * xA2^6)
    let t210 = circuit_mul(in47, t11); // Eval sumdlogdiv_b_den step coeff_7 * xA2^7
    let t211 = circuit_add(t209, t210); // Eval sumdlogdiv_b_den step + (coeff_7 * xA2^7)
    let t212 = circuit_mul(in48, t13); // Eval sumdlogdiv_b_den step coeff_8 * xA2^8
    let t213 = circuit_add(t211, t212); // Eval sumdlogdiv_b_den step + (coeff_8 * xA2^8)
    let t214 = circuit_mul(in49, t15); // Eval sumdlogdiv_b_den step coeff_9 * xA2^9
    let t215 = circuit_add(t213, t214); // Eval sumdlogdiv_b_den step + (coeff_9 * xA2^9)
    let t216 = circuit_mul(in50, t17); // Eval sumdlogdiv_b_den step coeff_10 * xA2^10
    let t217 = circuit_add(t215, t216); // Eval sumdlogdiv_b_den step + (coeff_10 * xA2^10)
    let t218 = circuit_mul(in51, t19); // Eval sumdlogdiv_b_den step coeff_11 * xA2^11
    let t219 = circuit_add(t217, t218); // Eval sumdlogdiv_b_den step + (coeff_11 * xA2^11)
    let t220 = circuit_mul(in52, t21); // Eval sumdlogdiv_b_den step coeff_12 * xA2^12
    let t221 = circuit_add(t219, t220); // Eval sumdlogdiv_b_den step + (coeff_12 * xA2^12)
    let t222 = circuit_mul(in53, t23); // Eval sumdlogdiv_b_den step coeff_13 * xA2^13
    let t223 = circuit_add(t221, t222); // Eval sumdlogdiv_b_den step + (coeff_13 * xA2^13)
    let t224 = circuit_mul(in54, t25); // Eval sumdlogdiv_b_den step coeff_14 * xA2^14
    let t225 = circuit_add(t223, t224); // Eval sumdlogdiv_b_den step + (coeff_14 * xA2^14)
    let t226 = circuit_mul(in55, t27); // Eval sumdlogdiv_b_den step coeff_15 * xA2^15
    let t227 = circuit_add(t225, t226); // Eval sumdlogdiv_b_den step + (coeff_15 * xA2^15)
