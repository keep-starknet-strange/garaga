...
pub fn run_BLS12_381_MP_CHECK_FINALIZE_BLS_2P_circuit(
    ...
    let t11 = circuit_mul(in8, in6);
    let t12 = circuit_mul(t11, in4);
    let t13 = circuit_sub(t12, in2); // (Π(n-1,k) (Pk(z)) - R_n_minus_1(z))
    let t14 = circuit_mul(in3, in7);
    let t15 = circuit_add(t14, t13); // c_1 * previous_lhs + lhs_n_minus_1
    let t16 = circuit_mul(in1, t4); // Eval sparse poly P_irr step coeff_6 * z^6
    let t17 = circuit_add(in0, t16); // Eval sparse poly P_irr step + coeff_6 * z^6
    let t18 = circuit_add(t17, t10); // Eval sparse poly P_irr step + 1*z^12
    let t19 = circuit_mul(in89, in5); // Eval big_Q Horner step: multiply by z
    let t20 = circuit_add(in88, t19); // Eval big_Q Horner step: add coefficient_79
    let t21 = circuit_mul(t20, in5); // Eval big_Q Horner step: multiply by z
    let t22 = circuit_add(in87, t21); // Eval big_Q Horner step: add coefficient_78
    let t23 = circuit_mul(t22, in5); // Eval big_Q Horner step: multiply by z
    let t24 = circuit_add(in86, t23); // Eval big_Q Horner step: add coefficient_77
    let t25 = circuit_mul(t24, in5); // Eval big_Q Horner step: multiply by z
    let t26 = circuit_add(in85, t25); // Eval big_Q Horner step: add coefficient_76
    let t27 = circuit_mul(t26, in5); // Eval big_Q Horner step: multiply by z
    let t28 = circuit_add(in84, t27); // Eval big_Q Horner step: add coefficient_75
    let t29 = circuit_mul(t28, in5); // Eval big_Q Horner step: multiply by z
    let t30 = circuit_add(in83, t29); // Eval big_Q Horner step: add coefficient_74
    let t31 = circuit_mul(t30, in5); // Eval big_Q Horner step: multiply by z
    let t32 = circuit_add(in82, t31); // Eval big_Q Horner step: add coefficient_73
    let t33 = circuit_mul(t32, in5); // Eval big_Q Horner step: multiply by z
    let t34 = circuit_add(in81, t33); // Eval big_Q Horner step: add coefficient_72
    let t35 = circuit_mul(t34, in5); // Eval big_Q Horner step: multiply by z
    let t36 = circuit_add(in80, t35); // Eval big_Q Horner step: add coefficient_71
    let t37 = circuit_mul(t36, in5); // Eval big_Q Horner step: multiply by z
    let t38 = circuit_add(in79, t37); // Eval big_Q Horner step: add coefficient_70
    let t39 = circuit_mul(t38, in5); // Eval big_Q Horner step: multiply by z
    let t40 = circuit_add(in78, t39); // Eval big_Q Horner step: add coefficient_69
    let t41 = circuit_mul(t40, in5); // Eval big_Q Horner step: multiply by z
    let t42 = circuit_add(in77, t41); // Eval big_Q Horner step: add coefficient_68
    let t43 = circuit_mul(t42, in5); // Eval big_Q Horner step: multiply by z
    let t44 = circuit_add(in76, t43); // Eval big_Q Horner step: add coefficient_67
    let t45 = circuit_mul(t44, in5); // Eval big_Q Horner step: multiply by z
    let t46 = circuit_add(in75, t45); // Eval big_Q Horner step: add coefficient_66
    let t47 = circuit_mul(t46, in5); // Eval big_Q Horner step: multiply by z
    let t48 = circuit_add(in74, t47); // Eval big_Q Horner step: add coefficient_65
    let t49 = circuit_mul(t48, in5); // Eval big_Q Horner step: multiply by z
    let t50 = circuit_add(in73, t49); // Eval big_Q Horner step: add coefficient_64
    let t51 = circuit_mul(t50, in5); // Eval big_Q Horner step: multiply by z
    let t52 = circuit_add(in72, t51); // Eval big_Q Horner step: add coefficient_63
    let t53 = circuit_mul(t52, in5); // Eval big_Q Horner step: multiply by z
    let t54 = circuit_add(in71, t53); // Eval big_Q Horner step: add coefficient_62
    let t55 = circuit_mul(t54, in5); // Eval big_Q Horner step: multiply by z
    let t56 = circuit_add(in70, t55); // Eval big_Q Horner step: add coefficient_61
    let t57 = circuit_mul(t56, in5); // Eval big_Q Horner step: multiply by z
    let t58 = circuit_add(in69, t57); // Eval big_Q Horner step: add coefficient_60
    let t59 = circuit_mul(t58, in5); // Eval big_Q Horner step: multiply by z
    let t60 = circuit_add(in68, t59); // Eval big_Q Horner step: add coefficient_59
    let t61 = circuit_mul(t60, in5); // Eval big_Q Horner step: multiply by z
    let t62 = circuit_add(in67, t61); // Eval big_Q Horner step: add coefficient_58
    let t63 = circuit_mul(t62, in5); // Eval big_Q Horner step: multiply by z
    let t64 = circuit_add(in66, t63); // Eval big_Q Horner step: add coefficient_57
    let t65 = circuit_mul(t64, in5); // Eval big_Q Horner step: multiply by z
    let t66 = circuit_add(in65, t65); // Eval big_Q Horner step: add coefficient_56
    let t67 = circuit_mul(t66, in5); // Eval big_Q Horner step: multiply by z
    let t68 = circuit_add(in64, t67); // Eval big_Q Horner step: add coefficient_55
    let t69 = circuit_mul(t68, in5); // Eval big_Q Horner step: multiply by z
    let t70 = circuit_add(in63, t69); // Eval big_Q Horner step: add coefficient_54
    let t71 = circuit_mul(t70, in5); // Eval big_Q Horner step: multiply by z
    let t72 = circuit_add(in62, t71); // Eval big_Q Horner step: add coefficient_53
    let t73 = circuit_mul(t72, in5); // Eval big_Q Horner step: multiply by z
    let t74 = circuit_add(in61, t73); // Eval big_Q Horner step: add coefficient_52
    let t75 = circuit_mul(t74, in5); // Eval big_Q Horner step: multiply by z
    let t76 = circuit_add(in60, t75); // Eval big_Q Horner step: add coefficient_51
    let t77 = circuit_mul(t76, in5); // Eval big_Q Horner step: multiply by z
    let t78 = circuit_add(in59, t77); // Eval big_Q Horner step: add coefficient_50
    let t79 = circuit_mul(t78, in5); // Eval big_Q Horner step: multiply by z
    let t80 = circuit_add(in58, t79); // Eval big_Q Horner step: add coefficient_49
    let t81 = circuit_mul(t80, in5); // Eval big_Q Horner step: multiply by z
    let t82 = circuit_add(in57, t81); // Eval big_Q Horner step: add coefficient_48
    let t83 = circuit_mul(t82, in5); // Eval big_Q Horner step: multiply by z
    let t84 = circuit_add(in56, t83); // Eval big_Q Horner step: add coefficient_47
    let t85 = circuit_mul(t84, in5); // Eval big_Q Horner step: multiply by z
    let t86 = circuit_add(in55, t85); // Eval big_Q Horner step: add coefficient_46
    let t87 = circuit_mul(t86, in5); // Eval big_Q Horner step: multiply by z
    let t88 = circuit_add(in54, t87); // Eval big_Q Horner step: add coefficient_45
    let t89 = circuit_mul(t88, in5); // Eval big_Q Horner step: multiply by z
    let t90 = circuit_add(in53, t89); // Eval big_Q Horner step: add coefficient_44
    let t91 = circuit_mul(t90, in5); // Eval big_Q Horner step: multiply by z
    let t92 = circuit_add(in52, t91); // Eval big_Q Horner step: add coefficient_43
    let t93 = circuit_mul(t92, in5); // Eval big_Q Horner step: multiply by z
    let t94 = circuit_add(in51, t93); // Eval big_Q Horner step: add coefficient_42
    let t95 = circuit_mul(t94, in5); // Eval big_Q Horner step: multiply by z
    let t96 = circuit_add(in50, t95); // Eval big_Q Horner step: add coefficient_41
    let t97 = circuit_mul(t96, in5); // Eval big_Q Horner step: multiply by z
    let t98 = circuit_add(in49, t97); // Eval big_Q Horner step: add coefficient_40
    let t99 = circuit_mul(t98, in5); // Eval big_Q Horner step: multiply by z
    let t100 = circuit_add(in48, t99); // Eval big_Q Horner step: add coefficient_39
    let t101 = circuit_mul(t100, in5); // Eval big_Q Horner step: multiply by z
    let t102 = circuit_add(in47, t101); // Eval big_Q Horner step: add coefficient_38
    let t103 = circuit_mul(t102, in5); // Eval big_Q Horner step: multiply by z
    let t104 = circuit_add(in46, t103); // Eval big_Q Horner step: add coefficient_37
    let t105 = circuit_mul(t104, in5); // Eval big_Q Horner step: multiply by z
    let t106 = circuit_add(in45, t105); // Eval big_Q Horner step: add coefficient_36
    let t107 = circuit_mul(t106, in5); // Eval big_Q Horner step: multiply by z
    let t108 = circuit_add(in44, t107); // Eval big_Q Horner step: add coefficient_35
    let t109 = circuit_mul(t108, in5); // Eval big_Q Horner step: multiply by z
    let t110 = circuit_add(in43, t109); // Eval big_Q Horner step: add coefficient_34
    let t111 = circuit_mul(t110, in5); // Eval big_Q Horner step: multiply by z
    let t112 = circuit_add(in42, t111); // Eval big_Q Horner step: add coefficient_33
    let t113 = circuit_mul(t112, in5); // Eval big_Q Horner step: multiply by z
    let t114 = circuit_add(in41, t113); // Eval big_Q Horner step: add coefficient_32
    let t115 = circuit_mul(t114, in5); // Eval big_Q Horner step: multiply by z
    let t116 = circuit_add(in40, t115); // Eval big_Q Horner step: add coefficient_31
    let t117 = circuit_mul(t116, in5); // Eval big_Q Horner step: multiply by z
    let t118 = circuit_add(in39, t117); // Eval big_Q Horner step: add coefficient_30
    let t119 = circuit_mul(t118, in5); // Eval big_Q Horner step: multiply by z
    let t120 = circuit_add(in38, t119); // Eval big_Q Horner step: add coefficient_29
    let t121 = circuit_mul(t120, in5); // Eval big_Q Horner step: multiply by z
    let t122 = circuit_add(in37, t121); // Eval big_Q Horner step: add coefficient_28
    let t123 = circuit_mul(t122, in5); // Eval big_Q Horner step: multiply by z
    let t124 = circuit_add(in36, t123); // Eval big_Q Horner step: add coefficient_27
    let t125 = circuit_mul(t124, in5); // Eval big_Q Horner step: multiply by z
    let t126 = circuit_add(in35, t125); // Eval big_Q Horner step: add coefficient_26
    let t127 = circuit_mul(t126, in5); // Eval big_Q Horner step: multiply by z
    let t128 = circuit_add(in34, t127); // Eval big_Q Horner step: add coefficient_25
    let t129 = circuit_mul(t128, in5); // Eval big_Q Horner step: multiply by z
    let t130 = circuit_add(in33, t129); // Eval big_Q Horner step: add coefficient_24
    let t131 = circuit_mul(t130, in5); // Eval big_Q Horner step: multiply by z
    let t132 = circuit_add(in32, t131); // Eval big_Q Horner step: add coefficient_23
    let t133 = circuit_mul(t132, in5); // Eval big_Q Horner step: multiply by z
    let t134 = circuit_add(in31, t133); // Eval big_Q Horner step: add coefficient_22
    let t135 = circuit_mul(t134, in5); // Eval big_Q Horner step: multiply by z
    let t136 = circuit_add(in30, t135); // Eval big_Q Horner step: add coefficient_21
    let t137 = circuit_mul(t136, in5); // Eval big_Q Horner step: multiply by z
    let t138 = circuit_add(in29, t137); // Eval big_Q Horner step: add coefficient_20
    let t139 = circuit_mul(t138, in5); // Eval big_Q Horner step: multiply by z
    let t140 = circuit_add(in28, t139); // Eval big_Q Horner step: add coefficient_19
    let t141 = circuit_mul(t140, in5); // Eval big_Q Horner step: multiply by z
    let t142 = circuit_add(in27, t141); // Eval big_Q Horner step: add coefficient_18
    let t143 = circuit_mul(t142, in5); // Eval big_Q Horner step: multiply by z
    let t144 = circuit_add(in26, t143); // Eval big_Q Horner step: add coefficient_17
    let t145 = circuit_mul(t144, in5); // Eval big_Q Horner step: multiply by z
    let t146 = circuit_add(in25, t145); // Eval big_Q Horner step: add coefficient_16
    let t147 = circuit_mul(t146, in5); // Eval big_Q Horner step: multiply by z
    let t148 = circuit_add(in24, t147); // Eval big_Q Horner step: add coefficient_15
    let t149 = circuit_mul(t148, in5); // Eval big_Q Horner step: multiply by z
    let t150 = circuit_add(in23, t149); // Eval big_Q Horner step: add coefficient_14
    let t151 = circuit_mul(t150, in5); // Eval big_Q Horner step: multiply by z
    let t152 = circuit_add(in22, t151); // Eval big_Q Horner step: add coefficient_13
    let t153 = circuit_mul(t152, in5); // Eval big_Q Horner step: multiply by z
    let t154 = circuit_add(in21, t153); // Eval big_Q Horner step: add coefficient_12
    let t155 = circuit_mul(t154, in5); // Eval big_Q Horner step: multiply by z
    let t156 = circuit_add(in20, t155); // Eval big_Q Horner step: add coefficient_11
    let t157 = circuit_mul(t156, in5); // Eval big_Q Horner step: multiply by z
    let t158 = circuit_add(in19, t157); // Eval big_Q Horner step: add coefficient_10
    let t159 = circuit_mul(t158, in5); // Eval big_Q Horner step: multiply by z
    let t160 = circuit_add(in18, t159); // Eval big_Q Horner step: add coefficient_9
    let t161 = circuit_mul(t160, in5); // Eval big_Q Horner step: multiply by z
    let t162 = circuit_add(in17, t161); // Eval big_Q Horner step: add coefficient_8
    let t163 = circuit_mul(t162, in5); // Eval big_Q Horner step: multiply by z
    let t164 = circuit_add(in16, t163); // Eval big_Q Horner step: add coefficient_7
    let t165 = circuit_mul(t164, in5); // Eval big_Q Horner step: multiply by z
    let t166 = circuit_add(in15, t165); // Eval big_Q Horner step: add coefficient_6
    let t167 = circuit_mul(t166, in5); // Eval big_Q Horner step: multiply by z
    let t168 = circuit_add(in14, t167); // Eval big_Q Horner step: add coefficient_5
    let t169 = circuit_mul(t168, in5); // Eval big_Q Horner step: multiply by z
    let t170 = circuit_add(in13, t169); // Eval big_Q Horner step: add coefficient_4
    let t171 = circuit_mul(t170, in5); // Eval big_Q Horner step: multiply by z
    let t172 = circuit_add(in12, t171); // Eval big_Q Horner step: add coefficient_3
    let t173 = circuit_mul(t172, in5); // Eval big_Q Horner step: multiply by z
    let t174 = circuit_add(in11, t173); // Eval big_Q Horner step: add coefficient_2
    let t175 = circuit_mul(t174, in5); // Eval big_Q Horner step: multiply by z
    let t176 = circuit_add(in10, t175); // Eval big_Q Horner step: add coefficient_1
    let t177 = circuit_mul(t176, in5); // Eval big_Q Horner step: multiply by z
    let t178 = circuit_add(in9, t177); // Eval big_Q Horner step: add coefficient_0
    let t179 = circuit_mul(t178, t18); // Q(z) * P(z)
    let t180 = circuit_sub(t15, t179); // final_lhs - Q(z) * P(z)

    let modulus = crate::definitions::get_BLS12_381_modulus(); // BLS12_381 prime field modulus

    let mut circuit_inputs = (t180,).new_inputs();
    // Prefill constants:
    ...
    circuit_inputs = circuit_inputs.next_2(c_1); // in3
    ...
    let outputs = circuit_inputs.done_2().eval(modulus).unwrap();
    let final_check: u384 = outputs.get_output(t180);
    return (final_check,);
}
#[inline(always)]
pub fn run_BLS12_381_MP_CHECK_FINALIZE_BLS_3P_circuit(
    ...
    let t17 = circuit_add(in0, t16); // Eval sparse poly P_irr step + coeff_6 * z^6
    let t18 = circuit_add(t17, t10); // Eval sparse poly P_irr step + 1*z^12
    let t19 = circuit_mul(in113, in5); // Eval big_Q Horner step: multiply by z
    let t20 = circuit_add(in112, t19); // Eval big_Q Horner step: add coefficient_103
    let t21 = circuit_mul(t20, in5); // Eval big_Q Horner step: multiply by z
    let t22 = circuit_add(in111, t21); // Eval big_Q Horner step: add coefficient_102
    let t23 = circuit_mul(t22, in5); // Eval big_Q Horner step: multiply by z
    let t24 = circuit_add(in110, t23); // Eval big_Q Horner step: add coefficient_101
    let t25 = circuit_mul(t24, in5); // Eval big_Q Horner step: multiply by z
    let t26 = circuit_add(in109, t25); // Eval big_Q Horner step: add coefficient_100
    let t27 = circuit_mul(t26, in5); // Eval big_Q Horner step: multiply by z
    let t28 = circuit_add(in108, t27); // Eval big_Q Horner step: add coefficient_99
    let t29 = circuit_mul(t28, in5); // Eval big_Q Horner step: multiply by z
    let t30 = circuit_add(in107, t29); // Eval big_Q Horner step: add coefficient_98
    let t31 = circuit_mul(t30, in5); // Eval big_Q Horner step: multiply by z
    let t32 = circuit_add(in106, t31); // Eval big_Q Horner step: add coefficient_97
    let t33 = circuit_mul(t32, in5); // Eval big_Q Horner step: multiply by z
    let t34 = circuit_add(in105, t33); // Eval big_Q Horner step: add coefficient_96
    let t35 = circuit_mul(t34, in5); // Eval big_Q Horner step: multiply by z
    let t36 = circuit_add(in104, t35); // Eval big_Q Horner step: add coefficient_95
    let t37 = circuit_mul(t36, in5); // Eval big_Q Horner step: multiply by z
    let t38 = circuit_add(in103, t37); // Eval big_Q Horner step: add coefficient_94
    let t39 = circuit_mul(t38, in5); // Eval big_Q Horner step: multiply by z
    let t40 = circuit_add(in102, t39); // Eval big_Q Horner step: add coefficient_93
    let t41 = circuit_mul(t40, in5); // Eval big_Q Horner step: multiply by z
    let t42 = circuit_add(in101, t41); // Eval big_Q Horner step: add coefficient_92
    let t43 = circuit_mul(t42, in5); // Eval big_Q Horner step: multiply by z
    let t44 = circuit_add(in100, t43); // Eval big_Q Horner step: add coefficient_91
    let t45 = circuit_mul(t44, in5); // Eval big_Q Horner step: multiply by z
    let t46 = circuit_add(in99, t45); // Eval big_Q Horner step: add coefficient_90
    let t47 = circuit_mul(t46, in5); // Eval big_Q Horner step: multiply by z
    let t48 = circuit_add(in98, t47); // Eval big_Q Horner step: add coefficient_89
    let t49 = circuit_mul(t48, in5); // Eval big_Q Horner step: multiply by z
    let t50 = circuit_add(in97, t49); // Eval big_Q Horner step: add coefficient_88
    let t51 = circuit_mul(t50, in5); // Eval big_Q Horner step: multiply by z
    let t52 = circuit_add(in96, t51); // Eval big_Q Horner step: add coefficient_87
    let t53 = circuit_mul(t52, in5); // Eval big_Q Horner step: multiply by z
    let t54 = circuit_add(in95, t53); // Eval big_Q Horner step: add coefficient_86
    let t55 = circuit_mul(t54, in5); // Eval big_Q Horner step: multiply by z
    let t56 = circuit_add(in94, t55); // Eval big_Q Horner step: add coefficient_85
    let t57 = circuit_mul(t56, in5); // Eval big_Q Horner step: multiply by z
    let t58 = circuit_add(in93, t57); // Eval big_Q Horner step: add coefficient_84
    let t59 = circuit_mul(t58, in5); // Eval big_Q Horner step: multiply by z
    let t60 = circuit_add(in92, t59); // Eval big_Q Horner step: add coefficient_83
    let t61 = circuit_mul(t60, in5); // Eval big_Q Horner step: multiply by z
    let t62 = circuit_add(in91, t61); // Eval big_Q Horner step: add coefficient_82
    let t63 = circuit_mul(t62, in5); // Eval big_Q Horner step: multiply by z
    let t64 = circuit_add(in90, t63); // Eval big_Q Horner step: add coefficient_81
    let t65 = circuit_mul(t64, in5); // Eval big_Q Horner step: multiply by z
    let t66 = circuit_add(in89, t65); // Eval big_Q Horner step: add coefficient_80
    let t67 = circuit_mul(t66, in5); // Eval big_Q Horner step: multiply by z
    let t68 = circuit_add(in88, t67); // Eval big_Q Horner step: add coefficient_79
    let t69 = circuit_mul(t68, in5); // Eval big_Q Horner step: multiply by z
    let t70 = circuit_add(in87, t69); // Eval big_Q Horner step: add coefficient_78
    let t71 = circuit_mul(t70, in5); // Eval big_Q Horner step: multiply by z
    let t72 = circuit_add(in86, t71); // Eval big_Q Horner step: add coefficient_77
    let t73 = circuit_mul(t72, in5); // Eval big_Q Horner step: multiply by z
    let t74 = circuit_add(in85, t73); // Eval big_Q Horner step: add coefficient_76
    let t75 = circuit_mul(t74, in5); // Eval big_Q Horner step: multiply by z
    let t76 = circuit_add(in84, t75); // Eval big_Q Horner step: add coefficient_75
    let t77 = circuit_mul(t76, in5); // Eval big_Q Horner step: multiply by z
    let t78 = circuit_add(in83, t77); // Eval big_Q Horner step: add coefficient_74
    let t79 = circuit_mul(t78, in5); // Eval big_Q Horner step: multiply by z
    let t80 = circuit_add(in82, t79); // Eval big_Q Horner step: add coefficient_73
    let t81 = circuit_mul(t80, in5); // Eval big_Q Horner step: multiply by z
    let t82 = circuit_add(in81, t81); // Eval big_Q Horner step: add coefficient_72
    let t83 = circuit_mul(t82, in5); // Eval big_Q Horner step: multiply by z
    let t84 = circuit_add(in80, t83); // Eval big_Q Horner step: add coefficient_71
    let t85 = circuit_mul(t84, in5); // Eval big_Q Horner step: multiply by z
    let t86 = circuit_add(in79, t85); // Eval big_Q Horner step: add coefficient_70
    let t87 = circuit_mul(t86, in5); // Eval big_Q Horner step: multiply by z
    let t88 = circuit_add(in78, t87); // Eval big_Q Horner step: add coefficient_69
    let t89 = circuit_mul(t88, in5); // Eval big_Q Horner step: multiply by z
    let t90 = circuit_add(in77, t89); // Eval big_Q Horner step: add coefficient_68
    let t91 = circuit_mul(t90, in5); // Eval big_Q Horner step: multiply by z
    let t92 = circuit_add(in76, t91); // Eval big_Q Horner step: add coefficient_67
    let t93 = circuit_mul(t92, in5); // Eval big_Q Horner step: multiply by z
    let t94 = circuit_add(in75, t93); // Eval big_Q Horner step: add coefficient_66
    let t95 = circuit_mul(t94, in5); // Eval big_Q Horner step: multiply by z
    let t96 = circuit_add(in74, t95); // Eval big_Q Horner step: add coefficient_65
    let t97 = circuit_mul(t96, in5); // Eval big_Q Horner step: multiply by z
    let t98 = circuit_add(in73, t97); // Eval big_Q Horner step: add coefficient_64
    let t99 = circuit_mul(t98, in5); // Eval big_Q Horner step: multiply by z
    let t100 = circuit_add(in72, t99); // Eval big_Q Horner step: add coefficient_63
    let t101 = circuit_mul(t100, in5); // Eval big_Q Horner step: multiply by z
    let t102 = circuit_add(in71, t101); // Eval big_Q Horner step: add coefficient_62
    let t103 = circuit_mul(t102, in5); // Eval big_Q Horner step: multiply by z
    let t104 = circuit_add(in70, t103); // Eval big_Q Horner step: add coefficient_61
    let t105 = circuit_mul(t104, in5); // Eval big_Q Horner step: multiply by z
    let t106 = circuit_add(in69, t105); // Eval big_Q Horner step: add coefficient_60
    let t107 = circuit_mul(t106, in5); // Eval big_Q Horner step: multiply by z
    let t108 = circuit_add(in68, t107); // Eval big_Q Horner step: add coefficient_59
    let t109 = circuit_mul(t108, in5); // Eval big_Q Horner step: multiply by z
    let t110 = circuit_add(in67, t109); // Eval big_Q Horner step: add coefficient_58
    let t111 = circuit_mul(t110, in5); // Eval big_Q Horner step: multiply by z
    let t112 = circuit_add(in66, t111); // Eval big_Q Horner step: add coefficient_57
    let t113 = circuit_mul(t112, in5); // Eval big_Q Horner step: multiply by z
    let t114 = circuit_add(in65, t113); // Eval big_Q Horner step: add coefficient_56
    let t115 = circuit_mul(t114, in5); // Eval big_Q Horner step: multiply by z
    let t116 = circuit_add(in64, t115); // Eval big_Q Horner step: add coefficient_55
    let t117 = circuit_mul(t116, in5); // Eval big_Q Horner step: multiply by z
    let t118 = circuit_add(in63, t117); // Eval big_Q Horner step: add coefficient_54
    let t119 = circuit_mul(t118, in5); // Eval big_Q Horner step: multiply by z
    let t120 = circuit_add(in62, t119); // Eval big_Q Horner step: add coefficient_53
    let t121 = circuit_mul(t120, in5); // Eval big_Q Horner step: multiply by z
    let t122 = circuit_add(in61, t121); // Eval big_Q Horner step: add coefficient_52
    let t123 = circuit_mul(t122, in5); // Eval big_Q Horner step: multiply by z
    let t124 = circuit_add(in60, t123); // Eval big_Q Horner step: add coefficient_51
    let t125 = circuit_mul(t124, in5); // Eval big_Q Horner step: multiply by z
    let t126 = circuit_add(in59, t125); // Eval big_Q Horner step: add coefficient_50
    let t127 = circuit_mul(t126, in5); // Eval big_Q Horner step: multiply by z
    let t128 = circuit_add(in58, t127); // Eval big_Q Horner step: add coefficient_49
    let t129 = circuit_mul(t128, in5); // Eval big_Q Horner step: multiply by z
    let t130 = circuit_add(in57, t129); // Eval big_Q Horner step: add coefficient_48
    let t131 = circuit_mul(t130, in5); // Eval big_Q Horner step: multiply by z
    let t132 = circuit_add(in56, t131); // Eval big_Q Horner step: add coefficient_47
    let t133 = circuit_mul(t132, in5); // Eval big_Q Horner step: multiply by z
    let t134 = circuit_add(in55, t133); // Eval big_Q Horner step: add coefficient_46
    let t135 = circuit_mul(t134, in5); // Eval big_Q Horner step: multiply by z
    let t136 = circuit_add(in54, t135); // Eval big_Q Horner step: add coefficient_45
    let t137 = circuit_mul(t136, in5); // Eval big_Q Horner step: multiply by z
    let t138 = circuit_add(in53, t137); // Eval big_Q Horner step: add coefficient_44
    let t139 = circuit_mul(t138, in5); // Eval big_Q Horner step: multiply by z
    let t140 = circuit_add(in52, t139); // Eval big_Q Horner step: add coefficient_43
    let t141 = circuit_mul(t140, in5); // Eval big_Q Horner step: multiply by z
    let t142 = circuit_add(in51, t141); // Eval big_Q Horner step: add coefficient_42
    let t143 = circuit_mul(t142, in5); // Eval big_Q Horner step: multiply by z
    let t144 = circuit_add(in50, t143); // Eval big_Q Horner step: add coefficient_41
    let t145 = circuit_mul(t144, in5); // Eval big_Q Horner step: multiply by z
    let t146 = circuit_add(in49, t145); // Eval big_Q Horner step: add coefficient_40
    let t147 = circuit_mul(t146, in5); // Eval big_Q Horner step: multiply by z
    let t148 = circuit_add(in48, t147); // Eval big_Q Horner step: add coefficient_39
    let t149 = circuit_mul(t148, in5); // Eval big_Q Horner step: multiply by z
    let t150 = circuit_add(in47, t149); // Eval big_Q Horner step: add coefficient_38
    let t151 = circuit_mul(t150, in5); // Eval big_Q Horner step: multiply by z
    let t152 = circuit_add(in46, t151); // Eval big_Q Horner step: add coefficient_37
    let t153 = circuit_mul(t152, in5); // Eval big_Q Horner step: multiply by z
    let t154 = circuit_add(in45, t153); // Eval big_Q Horner step: add coefficient_36
    let t155 = circuit_mul(t154, in5); // Eval big_Q Horner step: multiply by z
    let t156 = circuit_add(in44, t155); // Eval big_Q Horner step: add coefficient_35
    let t157 = circuit_mul(t156, in5); // Eval big_Q Horner step: multiply by z
    let t158 = circuit_add(in43, t157); // Eval big_Q Horner step: add coefficient_34
    let t159 = circuit_mul(t158, in5); // Eval big_Q Horner step: multiply by z
    let t160 = circuit_add(in42, t159); // Eval big_Q Horner step: add coefficient_33
    let t161 = circuit_mul(t160, in5); // Eval big_Q Horner step: multiply by z
    let t162 = circuit_add(in41, t161); // Eval big_Q Horner step: add coefficient_32
    let t163 = circuit_mul(t162, in5); // Eval big_Q Horner step: multiply by z
    let t164 = circuit_add(in40, t163); // Eval big_Q Horner step: add coefficient_31
    let t165 = circuit_mul(t164, in5); // Eval big_Q Horner step: multiply by z
    let t166 = circuit_add(in39, t165); // Eval big_Q Horner step: add coefficient_30
    let t167 = circuit_mul(t166, in5); // Eval big_Q Horner step: multiply by z
    let t168 = circuit_add(in38, t167); // Eval big_Q Horner step: add coefficient_29
    let t169 = circuit_mul(t168, in5); // Eval big_Q Horner step: multiply by z
    let t170 = circuit_add(in37, t169); // Eval big_Q Horner step: add coefficient_28
    let t171 = circuit_mul(t170, in5); // Eval big_Q Horner step: multiply by z
    let t172 = circuit_add(in36, t171); // Eval big_Q Horner step: add coefficient_27
    let t173 = circuit_mul(t172, in5); // Eval big_Q Horner step: multiply by z
    let t174 = circuit_add(in35, t173); // Eval big_Q Horner step: add coefficient_26
    let t175 = circuit_mul(t174, in5); // Eval big_Q Horner step: multiply by z
    let t176 = circuit_add(in34, t175); // Eval big_Q Horner step: add coefficient_25
    let t177 = circuit_mul(t176, in5); // Eval big_Q Horner step: multiply by z
    let t178 = circuit_add(in33, t177); // Eval big_Q Horner step: add coefficient_24
    let t179 = circuit_mul(t178, in5); // Eval big_Q Horner step: multiply by z
    let t180 = circuit_add(in32, t179); // Eval big_Q Horner step: add coefficient_23
    let t181 = circuit_mul(t180, in5); // Eval big_Q Horner step: multiply by z
    let t182 = circuit_add(in31, t181); // Eval big_Q Horner step: add coefficient_22
    let t183 = circuit_mul(t182, in5); // Eval big_Q Horner step: multiply by z
    let t184 = circuit_add(in30, t183); // Eval big_Q Horner step: add coefficient_21
    let t185 = circuit_mul(t184, in5); // Eval big_Q Horner step: multiply by z
    let t186 = circuit_add(in29, t185); // Eval big_Q Horner step: add coefficient_20
    let t187 = circuit_mul(t186, in5); // Eval big_Q Horner step: multiply by z
    let t188 = circuit_add(in28, t187); // Eval big_Q Horner step: add coefficient_19
    let t189 = circuit_mul(t188, in5); // Eval big_Q Horner step: multiply by z
    let t190 = circuit_add(in27, t189); // Eval big_Q Horner step: add coefficient_18
    let t191 = circuit_mul(t190, in5); // Eval big_Q Horner step: multiply by z
    let t192 = circuit_add(in26, t191); // Eval big_Q Horner step: add coefficient_17
    let t193 = circuit_mul(t192, in5); // Eval big_Q Horner step: multiply by z
    let t194 = circuit_add(in25, t193); // Eval big_Q Horner step: add coefficient_16
    let t195 = circuit_mul(t194, in5); // Eval big_Q Horner step: multiply by z
    let t196 = circuit_add(in24, t195); // Eval big_Q Horner step: add coefficient_15
    let t197 = circuit_mul(t196, in5); // Eval big_Q Horner step: multiply by z
    let t198 = circuit_add(in23, t197); // Eval big_Q Horner step: add coefficient_14
    let t199 = circuit_mul(t198, in5); // Eval big_Q Horner step: multiply by z
    let t200 = circuit_add(in22, t199); // Eval big_Q Horner step: add coefficient_13
    let t201 = circuit_mul(t200, in5); // Eval big_Q Horner step: multiply by z
    let t202 = circuit_add(in21, t201); // Eval big_Q Horner step: add coefficient_12
    let t203 = circuit_mul(t202, in5); // Eval big_Q Horner step: multiply by z
    let t204 = circuit_add(in20, t203); // Eval big_Q Horner step: add coefficient_11
    let t205 = circuit_mul(t204, in5); // Eval big_Q Horner step: multiply by z
    let t206 = circuit_add(in19, t205); // Eval big_Q Horner step: add coefficient_10
    let t207 = circuit_mul(t206, in5); // Eval big_Q Horner step: multiply by z
    let t208 = circuit_add(in18, t207); // Eval big_Q Horner step: add coefficient_9
    let t209 = circuit_mul(t208, in5); // Eval big_Q Horner step: multiply by z
    let t210 = circuit_add(in17, t209); // Eval big_Q Horner step: add coefficient_8
    let t211 = circuit_mul(t210, in5); // Eval big_Q Horner step: multiply by z
    let t212 = circuit_add(in16, t211); // Eval big_Q Horner step: add coefficient_7
    let t213 = circuit_mul(t212, in5); // Eval big_Q Horner step: multiply by z
    let t214 = circuit_add(in15, t213); // Eval big_Q Horner step: add coefficient_6
    let t215 = circuit_mul(t214, in5); // Eval big_Q Horner step: multiply by z
    let t216 = circuit_add(in14, t215); // Eval big_Q Horner step: add coefficient_5
    let t217 = circuit_mul(t216, in5); // Eval big_Q Horner step: multiply by z
    let t218 = circuit_add(in13, t217); // Eval big_Q Horner step: add coefficient_4
    let t219 = circuit_mul(t218, in5); // Eval big_Q Horner step: multiply by z
    let t220 = circuit_add(in12, t219); // Eval big_Q Horner step: add coefficient_3
    let t221 = circuit_mul(t220, in5); // Eval big_Q Horner step: multiply by z
    let t222 = circuit_add(in11, t221); // Eval big_Q Horner step: add coefficient_2
    let t223 = circuit_mul(t222, in5); // Eval big_Q Horner step: multiply by z
    let t224 = circuit_add(in10, t223); // Eval big_Q Horner step: add coefficient_1
    let t225 = circuit_mul(t224, in5); // Eval big_Q Horner step: multiply by z
    let t226 = circuit_add(in9, t225); // Eval big_Q Horner step: add coefficient_0
    let t227 = circuit_mul(t226, t18); // Q(z) * P(z)
    let t228 = circuit_sub(t15, t227); // final_lhs - Q(z) * P(z)

    let modulus = crate::definitions::get_BLS12_381_modulus(); // BLS12_381 prime field modulus

    let mut circuit_inputs = (t228,).new_inputs();
    // Prefill constants:
    circuit_inputs = circuit_inputs.next_2([0x2, 0x0, 0x0, 0x0]); // in0
    circuit_inputs = circuit_inputs
        .next_2(
    ...
    let outputs = circuit_inputs.done_2().eval(modulus).unwrap();
    let final_check: u384 = outputs.get_output(t228);
    return (final_check,);
}
#[inline(always)]
...
pub fn run_BN254_MP_CHECK_FINALIZE_BN_2P_2F_circuit(
    ...
    let t38 = circuit_mul(t8, in28); // Eval sparse poly line_1 step coeff_1 * z^1
    let t39 = circuit_add(in1, t38); // Eval sparse poly line_1 step + coeff_1 * z^1
    let t40 = circuit_mul(t11, t1); // Eval sparse poly line_1 step coeff_3 * z^3
    let t41 = circuit_add(t39, t40); // Eval sparse poly line_1 step + coeff_3 * z^3
    let t42 = circuit_mul(t12, t3); // Eval sparse poly line_1 step coeff_7 * z^7
    let t43 = circuit_add(t41, t42); // Eval sparse poly line_1 step + coeff_7 * z^7
    let t44 = circuit_mul(t13, t4); // Eval sparse poly line_1 step coeff_9 * z^9
    let t45 = circuit_add(t43, t44); // Eval sparse poly line_1 step + coeff_9 * z^9
    ...
    let t56 = circuit_mul(t24, in28); // Eval sparse poly line_1 step coeff_1 * z^1
    let t57 = circuit_add(in1, t56); // Eval sparse poly line_1 step + coeff_1 * z^1
    let t58 = circuit_mul(t27, t1); // Eval sparse poly line_1 step coeff_3 * z^3
    let t59 = circuit_add(t57, t58); // Eval sparse poly line_1 step + coeff_3 * z^3
    let t60 = circuit_mul(t28, t3); // Eval sparse poly line_1 step coeff_7 * z^7
    let t61 = circuit_add(t59, t60); // Eval sparse poly line_1 step + coeff_7 * z^7
    let t62 = circuit_mul(t29, t4); // Eval sparse poly line_1 step coeff_9 * z^9
    let t63 = circuit_add(t61, t62); // Eval sparse poly line_1 step + coeff_9 * z^9
    let t64 = circuit_mul(t55, t63);
    let t65 = circuit_mul(t32, in28); // Eval sparse poly line_1 step coeff_1 * z^1
    let t66 = circuit_add(in1, t65); // Eval sparse poly line_1 step + coeff_1 * z^1
    let t67 = circuit_mul(t35, t1); // Eval sparse poly line_1 step coeff_3 * z^3
    let t68 = circuit_add(t66, t67); // Eval sparse poly line_1 step + coeff_3 * z^3
    let t69 = circuit_mul(t36, t3); // Eval sparse poly line_1 step coeff_7 * z^7
    let t70 = circuit_add(t68, t69); // Eval sparse poly line_1 step + coeff_7 * z^7
    let t71 = circuit_mul(t37, t4); // Eval sparse poly line_1 step coeff_9 * z^9
    let t72 = circuit_add(t70, t71); // Eval sparse poly line_1 step + coeff_9 * z^9
...
pub fn run_BN254_MP_CHECK_FINALIZE_BN_3P_2F_circuit(
    ...
    let t141 = circuit_mul(t95, in44); // Eval sparse poly line_2 step coeff_1 * z^1
    let t142 = circuit_add(in5, t141); // Eval sparse poly line_2 step + coeff_1 * z^1
    let t143 = circuit_mul(t98, t1); // Eval sparse poly line_2 step coeff_3 * z^3
    let t144 = circuit_add(t142, t143); // Eval sparse poly line_2 step + coeff_3 * z^3
    let t145 = circuit_mul(t99, t3); // Eval sparse poly line_2 step coeff_7 * z^7
    let t146 = circuit_add(t144, t145); // Eval sparse poly line_2 step + coeff_7 * z^7
    let t147 = circuit_mul(t100, t4); // Eval sparse poly line_2 step coeff_9 * z^9
    let t148 = circuit_add(t146, t147); // Eval sparse poly line_2 step + coeff_9 * z^9
    let t149 = circuit_mul(in49, t148);
    let t150 = circuit_mul(t103, in44); // Eval sparse poly line_2 step coeff_1 * z^1
    let t151 = circuit_add(in5, t150); // Eval sparse poly line_2 step + coeff_1 * z^1
    let t152 = circuit_mul(t106, t1); // Eval sparse poly line_2 step coeff_3 * z^3
    let t153 = circuit_add(t151, t152); // Eval sparse poly line_2 step + coeff_3 * z^3
    let t154 = circuit_mul(t107, t3); // Eval sparse poly line_2 step coeff_7 * z^7
    let t155 = circuit_add(t153, t154); // Eval sparse poly line_2 step + coeff_7 * z^7
    let t156 = circuit_mul(t108, t4); // Eval sparse poly line_2 step coeff_9 * z^9
    let t157 = circuit_add(t155, t156); // Eval sparse poly line_2 step + coeff_9 * z^9
    ...
    let t168 = circuit_mul(t119, in44); // Eval sparse poly line_2 step coeff_1 * z^1
    let t169 = circuit_add(in5, t168); // Eval sparse poly line_2 step + coeff_1 * z^1
    let t170 = circuit_mul(t122, t1); // Eval sparse poly line_2 step coeff_3 * z^3
    let t171 = circuit_add(t169, t170); // Eval sparse poly line_2 step + coeff_3 * z^3
    let t172 = circuit_mul(t123, t3); // Eval sparse poly line_2 step coeff_7 * z^7
    let t173 = circuit_add(t171, t172); // Eval sparse poly line_2 step + coeff_7 * z^7
    let t174 = circuit_mul(t124, t4); // Eval sparse poly line_2 step coeff_9 * z^9
    let t175 = circuit_add(t173, t174); // Eval sparse poly line_2 step + coeff_9 * z^9
    let t176 = circuit_mul(t167, t175);
    let t177 = circuit_mul(t127, in44); // Eval sparse poly line_2 step coeff_1 * z^1
    let t178 = circuit_add(in5, t177); // Eval sparse poly line_2 step + coeff_1 * z^1
    let t179 = circuit_mul(t130, t1); // Eval sparse poly line_2 step coeff_3 * z^3
    let t180 = circuit_add(t178, t179); // Eval sparse poly line_2 step + coeff_3 * z^3
    let t181 = circuit_mul(t131, t3); // Eval sparse poly line_2 step coeff_7 * z^7
    let t182 = circuit_add(t180, t181); // Eval sparse poly line_2 step + coeff_7 * z^7
    let t183 = circuit_mul(t132, t4); // Eval sparse poly line_2 step coeff_9 * z^9
    let t184 = circuit_add(t182, t183); // Eval sparse poly line_2 step + coeff_9 * z^9
    let t185 = circuit_mul(t176, t184);
    let t186 = circuit_mul(t135, in44); // Eval sparse poly line_2 step coeff_1 * z^1
    let t187 = circuit_add(in5, t186); // Eval sparse poly line_2 step + coeff_1 * z^1
    let t188 = circuit_mul(t138, t1); // Eval sparse poly line_2 step coeff_3 * z^3
    let t189 = circuit_add(t187, t188); // Eval sparse poly line_2 step + coeff_3 * z^3
    let t190 = circuit_mul(t139, t3); // Eval sparse poly line_2 step coeff_7 * z^7
    let t191 = circuit_add(t189, t190); // Eval sparse poly line_2 step + coeff_7 * z^7
    let t192 = circuit_mul(t140, t4); // Eval sparse poly line_2 step coeff_9 * z^9
    let t193 = circuit_add(t191, t192); // Eval sparse poly line_2 step + coeff_9 * z^9
    ...
    let t200 = circuit_sub(t199, in41); // ((Π(n-1,k) (Pk(z)) - R_n_minus_1(z))
    let t201 = circuit_mul(in42, in48);
    let t202 = circuit_add(t201, t195);
    let t203 = circuit_mul(in42, t202);
    let t204 = circuit_add(t203, t200);
    let t205 = circuit_mul(in239, in44); // Eval big_Q Horner step: multiply by z
    let t206 = circuit_add(in238, t205); // Eval big_Q Horner step: add coefficient_188
    let t207 = circuit_mul(t206, in44); // Eval big_Q Horner step: multiply by z
    let t208 = circuit_add(in237, t207); // Eval big_Q Horner step: add coefficient_187
    let t209 = circuit_mul(t208, in44); // Eval big_Q Horner step: multiply by z
    let t210 = circuit_add(in236, t209); // Eval big_Q Horner step: add coefficient_186
    let t211 = circuit_mul(t210, in44); // Eval big_Q Horner step: multiply by z
    let t212 = circuit_add(in235, t211); // Eval big_Q Horner step: add coefficient_185
    let t213 = circuit_mul(t212, in44); // Eval big_Q Horner step: multiply by z
    let t214 = circuit_add(in234, t213); // Eval big_Q Horner step: add coefficient_184
    let t215 = circuit_mul(t214, in44); // Eval big_Q Horner step: multiply by z
    let t216 = circuit_add(in233, t215); // Eval big_Q Horner step: add coefficient_183
    let t217 = circuit_mul(t216, in44); // Eval big_Q Horner step: multiply by z
    let t218 = circuit_add(in232, t217); // Eval big_Q Horner step: add coefficient_182
    let t219 = circuit_mul(t218, in44); // Eval big_Q Horner step: multiply by z
    let t220 = circuit_add(in231, t219); // Eval big_Q Horner step: add coefficient_181
    let t221 = circuit_mul(t220, in44); // Eval big_Q Horner step: multiply by z
    let t222 = circuit_add(in230, t221); // Eval big_Q Horner step: add coefficient_180
    let t223 = circuit_mul(t222, in44); // Eval big_Q Horner step: multiply by z
    let t224 = circuit_add(in229, t223); // Eval big_Q Horner step: add coefficient_179
    let t225 = circuit_mul(t224, in44); // Eval big_Q Horner step: multiply by z
    let t226 = circuit_add(in228, t225); // Eval big_Q Horner step: add coefficient_178
    let t227 = circuit_mul(t226, in44); // Eval big_Q Horner step: multiply by z
    let t228 = circuit_add(in227, t227); // Eval big_Q Horner step: add coefficient_177
    let t229 = circuit_mul(t228, in44); // Eval big_Q Horner step: multiply by z
    let t230 = circuit_add(in226, t229); // Eval big_Q Horner step: add coefficient_176
    let t231 = circuit_mul(t230, in44); // Eval big_Q Horner step: multiply by z
    let t232 = circuit_add(in225, t231); // Eval big_Q Horner step: add coefficient_175
    let t233 = circuit_mul(t232, in44); // Eval big_Q Horner step: multiply by z
    let t234 = circuit_add(in224, t233); // Eval big_Q Horner step: add coefficient_174
    let t235 = circuit_mul(t234, in44); // Eval big_Q Horner step: multiply by z
    let t236 = circuit_add(in223, t235); // Eval big_Q Horner step: add coefficient_173
    let t237 = circuit_mul(t236, in44); // Eval big_Q Horner step: multiply by z
    let t238 = circuit_add(in222, t237); // Eval big_Q Horner step: add coefficient_172
    let t239 = circuit_mul(t238, in44); // Eval big_Q Horner step: multiply by z
    let t240 = circuit_add(in221, t239); // Eval big_Q Horner step: add coefficient_171
    let t241 = circuit_mul(t240, in44); // Eval big_Q Horner step: multiply by z
    let t242 = circuit_add(in220, t241); // Eval big_Q Horner step: add coefficient_170
    let t243 = circuit_mul(t242, in44); // Eval big_Q Horner step: multiply by z
    let t244 = circuit_add(in219, t243); // Eval big_Q Horner step: add coefficient_169
    let t245 = circuit_mul(t244, in44); // Eval big_Q Horner step: multiply by z
    let t246 = circuit_add(in218, t245); // Eval big_Q Horner step: add coefficient_168
    let t247 = circuit_mul(t246, in44); // Eval big_Q Horner step: multiply by z
    let t248 = circuit_add(in217, t247); // Eval big_Q Horner step: add coefficient_167
    let t249 = circuit_mul(t248, in44); // Eval big_Q Horner step: multiply by z
    let t250 = circuit_add(in216, t249); // Eval big_Q Horner step: add coefficient_166
    let t251 = circuit_mul(t250, in44); // Eval big_Q Horner step: multiply by z
    let t252 = circuit_add(in215, t251); // Eval big_Q Horner step: add coefficient_165
    let t253 = circuit_mul(t252, in44); // Eval big_Q Horner step: multiply by z
    let t254 = circuit_add(in214, t253); // Eval big_Q Horner step: add coefficient_164
    let t255 = circuit_mul(t254, in44); // Eval big_Q Horner step: multiply by z
    let t256 = circuit_add(in213, t255); // Eval big_Q Horner step: add coefficient_163
    let t257 = circuit_mul(t256, in44); // Eval big_Q Horner step: multiply by z
    let t258 = circuit_add(in212, t257); // Eval big_Q Horner step: add coefficient_162
    let t259 = circuit_mul(t258, in44); // Eval big_Q Horner step: multiply by z
    let t260 = circuit_add(in211, t259); // Eval big_Q Horner step: add coefficient_161
    let t261 = circuit_mul(t260, in44); // Eval big_Q Horner step: multiply by z
    let t262 = circuit_add(in210, t261); // Eval big_Q Horner step: add coefficient_160
    let t263 = circuit_mul(t262, in44); // Eval big_Q Horner step: multiply by z
    let t264 = circuit_add(in209, t263); // Eval big_Q Horner step: add coefficient_159
    let t265 = circuit_mul(t264, in44); // Eval big_Q Horner step: multiply by z
    let t266 = circuit_add(in208, t265); // Eval big_Q Horner step: add coefficient_158
    let t267 = circuit_mul(t266, in44); // Eval big_Q Horner step: multiply by z
    let t268 = circuit_add(in207, t267); // Eval big_Q Horner step: add coefficient_157
    let t269 = circuit_mul(t268, in44); // Eval big_Q Horner step: multiply by z
    let t270 = circuit_add(in206, t269); // Eval big_Q Horner step: add coefficient_156
    let t271 = circuit_mul(t270, in44); // Eval big_Q Horner step: multiply by z
    let t272 = circuit_add(in205, t271); // Eval big_Q Horner step: add coefficient_155
    let t273 = circuit_mul(t272, in44); // Eval big_Q Horner step: multiply by z
    let t274 = circuit_add(in204, t273); // Eval big_Q Horner step: add coefficient_154
    let t275 = circuit_mul(t274, in44); // Eval big_Q Horner step: multiply by z
    let t276 = circuit_add(in203, t275); // Eval big_Q Horner step: add coefficient_153
    let t277 = circuit_mul(t276, in44); // Eval big_Q Horner step: multiply by z
    let t278 = circuit_add(in202, t277); // Eval big_Q Horner step: add coefficient_152
    let t279 = circuit_mul(t278, in44); // Eval big_Q Horner step: multiply by z
    let t280 = circuit_add(in201, t279); // Eval big_Q Horner step: add coefficient_151
    let t281 = circuit_mul(t280, in44); // Eval big_Q Horner step: multiply by z
    let t282 = circuit_add(in200, t281); // Eval big_Q Horner step: add coefficient_150
    let t283 = circuit_mul(t282, in44); // Eval big_Q Horner step: multiply by z
    let t284 = circuit_add(in199, t283); // Eval big_Q Horner step: add coefficient_149
    let t285 = circuit_mul(t284, in44); // Eval big_Q Horner step: multiply by z
    let t286 = circuit_add(in198, t285); // Eval big_Q Horner step: add coefficient_148
    let t287 = circuit_mul(t286, in44); // Eval big_Q Horner step: multiply by z
    let t288 = circuit_add(in197, t287); // Eval big_Q Horner step: add coefficient_147
    let t289 = circuit_mul(t288, in44); // Eval big_Q Horner step: multiply by z
    let t290 = circuit_add(in196, t289); // Eval big_Q Horner step: add coefficient_146
    let t291 = circuit_mul(t290, in44); // Eval big_Q Horner step: multiply by z
    let t292 = circuit_add(in195, t291); // Eval big_Q Horner step: add coefficient_145
    let t293 = circuit_mul(t292, in44); // Eval big_Q Horner step: multiply by z
    let t294 = circuit_add(in194, t293); // Eval big_Q Horner step: add coefficient_144
    let t295 = circuit_mul(t294, in44); // Eval big_Q Horner step: multiply by z
    let t296 = circuit_add(in193, t295); // Eval big_Q Horner step: add coefficient_143
    let t297 = circuit_mul(t296, in44); // Eval big_Q Horner step: multiply by z
    let t298 = circuit_add(in192, t297); // Eval big_Q Horner step: add coefficient_142
    let t299 = circuit_mul(t298, in44); // Eval big_Q Horner step: multiply by z
    let t300 = circuit_add(in191, t299); // Eval big_Q Horner step: add coefficient_141
    let t301 = circuit_mul(t300, in44); // Eval big_Q Horner step: multiply by z
    let t302 = circuit_add(in190, t301); // Eval big_Q Horner step: add coefficient_140
    let t303 = circuit_mul(t302, in44); // Eval big_Q Horner step: multiply by z
    let t304 = circuit_add(in189, t303); // Eval big_Q Horner step: add coefficient_139
    let t305 = circuit_mul(t304, in44); // Eval big_Q Horner step: multiply by z
    let t306 = circuit_add(in188, t305); // Eval big_Q Horner step: add coefficient_138
    let t307 = circuit_mul(t306, in44); // Eval big_Q Horner step: multiply by z
    let t308 = circuit_add(in187, t307); // Eval big_Q Horner step: add coefficient_137
    let t309 = circuit_mul(t308, in44); // Eval big_Q Horner step: multiply by z
    let t310 = circuit_add(in186, t309); // Eval big_Q Horner step: add coefficient_136
    let t311 = circuit_mul(t310, in44); // Eval big_Q Horner step: multiply by z
    let t312 = circuit_add(in185, t311); // Eval big_Q Horner step: add coefficient_135
    let t313 = circuit_mul(t312, in44); // Eval big_Q Horner step: multiply by z
    let t314 = circuit_add(in184, t313); // Eval big_Q Horner step: add coefficient_134
    let t315 = circuit_mul(t314, in44); // Eval big_Q Horner step: multiply by z
    let t316 = circuit_add(in183, t315); // Eval big_Q Horner step: add coefficient_133
    let t317 = circuit_mul(t316, in44); // Eval big_Q Horner step: multiply by z
    let t318 = circuit_add(in182, t317); // Eval big_Q Horner step: add coefficient_132
    let t319 = circuit_mul(t318, in44); // Eval big_Q Horner step: multiply by z
    let t320 = circuit_add(in181, t319); // Eval big_Q Horner step: add coefficient_131
    let t321 = circuit_mul(t320, in44); // Eval big_Q Horner step: multiply by z
    let t322 = circuit_add(in180, t321); // Eval big_Q Horner step: add coefficient_130
    let t323 = circuit_mul(t322, in44); // Eval big_Q Horner step: multiply by z
    let t324 = circuit_add(in179, t323); // Eval big_Q Horner step: add coefficient_129
    let t325 = circuit_mul(t324, in44); // Eval big_Q Horner step: multiply by z
    let t326 = circuit_add(in178, t325); // Eval big_Q Horner step: add coefficient_128
    let t327 = circuit_mul(t326, in44); // Eval big_Q Horner step: multiply by z
    let t328 = circuit_add(in177, t327); // Eval big_Q Horner step: add coefficient_127
    let t329 = circuit_mul(t328, in44); // Eval big_Q Horner step: multiply by z
    let t330 = circuit_add(in176, t329); // Eval big_Q Horner step: add coefficient_126
    let t331 = circuit_mul(t330, in44); // Eval big_Q Horner step: multiply by z
    let t332 = circuit_add(in175, t331); // Eval big_Q Horner step: add coefficient_125
    let t333 = circuit_mul(t332, in44); // Eval big_Q Horner step: multiply by z
    let t334 = circuit_add(in174, t333); // Eval big_Q Horner step: add coefficient_124
    let t335 = circuit_mul(t334, in44); // Eval big_Q Horner step: multiply by z
    let t336 = circuit_add(in173, t335); // Eval big_Q Horner step: add coefficient_123
    let t337 = circuit_mul(t336, in44); // Eval big_Q Horner step: multiply by z
    let t338 = circuit_add(in172, t337); // Eval big_Q Horner step: add coefficient_122
    let t339 = circuit_mul(t338, in44); // Eval big_Q Horner step: multiply by z
    let t340 = circuit_add(in171, t339); // Eval big_Q Horner step: add coefficient_121
    let t341 = circuit_mul(t340, in44); // Eval big_Q Horner step: multiply by z
    let t342 = circuit_add(in170, t341); // Eval big_Q Horner step: add coefficient_120
    let t343 = circuit_mul(t342, in44); // Eval big_Q Horner step: multiply by z
    let t344 = circuit_add(in169, t343); // Eval big_Q Horner step: add coefficient_119
    let t345 = circuit_mul(t344, in44); // Eval big_Q Horner step: multiply by z
    let t346 = circuit_add(in168, t345); // Eval big_Q Horner step: add coefficient_118
    let t347 = circuit_mul(t346, in44); // Eval big_Q Horner step: multiply by z
    let t348 = circuit_add(in167, t347); // Eval big_Q Horner step: add coefficient_117
    let t349 = circuit_mul(t348, in44); // Eval big_Q Horner step: multiply by z
    let t350 = circuit_add(in166, t349); // Eval big_Q Horner step: add coefficient_116
    let t351 = circuit_mul(t350, in44); // Eval big_Q Horner step: multiply by z
    let t352 = circuit_add(in165, t351); // Eval big_Q Horner step: add coefficient_115
    let t353 = circuit_mul(t352, in44); // Eval big_Q Horner step: multiply by z
    let t354 = circuit_add(in164, t353); // Eval big_Q Horner step: add coefficient_114
    let t355 = circuit_mul(t354, in44); // Eval big_Q Horner step: multiply by z
    let t356 = circuit_add(in163, t355); // Eval big_Q Horner step: add coefficient_113
    let t357 = circuit_mul(t356, in44); // Eval big_Q Horner step: multiply by z
    let t358 = circuit_add(in162, t357); // Eval big_Q Horner step: add coefficient_112
    let t359 = circuit_mul(t358, in44); // Eval big_Q Horner step: multiply by z
    let t360 = circuit_add(in161, t359); // Eval big_Q Horner step: add coefficient_111
    let t361 = circuit_mul(t360, in44); // Eval big_Q Horner step: multiply by z
    let t362 = circuit_add(in160, t361); // Eval big_Q Horner step: add coefficient_110
    let t363 = circuit_mul(t362, in44); // Eval big_Q Horner step: multiply by z
    let t364 = circuit_add(in159, t363); // Eval big_Q Horner step: add coefficient_109
    let t365 = circuit_mul(t364, in44); // Eval big_Q Horner step: multiply by z
    let t366 = circuit_add(in158, t365); // Eval big_Q Horner step: add coefficient_108
    let t367 = circuit_mul(t366, in44); // Eval big_Q Horner step: multiply by z
    let t368 = circuit_add(in157, t367); // Eval big_Q Horner step: add coefficient_107
    let t369 = circuit_mul(t368, in44); // Eval big_Q Horner step: multiply by z
    let t370 = circuit_add(in156, t369); // Eval big_Q Horner step: add coefficient_106
    let t371 = circuit_mul(t370, in44); // Eval big_Q Horner step: multiply by z
    let t372 = circuit_add(in155, t371); // Eval big_Q Horner step: add coefficient_105
    let t373 = circuit_mul(t372, in44); // Eval big_Q Horner step: multiply by z
    let t374 = circuit_add(in154, t373); // Eval big_Q Horner step: add coefficient_104
    let t375 = circuit_mul(t374, in44); // Eval big_Q Horner step: multiply by z
    let t376 = circuit_add(in153, t375); // Eval big_Q Horner step: add coefficient_103
    let t377 = circuit_mul(t376, in44); // Eval big_Q Horner step: multiply by z
    let t378 = circuit_add(in152, t377); // Eval big_Q Horner step: add coefficient_102
    let t379 = circuit_mul(t378, in44); // Eval big_Q Horner step: multiply by z
    let t380 = circuit_add(in151, t379); // Eval big_Q Horner step: add coefficient_101
    let t381 = circuit_mul(t380, in44); // Eval big_Q Horner step: multiply by z
    let t382 = circuit_add(in150, t381); // Eval big_Q Horner step: add coefficient_100
    let t383 = circuit_mul(t382, in44); // Eval big_Q Horner step: multiply by z
    let t384 = circuit_add(in149, t383); // Eval big_Q Horner step: add coefficient_99
    let t385 = circuit_mul(t384, in44); // Eval big_Q Horner step: multiply by z
    let t386 = circuit_add(in148, t385); // Eval big_Q Horner step: add coefficient_98
    let t387 = circuit_mul(t386, in44); // Eval big_Q Horner step: multiply by z
    let t388 = circuit_add(in147, t387); // Eval big_Q Horner step: add coefficient_97
    let t389 = circuit_mul(t388, in44); // Eval big_Q Horner step: multiply by z
    let t390 = circuit_add(in146, t389); // Eval big_Q Horner step: add coefficient_96
    let t391 = circuit_mul(t390, in44); // Eval big_Q Horner step: multiply by z
    let t392 = circuit_add(in145, t391); // Eval big_Q Horner step: add coefficient_95
    let t393 = circuit_mul(t392, in44); // Eval big_Q Horner step: multiply by z
    let t394 = circuit_add(in144, t393); // Eval big_Q Horner step: add coefficient_94
    let t395 = circuit_mul(t394, in44); // Eval big_Q Horner step: multiply by z
    let t396 = circuit_add(in143, t395); // Eval big_Q Horner step: add coefficient_93
    let t397 = circuit_mul(t396, in44); // Eval big_Q Horner step: multiply by z
    let t398 = circuit_add(in142, t397); // Eval big_Q Horner step: add coefficient_92
    let t399 = circuit_mul(t398, in44); // Eval big_Q Horner step: multiply by z
    let t400 = circuit_add(in141, t399); // Eval big_Q Horner step: add coefficient_91
    let t401 = circuit_mul(t400, in44); // Eval big_Q Horner step: multiply by z
    let t402 = circuit_add(in140, t401); // Eval big_Q Horner step: add coefficient_90
    let t403 = circuit_mul(t402, in44); // Eval big_Q Horner step: multiply by z
    let t404 = circuit_add(in139, t403); // Eval big_Q Horner step: add coefficient_89
    let t405 = circuit_mul(t404, in44); // Eval big_Q Horner step: multiply by z
    let t406 = circuit_add(in138, t405); // Eval big_Q Horner step: add coefficient_88
    let t407 = circuit_mul(t406, in44); // Eval big_Q Horner step: multiply by z
    let t408 = circuit_add(in137, t407); // Eval big_Q Horner step: add coefficient_87
    let t409 = circuit_mul(t408, in44); // Eval big_Q Horner step: multiply by z
    let t410 = circuit_add(in136, t409); // Eval big_Q Horner step: add coefficient_86
    let t411 = circuit_mul(t410, in44); // Eval big_Q Horner step: multiply by z
    let t412 = circuit_add(in135, t411); // Eval big_Q Horner step: add coefficient_85
    let t413 = circuit_mul(t412, in44); // Eval big_Q Horner step: multiply by z
    let t414 = circuit_add(in134, t413); // Eval big_Q Horner step: add coefficient_84
    let t415 = circuit_mul(t414, in44); // Eval big_Q Horner step: multiply by z
    let t416 = circuit_add(in133, t415); // Eval big_Q Horner step: add coefficient_83
    let t417 = circuit_mul(t416, in44); // Eval big_Q Horner step: multiply by z
    let t418 = circuit_add(in132, t417); // Eval big_Q Horner step: add coefficient_82
    let t419 = circuit_mul(t418, in44); // Eval big_Q Horner step: multiply by z
    let t420 = circuit_add(in131, t419); // Eval big_Q Horner step: add coefficient_81
    let t421 = circuit_mul(t420, in44); // Eval big_Q Horner step: multiply by z
    let t422 = circuit_add(in130, t421); // Eval big_Q Horner step: add coefficient_80
    let t423 = circuit_mul(t422, in44); // Eval big_Q Horner step: multiply by z
    let t424 = circuit_add(in129, t423); // Eval big_Q Horner step: add coefficient_79
    let t425 = circuit_mul(t424, in44); // Eval big_Q Horner step: multiply by z
    let t426 = circuit_add(in128, t425); // Eval big_Q Horner step: add coefficient_78
    let t427 = circuit_mul(t426, in44); // Eval big_Q Horner step: multiply by z
    let t428 = circuit_add(in127, t427); // Eval big_Q Horner step: add coefficient_77
    let t429 = circuit_mul(t428, in44); // Eval big_Q Horner step: multiply by z
    let t430 = circuit_add(in126, t429); // Eval big_Q Horner step: add coefficient_76
    let t431 = circuit_mul(t430, in44); // Eval big_Q Horner step: multiply by z
    let t432 = circuit_add(in125, t431); // Eval big_Q Horner step: add coefficient_75
    let t433 = circuit_mul(t432, in44); // Eval big_Q Horner step: multiply by z
    let t434 = circuit_add(in124, t433); // Eval big_Q Horner step: add coefficient_74
    let t435 = circuit_mul(t434, in44); // Eval big_Q Horner step: multiply by z
    let t436 = circuit_add(in123, t435); // Eval big_Q Horner step: add coefficient_73
    let t437 = circuit_mul(t436, in44); // Eval big_Q Horner step: multiply by z
    let t438 = circuit_add(in122, t437); // Eval big_Q Horner step: add coefficient_72
    let t439 = circuit_mul(t438, in44); // Eval big_Q Horner step: multiply by z
    let t440 = circuit_add(in121, t439); // Eval big_Q Horner step: add coefficient_71
    let t441 = circuit_mul(t440, in44); // Eval big_Q Horner step: multiply by z
    let t442 = circuit_add(in120, t441); // Eval big_Q Horner step: add coefficient_70
    let t443 = circuit_mul(t442, in44); // Eval big_Q Horner step: multiply by z
    let t444 = circuit_add(in119, t443); // Eval big_Q Horner step: add coefficient_69
    let t445 = circuit_mul(t444, in44); // Eval big_Q Horner step: multiply by z
    let t446 = circuit_add(in118, t445); // Eval big_Q Horner step: add coefficient_68
    let t447 = circuit_mul(t446, in44); // Eval big_Q Horner step: multiply by z
    let t448 = circuit_add(in117, t447); // Eval big_Q Horner step: add coefficient_67
    let t449 = circuit_mul(t448, in44); // Eval big_Q Horner step: multiply by z
    let t450 = circuit_add(in116, t449); // Eval big_Q Horner step: add coefficient_66
    let t451 = circuit_mul(t450, in44); // Eval big_Q Horner step: multiply by z
    let t452 = circuit_add(in115, t451); // Eval big_Q Horner step: add coefficient_65
    let t453 = circuit_mul(t452, in44); // Eval big_Q Horner step: multiply by z
    let t454 = circuit_add(in114, t453); // Eval big_Q Horner step: add coefficient_64
    let t455 = circuit_mul(t454, in44); // Eval big_Q Horner step: multiply by z
    let t456 = circuit_add(in113, t455); // Eval big_Q Horner step: add coefficient_63
    let t457 = circuit_mul(t456, in44); // Eval big_Q Horner step: multiply by z
    let t458 = circuit_add(in112, t457); // Eval big_Q Horner step: add coefficient_62
    let t459 = circuit_mul(t458, in44); // Eval big_Q Horner step: multiply by z
    let t460 = circuit_add(in111, t459); // Eval big_Q Horner step: add coefficient_61
    let t461 = circuit_mul(t460, in44); // Eval big_Q Horner step: multiply by z
    let t462 = circuit_add(in110, t461); // Eval big_Q Horner step: add coefficient_60
    let t463 = circuit_mul(t462, in44); // Eval big_Q Horner step: multiply by z
    let t464 = circuit_add(in109, t463); // Eval big_Q Horner step: add coefficient_59
    let t465 = circuit_mul(t464, in44); // Eval big_Q Horner step: multiply by z
    let t466 = circuit_add(in108, t465); // Eval big_Q Horner step: add coefficient_58
    let t467 = circuit_mul(t466, in44); // Eval big_Q Horner step: multiply by z
    let t468 = circuit_add(in107, t467); // Eval big_Q Horner step: add coefficient_57
    let t469 = circuit_mul(t468, in44); // Eval big_Q Horner step: multiply by z
    let t470 = circuit_add(in106, t469); // Eval big_Q Horner step: add coefficient_56
    let t471 = circuit_mul(t470, in44); // Eval big_Q Horner step: multiply by z
    let t472 = circuit_add(in105, t471); // Eval big_Q Horner step: add coefficient_55
    let t473 = circuit_mul(t472, in44); // Eval big_Q Horner step: multiply by z
    let t474 = circuit_add(in104, t473); // Eval big_Q Horner step: add coefficient_54
    let t475 = circuit_mul(t474, in44); // Eval big_Q Horner step: multiply by z
    let t476 = circuit_add(in103, t475); // Eval big_Q Horner step: add coefficient_53
    let t477 = circuit_mul(t476, in44); // Eval big_Q Horner step: multiply by z
    let t478 = circuit_add(in102, t477); // Eval big_Q Horner step: add coefficient_52
    let t479 = circuit_mul(t478, in44); // Eval big_Q Horner step: multiply by z
    let t480 = circuit_add(in101, t479); // Eval big_Q Horner step: add coefficient_51
    let t481 = circuit_mul(t480, in44); // Eval big_Q Horner step: multiply by z
    let t482 = circuit_add(in100, t481); // Eval big_Q Horner step: add coefficient_50
    let t483 = circuit_mul(t482, in44); // Eval big_Q Horner step: multiply by z
    let t484 = circuit_add(in99, t483); // Eval big_Q Horner step: add coefficient_49
    let t485 = circuit_mul(t484, in44); // Eval big_Q Horner step: multiply by z
    let t486 = circuit_add(in98, t485); // Eval big_Q Horner step: add coefficient_48
    let t487 = circuit_mul(t486, in44); // Eval big_Q Horner step: multiply by z
    let t488 = circuit_add(in97, t487); // Eval big_Q Horner step: add coefficient_47
    let t489 = circuit_mul(t488, in44); // Eval big_Q Horner step: multiply by z
    let t490 = circuit_add(in96, t489); // Eval big_Q Horner step: add coefficient_46
    let t491 = circuit_mul(t490, in44); // Eval big_Q Horner step: multiply by z
    let t492 = circuit_add(in95, t491); // Eval big_Q Horner step: add coefficient_45
    let t493 = circuit_mul(t492, in44); // Eval big_Q Horner step: multiply by z
    let t494 = circuit_add(in94, t493); // Eval big_Q Horner step: add coefficient_44
    let t495 = circuit_mul(t494, in44); // Eval big_Q Horner step: multiply by z
    let t496 = circuit_add(in93, t495); // Eval big_Q Horner step: add coefficient_43
    let t497 = circuit_mul(t496, in44); // Eval big_Q Horner step: multiply by z
    let t498 = circuit_add(in92, t497); // Eval big_Q Horner step: add coefficient_42
    let t499 = circuit_mul(t498, in44); // Eval big_Q Horner step: multiply by z
    let t500 = circuit_add(in91, t499); // Eval big_Q Horner step: add coefficient_41
    let t501 = circuit_mul(t500, in44); // Eval big_Q Horner step: multiply by z
    let t502 = circuit_add(in90, t501); // Eval big_Q Horner step: add coefficient_40
    let t503 = circuit_mul(t502, in44); // Eval big_Q Horner step: multiply by z
    let t504 = circuit_add(in89, t503); // Eval big_Q Horner step: add coefficient_39
    let t505 = circuit_mul(t504, in44); // Eval big_Q Horner step: multiply by z
    let t506 = circuit_add(in88, t505); // Eval big_Q Horner step: add coefficient_38
    let t507 = circuit_mul(t506, in44); // Eval big_Q Horner step: multiply by z
    let t508 = circuit_add(in87, t507); // Eval big_Q Horner step: add coefficient_37
    let t509 = circuit_mul(t508, in44); // Eval big_Q Horner step: multiply by z
    let t510 = circuit_add(in86, t509); // Eval big_Q Horner step: add coefficient_36
    let t511 = circuit_mul(t510, in44); // Eval big_Q Horner step: multiply by z
    let t512 = circuit_add(in85, t511); // Eval big_Q Horner step: add coefficient_35
    let t513 = circuit_mul(t512, in44); // Eval big_Q Horner step: multiply by z
    let t514 = circuit_add(in84, t513); // Eval big_Q Horner step: add coefficient_34
    let t515 = circuit_mul(t514, in44); // Eval big_Q Horner step: multiply by z
    let t516 = circuit_add(in83, t515); // Eval big_Q Horner step: add coefficient_33
    let t517 = circuit_mul(t516, in44); // Eval big_Q Horner step: multiply by z
    let t518 = circuit_add(in82, t517); // Eval big_Q Horner step: add coefficient_32
    let t519 = circuit_mul(t518, in44); // Eval big_Q Horner step: multiply by z
    let t520 = circuit_add(in81, t519); // Eval big_Q Horner step: add coefficient_31
    let t521 = circuit_mul(t520, in44); // Eval big_Q Horner step: multiply by z
    let t522 = circuit_add(in80, t521); // Eval big_Q Horner step: add coefficient_30
    let t523 = circuit_mul(t522, in44); // Eval big_Q Horner step: multiply by z
    let t524 = circuit_add(in79, t523); // Eval big_Q Horner step: add coefficient_29
    let t525 = circuit_mul(t524, in44); // Eval big_Q Horner step: multiply by z
    let t526 = circuit_add(in78, t525); // Eval big_Q Horner step: add coefficient_28
    let t527 = circuit_mul(t526, in44); // Eval big_Q Horner step: multiply by z
    let t528 = circuit_add(in77, t527); // Eval big_Q Horner step: add coefficient_27
    let t529 = circuit_mul(t528, in44); // Eval big_Q Horner step: multiply by z
    let t530 = circuit_add(in76, t529); // Eval big_Q Horner step: add coefficient_26
    let t531 = circuit_mul(t530, in44); // Eval big_Q Horner step: multiply by z
    let t532 = circuit_add(in75, t531); // Eval big_Q Horner step: add coefficient_25
    let t533 = circuit_mul(t532, in44); // Eval big_Q Horner step: multiply by z
    let t534 = circuit_add(in74, t533); // Eval big_Q Horner step: add coefficient_24
    let t535 = circuit_mul(t534, in44); // Eval big_Q Horner step: multiply by z
    let t536 = circuit_add(in73, t535); // Eval big_Q Horner step: add coefficient_23
    let t537 = circuit_mul(t536, in44); // Eval big_Q Horner step: multiply by z
    let t538 = circuit_add(in72, t537); // Eval big_Q Horner step: add coefficient_22
    let t539 = circuit_mul(t538, in44); // Eval big_Q Horner step: multiply by z
    let t540 = circuit_add(in71, t539); // Eval big_Q Horner step: add coefficient_21
    let t541 = circuit_mul(t540, in44); // Eval big_Q Horner step: multiply by z
    let t542 = circuit_add(in70, t541); // Eval big_Q Horner step: add coefficient_20
    let t543 = circuit_mul(t542, in44); // Eval big_Q Horner step: multiply by z
    let t544 = circuit_add(in69, t543); // Eval big_Q Horner step: add coefficient_19
    let t545 = circuit_mul(t544, in44); // Eval big_Q Horner step: multiply by z
    let t546 = circuit_add(in68, t545); // Eval big_Q Horner step: add coefficient_18
    let t547 = circuit_mul(t546, in44); // Eval big_Q Horner step: multiply by z
    let t548 = circuit_add(in67, t547); // Eval big_Q Horner step: add coefficient_17
    let t549 = circuit_mul(t548, in44); // Eval big_Q Horner step: multiply by z
    let t550 = circuit_add(in66, t549); // Eval big_Q Horner step: add coefficient_16
    let t551 = circuit_mul(t550, in44); // Eval big_Q Horner step: multiply by z
    let t552 = circuit_add(in65, t551); // Eval big_Q Horner step: add coefficient_15
    let t553 = circuit_mul(t552, in44); // Eval big_Q Horner step: multiply by z
    let t554 = circuit_add(in64, t553); // Eval big_Q Horner step: add coefficient_14
    let t555 = circuit_mul(t554, in44); // Eval big_Q Horner step: multiply by z
    let t556 = circuit_add(in63, t555); // Eval big_Q Horner step: add coefficient_13
    let t557 = circuit_mul(t556, in44); // Eval big_Q Horner step: multiply by z
    let t558 = circuit_add(in62, t557); // Eval big_Q Horner step: add coefficient_12
    let t559 = circuit_mul(t558, in44); // Eval big_Q Horner step: multiply by z
    let t560 = circuit_add(in61, t559); // Eval big_Q Horner step: add coefficient_11
    let t561 = circuit_mul(t560, in44); // Eval big_Q Horner step: multiply by z
    let t562 = circuit_add(in60, t561); // Eval big_Q Horner step: add coefficient_10
    let t563 = circuit_mul(t562, in44); // Eval big_Q Horner step: multiply by z
    let t564 = circuit_add(in59, t563); // Eval big_Q Horner step: add coefficient_9
    let t565 = circuit_mul(t564, in44); // Eval big_Q Horner step: multiply by z
    let t566 = circuit_add(in58, t565); // Eval big_Q Horner step: add coefficient_8
    let t567 = circuit_mul(t566, in44); // Eval big_Q Horner step: multiply by z
    let t568 = circuit_add(in57, t567); // Eval big_Q Horner step: add coefficient_7
    let t569 = circuit_mul(t568, in44); // Eval big_Q Horner step: multiply by z
    let t570 = circuit_add(in56, t569); // Eval big_Q Horner step: add coefficient_6
    let t571 = circuit_mul(t570, in44); // Eval big_Q Horner step: multiply by z
    let t572 = circuit_add(in55, t571); // Eval big_Q Horner step: add coefficient_5
    let t573 = circuit_mul(t572, in44); // Eval big_Q Horner step: multiply by z
    let t574 = circuit_add(in54, t573); // Eval big_Q Horner step: add coefficient_4
    let t575 = circuit_mul(t574, in44); // Eval big_Q Horner step: multiply by z
    let t576 = circuit_add(in53, t575); // Eval big_Q Horner step: add coefficient_3
    let t577 = circuit_mul(t576, in44); // Eval big_Q Horner step: multiply by z
    let t578 = circuit_add(in52, t577); // Eval big_Q Horner step: add coefficient_2
    let t579 = circuit_mul(t578, in44); // Eval big_Q Horner step: multiply by z
    let t580 = circuit_add(in51, t579); // Eval big_Q Horner step: add coefficient_1
    let t581 = circuit_mul(t580, in44); // Eval big_Q Horner step: multiply by z
    let t582 = circuit_add(in50, t581); // Eval big_Q Horner step: add coefficient_0
    let t583 = circuit_mul(in9, t2); // Eval sparse poly P_irr step coeff_6 * z^6
    let t584 = circuit_add(in8, t583); // Eval sparse poly P_irr step + coeff_6 * z^6
    let t585 = circuit_add(t584, t5); // Eval sparse poly P_irr step + 1*z^12
    let t586 = circuit_mul(t582, t585);
    let t587 = circuit_sub(t204, t586);
