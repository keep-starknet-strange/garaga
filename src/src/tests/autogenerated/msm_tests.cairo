...
fn test_msm_BN254_2P() {
    ...
    let scalars = array![
        ...
        u256 { low: 0xb4862b21fb97d43588561712e8e5216a, high: 0x967d0cae6f4590b9a164106cf6a659e },
    ]
        .span();
...
fn test_msm_BN254_3P() {
    ...
    let scalars = array![
        u256 { low: 0x0, high: 0x0 },
        u256 { low: 0x12e0c8b2bad640fb19488dec4f65d4d9, high: 0x1521f387af19922ad9b8a714e61a441c },
        u256 { low: 0x5a92118719c78df48f4ff31e78de5857, high: 0x28fcb26f9c6316b950f244556f25e2a2 },
    ]
        .span();
...
fn test_msm_BN254_4P() {
    ...
    let scalars = array![
        u256 { low: 0x0, high: 0x0 },
        u256 { low: 0x5a92118719c78df48f4ff31e78de5857, high: 0x28fcb26f9c6316b950f244556f25e2a2 },
        u256 { low: 0x8d723104f77383c13458a748e9bb17bc, high: 0x215ddba6dd84f39e71545a137a1d5006 },
        u256 { low: 0xeb2083e6ce164dba0ff18e0242af9fc3, high: 0x5f82a8f03983ca8ea7e9d498c778ea6 },
    ]
        .span();
...
fn test_msm_BN254_10P() {
    ...
    let scalars = array![
        u256 { low: 0x0, high: 0x0 },
        u256 { low: 0x247a8333f7b0b7d2cda8056c3d15eef7, high: 0x5d67b7072ae22448b0163c1cd9d2b7d },
        u256 { low: 0xe005b86051ef1922fe43c49e149818d1, high: 0x1f507980eece328bff7b118e820865d6 },
        u256 { low: 0x4a84eb038d1fd9b74d2b9deb1beb3711, high: 0x154bc8ce8c25166a1ff39849b4e1357d },
        u256 { low: 0x3405095c8a5006c1ec188efbd080e66e, high: 0x2305d1699a6a5f92cca74147f6be1f72 },
        u256 { low: 0x1775336d71eacd0549a3e80e966e1277, high: 0x144a7edf6288e1a5cc45782198a6416d },
        u256 { low: 0x2f1205544a5308cc3dfabc08935ddd72, high: 0x21c38572fcd81b5d24bace4307bf326 },
        u256 { low: 0x42930b33a81ad477fb3675b89cdeb3e6, high: 0x2b70369e16febaa011af923d79fdef7c },
        u256 { low: 0x2648ee38e07405eb215663abc1f254b8, high: 0x522c9d6d7ab792809e469e6ec62b2c8 },
        u256 { low: 0x85940927468ff53d864a7a50b48d73f1, high: 0xdc5dba1d977e9933c49d76fcfc6e625 },
    ]
        .span();
...
fn test_msm_BN254_11P() {
    ...
    let scalars = array![
        ...
        u256 { low: 0x2648ee38e07405eb215663abc1f254b8, high: 0x522c9d6d7ab792809e469e6ec62b2c8 },
        u256 { low: 0x85940927468ff53d864a7a50b48d73f1, high: 0xdc5dba1d977e9933c49d76fcfc6e625 },
        u256 { low: 0xd344749096fd35d0adf20806e5214606, high: 0x119d0dd09466e4726b5f5241f323ca74 },
        u256 { low: 0x5306f3f5151665705b7c709acb175a5a, high: 0x2592a1c37c879b741d878f9f9cdf5a86 },
    ]
        .span();
...
fn test_msm_BN254_12P() {
    ...
    let scalars = array![
        ...
        u256 { low: 0xd344749096fd35d0adf20806e5214606, high: 0x119d0dd09466e4726b5f5241f323ca74 },
        u256 { low: 0x5306f3f5151665705b7c709acb175a5a, high: 0x2592a1c37c879b741d878f9f9cdf5a86 },
        u256 { low: 0x30bcab0ed857010255d44936a1515607, high: 0x1158af9fbb42e0b20426465e3e37952d },
...
fn test_msm_BLS12_381_2P() {
    ...
    let scalars = array![
        u256 { low: 0x0, high: 0x0 },
        u256 { low: 0xb4862b21fb97d43588561712e8e5216a, high: 0x12cfa194e6f4590b9a164106cf6a659e },
    ]
        .span();
...
fn test_msm_BLS12_381_3P() {
    ...
    let scalars = array![
        u256 { low: 0x0, high: 0x0 },
        u256 { low: 0x12e0c8b2bad640fb19488dec4f65d4d9, high: 0x2a43e70faf19922ad9b8a714e61a441c },
        u256 { low: 0x5a92118719c78df48f4ff31e78de5857, high: 0x51f964df9c6316b950f244556f25e2a2 },
    ]
        .span();
...
fn test_msm_BLS12_381_4P() {
    ...
    let scalars = array![
        u256 { low: 0x0, high: 0x0 },
        u256 { low: 0x5a92118719c78df48f4ff31e78de5857, high: 0x51f964df9c6316b950f244556f25e2a2 },
        u256 { low: 0x8d723104f77383c13458a748e9bb17bc, high: 0x42bbb74ddd84f39e71545a137a1d5006 },
...
fn test_msm_BLS12_381_10P() {
    ...
    let scalars = array![
        u256 { low: 0x0, high: 0x0 },
        u256 { low: 0x247a8333f7b0b7d2cda8056c3d15eef7, high: 0xbacf6e172ae22448b0163c1cd9d2b7d },
        u256 { low: 0xe005b86051ef1922fe43c49e149818d1, high: 0x3ea0f301eece328bff7b118e820865d6 },
        u256 { low: 0x4a84eb038d1fd9b74d2b9deb1beb3711, high: 0x2a97919d8c25166a1ff39849b4e1357d },
        u256 { low: 0x3405095c8a5006c1ec188efbd080e66e, high: 0x460ba2d39a6a5f92cca74147f6be1f72 },
        ...
        u256 { low: 0x42930b33a81ad477fb3675b89cdeb3e6, high: 0x56e06d3d16febaa011af923d79fdef7c },
        u256 { low: 0x2648ee38e07405eb215663abc1f254b8, high: 0xa4593acd7ab792809e469e6ec62b2c8 },
        u256 { low: 0xd450fe4aec4f217bb306d1a8e5eeac76, high: 0x6b3f2afe642bfa42aef9c00b8a64c1b9 },
    ]
        .span();
...
fn test_msm_BLS12_381_11P() {
    ...
    let scalars = array![
        ...
        u256 { low: 0x2648ee38e07405eb215663abc1f254b8, high: 0xa4593acd7ab792809e469e6ec62b2c8 },
        u256 { low: 0xd450fe4aec4f217bb306d1a8e5eeac76, high: 0x6b3f2afe642bfa42aef9c00b8a64c1b9 },
        u256 { low: 0x85940927468ff53d864a7a50b48d73f1, high: 0x1b8bb742d977e9933c49d76fcfc6e625 },
        u256 { low: 0xd344749096fd35d0adf20806e5214606, high: 0x233a1ba09466e4726b5f5241f323ca74 },
    ]
        .span();
...
fn test_msm_BLS12_381_12P() {
    ...
    let scalars = array![
        ...
        u256 { low: 0x30bcab0ed857010255d44936a1515607, high: 0x22b15f3fbb42e0b20426465e3e37952d },
    ]
        .span();
...
fn test_msm_SECP256R1_2P() {
    ...
    let scalars = array![
        u256 { low: 0x0, high: 0x0 },
        u256 { low: 0xeb1167b367a9c3787c65c1e582e2e662, high: 0xf7c1bd874da5e709d4713d60c8a70639 },
    ]
        .span();
...
fn test_msm_SECP256R1_3P() {
    ...
    let scalars = array![
        u256 { low: 0x0, high: 0x0 },
        u256 { low: 0xe443df789558867f5ba91faf7a024204, high: 0x23a7711a8133287637ebdcd9e87a1613 },
        u256 { low: 0x1846d424c17c627923c6612f48268673, high: 0xfcbd04c340212ef7cca5a5a19e4d6e3c },
    ]
        .span();
...
fn test_msm_SECP256R1_4P() {
    ...
    let scalars = array![
        u256 { low: 0x0, high: 0x0 },
        u256 { low: 0x1846d424c17c627923c6612f48268673, high: 0xfcbd04c340212ef7cca5a5a19e4d6e3c },
        u256 { low: 0xb4862b21fb97d43588561712e8e5216a, high: 0x259f4329e6f4590b9a164106cf6a659e },
        u256 { low: 0x12e0c8b2bad640fb19488dec4f65d4d9, high: 0x5487ce1eaf19922ad9b8a714e61a441c },
    ]
        .span();
...
fn test_msm_SECP256R1_10P() {
    ...
    let scalars = array![
        u256 { low: 0x0, high: 0x0 },
        u256 { low: 0xb5d32b1666194cb1d71037d1b83e90ec, high: 0xa0116be5ab0c1681c8f8e3d0d3290a4c },
        u256 { low: 0xd3fbf47a7e5b1e7f9ca5499d004ae545, high: 0xbaf3897a3e70f16a55485822de1b372a },
        u256 { low: 0x101fbcccded733e8b421eaeb534097ca, high: 0x38c1962e9148624feac1c14f30e9c5cc },
        u256 { low: 0x247a8333f7b0b7d2cda8056c3d15eef7, high: 0x1759edc372ae22448b0163c1cd9d2b7d },
        u256 { low: 0xe005b86051ef1922fe43c49e149818d1, high: 0x7d41e602eece328bff7b118e820865d6 },
        ...
        u256 { low: 0x2f1205544a5308cc3dfabc08935ddd72, high: 0x870e15c2fcd81b5d24bace4307bf326 },
    ]
        .span();
...
fn test_msm_SECP256R1_11P() {
    ...
    let scalars = array![
        ...
        u256 { low: 0x1775336d71eacd0549a3e80e966e1277, high: 0x5129fb7c6288e1a5cc45782198a6416d },
        u256 { low: 0x2f1205544a5308cc3dfabc08935ddd72, high: 0x870e15c2fcd81b5d24bace4307bf326 },
        u256 { low: 0x42930b33a81ad477fb3675b89cdeb3e6, high: 0xadc0da7a16febaa011af923d79fdef7c },
        u256 { low: 0x2648ee38e07405eb215663abc1f254b8, high: 0x148b2758d7ab792809e469e6ec62b2c8 },
    ]
        .span();
...
fn test_msm_ED25519_2P() {
    ...
    let scalars = array![
        u256 { low: 0x0, high: 0x0 },
        u256 { low: 0xb4862b21fb97d43588561712e8e5216a, high: 0x4b3e865e6f4590b9a164106cf6a659e },
    ]
        .span();
...
fn test_msm_ED25519_3P() {
    ...
    let scalars = array![
        u256 { low: 0x0, high: 0x0 },
        u256 { low: 0x12e0c8b2bad640fb19488dec4f65d4d9, high: 0xa90f9c3af19922ad9b8a714e61a441c },
        u256 { low: 0xeb2083e6ce164dba0ff18e0242af9fc3, high: 0x2fc154703983ca8ea7e9d498c778ea6 },
    ]
        .span();
...
fn test_msm_ED25519_4P() {
    ...
    let scalars = array![
        u256 { low: 0x0, high: 0x0 },
        u256 { low: 0xeb2083e6ce164dba0ff18e0242af9fc3, high: 0x2fc154703983ca8ea7e9d498c778ea6 },
        u256 { low: 0x101fbcccded733e8b421eaeb534097ca, high: 0x71832c59148624feac1c14f30e9c5cc },
        u256 { low: 0x247a8333f7b0b7d2cda8056c3d15eef7, high: 0x2eb3db872ae22448b0163c1cd9d2b7d },
    ]
        .span();
...
fn test_msm_ED25519_10P() {
    ...
    let scalars = array![
        u256 { low: 0x0, high: 0x0 },
        u256 { low: 0x2f1205544a5308cc3dfabc08935ddd72, high: 0x10e1c2b2fcd81b5d24bace4307bf326 },
        u256 { low: 0x2648ee38e07405eb215663abc1f254b8, high: 0x29164ebd7ab792809e469e6ec62b2c8 },
        u256 { low: 0x85940927468ff53d864a7a50b48d73f1, high: 0x6e2edd0d977e9933c49d76fcfc6e625 },
        u256 { low: 0xd344749096fd35d0adf20806e5214606, high: 0x8ce86e89466e4726b5f5241f323ca74 },
        u256 { low: 0x30bcab0ed857010255d44936a1515607, high: 0x8ac57cfbb42e0b20426465e3e37952d },
        u256 { low: 0x5f3f563838701a14b490b6081dfc8352, high: 0xda2ddc3552116dd2ba4b180cb69ca38 },
        u256 { low: 0xc87a746319c16a0d0febd845d0dfae43, high: 0x7003168b29a8b06daf66c5f2577bffa },
        u256 { low: 0x176ea1b164264cd51ea45cd69371a71f, high: 0x3b6a666fb0323a1d576d4155ec17dbe },
        u256 { low: 0x9edfa3da6cf55b158b53031d05d51433, high: 0x23d79a9428a1c22d5fdb76a19fbeb1d },
    ]
        .span();
...
fn test_msm_ED25519_11P() {
    ...
    let scalars = array![
        ...
        u256 { low: 0x176ea1b164264cd51ea45cd69371a71f, high: 0x3b6a666fb0323a1d576d4155ec17dbe },
        u256 { low: 0x9edfa3da6cf55b158b53031d05d51433, high: 0x23d79a9428a1c22d5fdb76a19fbeb1d },
        u256 { low: 0x4d125e7fa59cec98126cbc8f38884479, high: 0x1f40f472e2950656fa231e959acdd98 },
        u256 { low: 0x98b33c6e0a14b90a7795e98680ee526e, high: 0xc8555a9fcfcfa81b306d70019d5f970 },
    ]
        .span();
...
fn test_msm_ED25519_12P() {
    ...
    let scalars = array![
        ...
        u256 { low: 0x4d125e7fa59cec98126cbc8f38884479, high: 0x1f40f472e2950656fa231e959acdd98 },
        u256 { low: 0x98b33c6e0a14b90a7795e98680ee526e, high: 0xc8555a9fcfcfa81b306d70019d5f970 },
        u256 { low: 0xebe2136898c752051e01a934402d0baf, high: 0x6c2a492cc0f859aa6524ab713b7e05 },
        u256 { low: 0x637e0edc5b6e4ae7a62081434fbaecc0, high: 0x4e8c1e4403d1f83a859890cd670f668 },
    ]
        .span();
