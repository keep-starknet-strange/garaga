...
fn test_ecdsa_BN254() {
    let mut ecdsa_sig_with_hints_serialized = array![
        ...
        0x0,
        0xa0b063933d8e3f54,
        0x1000000000000000003fc2ccc129935ee,
        0x1000000000000000030112506a6d6deff,
        0x21d269100269048a,
    ]
        .span();
...
fn test_ecdsa_BLS12_381() {
    let mut ecdsa_sig_with_hints_serialized = array![
        ...
        0x1cbcf87b9857ba44,
        0x989a085f93dfee0,
        0x100000000000000002e5733515f6dc037,
        ...
        0x4c5ccbf186df2adb,
        0x100000000000000009289460599d5e6be,
        0x100000000000000003f0c985cb7645566,
        0x396e116d375dd2dd,
    ]
        .span();
    let ecdsa_with_hints = Serde::<
...
fn test_ecdsa_SECP256K1() {
    let mut ecdsa_sig_with_hints_serialized = array![
        ...
        0x0,
        0x5763a6a1517232b0,
        0x100000000000000003fa616b9d1aa135b,
        0x2ee3ef80f868d011,
        0x100000000000000003fe78eccc1da3303,
        ...
        0xe635b285558b642c,
        0x0,
        0x1000000000000000097e848fb19a47c06,
        0x100000000000000003dc81ff2129521cf,
        0xdfac131bb3bb11de,
        0xafc939cc6fed0eee,
    ]
        .span();
