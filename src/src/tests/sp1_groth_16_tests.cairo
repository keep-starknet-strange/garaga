...
use garaga::ec::pairing::groth16::verify_groth16_bn254;
...
fn test_verify_sp1_groth16_proof_bn254() {
    ...
    assert(main(calldata) == true, 'Proof verification failed');
}

#[executable]
pub fn main(full_proof_with_hints: Span<felt252>) -> bool {
    ...
    let proof = Groth16Proof {
        ...
        b: groth16_proof.b,
        c: groth16_proof.c,
        public_inputs: proof_pub_input.span(),
    };

    return verify_groth16_bn254(
        proof, vk, precomputed_lines.span(), ic.span(), msm_hint, mpcheck_hint,
    );
}
