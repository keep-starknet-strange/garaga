...
You can find a bunch of example of verifying keys that will work directly in the [`hydra/garaga/starknet/groth16_contract_generator/examples`](https://github.com/keep-starknet-strange/garaga/tree/main/hydra/garaga/starknet/groth16_contract_generator/examples) folder.

If you're using [Arkworks](https://arkworks.rs/) for your Groth16 circuits, you can use the [`ark-snarkjs`](https://github.com/mysteryon88/ark-snarkjs) package to export your verifying keys and proofs into garaga-compatible JSON format. This library supports both BN254 and BLS12-381 curves.

Additionally, if you're writing circuits using [Noname](https://github.com/zksecurity/noname), you can compile your circuits to R1CS format compatible with Snarkjs, similar to how [Circom](https://docs.circom.io/) works. For more information on integrating Noname with SnarkJS, see [this article](https://blog.zksecurity.xyz/posts/noname-r1cs/).
