...
{% hint style="warning" %}
**Version Compatibility:** Use the latest [release tag](https://github.com/keep-starknet-strange/garaga/releases) (e.g., `v1.1.0`) to match the declared [maintained smart contracts](../maintained-smart-contracts/ "mention") and ensure compatibility with the pip package that generated your verifiers.
{% endhint %}
