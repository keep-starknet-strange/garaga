...
|-------|---------|------|--------|
| **Garaga v2** | [CryptoExperts](https://www.cryptoexperts.com/) | 2024 | [View Report (PDF)](https://github.com/keep-starknet-strange/garaga/blob/main/docs/Garaga-audit-report-v2.pdf) |
